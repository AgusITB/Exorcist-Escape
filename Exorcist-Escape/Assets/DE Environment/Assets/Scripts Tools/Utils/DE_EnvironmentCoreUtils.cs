...
namespace DEEnvironmentCore.Containers
{
#region [Enums]
    ...
    public enum DEPackages
    {
        ...
        DETwoSided,
        DEUVReveal,
        DEVectorDisplacement,
        DEVegetation,
        DEWater,
        DEPortal
    }
    public enum MenuPathsCycles
    {
        Cycle2019_1, Cycle2019_2, Cycle2019_3, Cycle2019_4,
        Cycle2020_1, Cycle2020_2, Cycle2020_3,
        Cycle2021_1, Cycle2021_2, Cycle2021_3,
        Cycle2022_1, Cycle2022_2, Cycle2022_3,
        Cycle2023_1, Cycle2023_2,
        Cycle6000_0, 
    }
#endregion
#region [Classes]
    ...
    {
        public string name = "";
        public DEPackages DEPackage;
        public MenuPathsRenderPipeline renderPipeline;
        public List<MenuPathsCycles> unityCycle;
...
namespace DEEnvironmentCore.Lights
{
...
namespace DEEnvironmentCore.Utils
{
#region [DE MeshUtils]
...
namespace DEEnvironmentCore.GraphicalUserInterface
{
    public static class DEEnvironmentGUI
    {
        /// <summary>
        /// Main GUI Class
        /// </summary>
        public class MainGUI
        {
            ...
            /// <param name="IconfileName">Main Icon (powered by Environments)</param>
            ...
            public MainGUI(ref int mainToolbar, string[] toolbarNames, Action[] actions, string name, string version, Vector2 editorWindowSize, string IconfileName, string publisherLink = "", string discordLink = "", string websiteLink = "", string mailLink = "", string publisher = "")
            {
                if (!Icon)
                    Icon = IconfileName.GetTexture2D();
            ...
            public void OnGUI()
            {
                ...
                EditorGUILayout.LabelField(new GUIContent(Icon), GUILayout.Width(iconSize), GUILayout.Height(iconSize));
                GUILayout.Space(10);
                EditorGUILayout.BeginVertical();

                // Mesh Tool Label
                EditorGUILayout.LabelField("<b>" + name + "</b> <size=9>" + version + "</size>", DEEnvironmentStyles.LabelStyle(bold: true, size: 24, richText: true), GUILayout.Height(iconSize / 2));

                // Selected Menu Label
                EditorGUILayout.LabelField(toolbarNames[mainToolbar], DEEnvironmentStyles.LabelStyle(bold: false, size: 18, richText: true, alignment: TextAnchor.MiddleLeft), GUILayout.Height(iconSize / 2));
                ...
                GUILayout.Space(10);
                mainToolbar = GUILayout.SelectionGrid(mainToolbar, toolbarNames, 1, DEEnvironmentStyles.ButtonStyle(), toolbarSize);
                EditorGUILayout.EndVertical();
                GUILayout.Space(10);
        ...
        public class SocialGUI
        {
            ...
            {
                Icon_Store = "T_IconStore".GetTexture2D();
                Icon_Store_active = "T_IconStoreActive".GetTexture2D(true);
                Icon_Discord = "T_IconDiscord".GetTexture2D();
                Icon_Discord_active = "T_IconDiscordActive".GetTexture2D(true);
                Icon_Website = "T_IconWWW".GetTexture2D();
                Icon_Website_active = "T_IconWWWActive".GetTexture2D(true);
                Icon_Mail = "T_IconMail".GetTexture2D();
                Icon_Mail_active = "T_IconMailActive".GetTexture2D(true);
        ...
        public class AboutGUI
        {
            ...
            public AboutGUI(string toolName, string publisher, string version, string[] creator, string[] writer, string[] adress = null, string htmlWebsite = "", string mail = "")
            {
                ...
                gs_Label = DEEnvironmentStyles.LabelStyle(size: 10);
                gs_Button = DEEnvironmentStyles.TextButtonStyle(col, false, 10);
    ...
    public class DEEnvironmentStyles
    {
    ...
    public static class GUIExtentions
    {
        ...
        /// Icon Field
        /// </summary>
        /// <param name="Icon">Texture 2D Icon</param>
        /// <param name="size">Icon displayed size</param>
        public static void DisplayLogo(this Texture2D Icon, string tooltip = "", float division = 1)
        {
            EditorGUILayout.LabelField(new GUIContent(Icon, tooltip), GUILayout.Height(Icon.height / division));
        }
        public static void DrawPipelineGUI(this MenuPathsRenderPipeline pipeline, int position = 0)
        {
            if (position != 0)
                GUILayout.Space(10);
            EditorGUILayout.LabelField(pipeline.ToString() + " Render Pipeline", DEEnvironmentStyles.LabelStyle(true));
            //var rect = GUILayoutUtility.GetLastRect();
            //Handles.BeginGUI();
...
namespace DEEnvironmentCore.Utils
{
    #region [DE Environment Extentions]
