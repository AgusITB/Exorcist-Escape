...
Shader "DE Environment/Surface/Moss Advance"
{
	Properties
	{
		...
		_MossBrightnessBottom("Brightness Bottom", Range( 0 , 2)) = 1
		...
		[Header(MOSS BLEND MODE)][DE_DrawerFloatEnum(Top Down _Bottom Up _Mixed)][Space(5)]_MossMode("Blend Mode", Float) = 2
		...
		[Header(PROJECTION BOTTOM UP)]_MossBlendNormalInfluenceBottom("Blend Normal Influence", Range( 0 , 1)) = 1
		_MossBlendStrengthBottom("Blend Strength", Range( 0.01 , 1)) = 1
		_MossBlendStrengthHeightBottom("Blend Strength Height ", Range( 0.01 , 10)) = 10
		_MossBlendOffsetBottom("Blend Offset", Range( -20 , 20)) = -1
	...
	SubShader
	{
		...
		Pass
		{
			...
			half _MossBlendStrengthBottom;
			half _MossBlendNormalInfluenceBottom;
			half _MossBlendStrengthHeightBottom;
			...
			float BlendSwitchfloat( float m_switch, float m_Top, float m_Bottom, float m_Mixed )
			{
				if(m_switch ==0)
					return m_Top;
				else if(m_switch ==1)
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				float BlendMode1721_g58567 = _MossMode;
				float temp_output_172_0_g58575 = BlendMode1721_g58567;
				float m_switch181_g58575 = temp_output_172_0_g58575;
				...
				float temp_output_177_0_g58575 = Blend_TopDown220_g58567;
				float3 lerpResult159_g58575 = lerp( temp_output_1165_0_g58567 , temp_output_874_0_g58567.xyz , temp_output_177_0_g58575);
				float3 m_Top181_g58575 = lerpResult159_g58575;
				float temp_output_147_0_g58590 = _MossBlendStrengthBottom;
				float3 temp_cast_15 = (temp_output_118_0_g58590).xxx;
				float3 lerpResult122_g58590 = lerp( _NInfluence , temp_output_80_0_g58590 , _MossBlendNormalInfluenceBottom);
				float dotResult92_g58590 = dot( temp_cast_15 , lerpResult122_g58590 );
				float3 temp_cast_18 = (saturate( ( ( -mul( GetObjectToWorldMatrix(), float4( v.positionOS.xyz , 0.0 ) ).xyz.y + _MossBlendOffsetBottom ) + temp_output_79_0_g58590 + temp_output_79_0_g58590 ) )).xxx;
				float dotResult94_g58590 = dot( temp_cast_18 , lerpResult122_g58590 );
				float HeightMask124_g58590 = saturate(pow(max( (((dotResult92_g58590*dotResult94_g58590)*4)+(dotResult94_g58590*2)), 0 ),_MossBlendStrengthHeightBottom));
				float WORLD_NORMAL_Y137_g58590 = ( ( 0.0 - ase_worldNormal.y ) + 1.0 );
				float lerpResult113_g58590 = lerp( 0.0 , ( temp_output_147_0_g58590 * HeightMask124_g58590 ) , WORLD_NORMAL_Y137_g58590);
				float Blend_BottomUp1699_g58567 = saturate( lerpResult113_g58590 );
				float temp_output_178_0_g58575 = Blend_BottomUp1699_g58567;
				float3 lerpResult163_g58575 = lerp( temp_output_1165_0_g58567 , temp_output_874_0_g58567.xyz , temp_output_178_0_g58575);
				float3 m_Bottom181_g58575 = lerpResult163_g58575;
				float3 lerpResult160_g58575 = lerp( lerpResult159_g58575 , lerpResult163_g58575 , temp_output_178_0_g58575);
				float3 m_Mixed181_g58575 = lerpResult160_g58575;
				float3 localBlendSwitchfloat3181_g58575 = BlendSwitchfloat3( m_switch181_g58575 , m_Top181_g58575 , m_Bottom181_g58575 , m_Mixed181_g58575 );
				float3 lerpResult1491_g58567 = lerp( temp_output_1165_0_g58567 , localBlendSwitchfloat3181_g58575 , ( _MossHeightEnable + ( ( _CATEGORY_MOSSHEIGHT + _SPACE_MOSSHEIGHT ) * 0.0 ) ));
						 ...
						 ) : SV_Target
			{
				...
				float temp_output_172_0_g58580 = _MossMode;
				float m_switch181_g58580 = temp_output_172_0_g58580;
				...
				float lerpResult170_g58590 = lerp( lerpResult110_g58590 , ( lerpResult110_g58590 + lerpResult129_g58590 ) , _MossBlendSideStrength);
				float Blend_TopDown220_g58567 = saturate( lerpResult170_g58590 );
				float temp_output_177_0_g58580 = Blend_TopDown220_g58567;
				float3 lerpResult159_g58580 = lerp( temp_output_72_0_g58567 , linearToGamma1886_g58567 , temp_output_177_0_g58580);
				float3 m_Top181_g58580 = lerpResult159_g58580;
				float3 linearToGamma1887_g58567 = FastLinearToSRGB( ( ( (_MossColorBottom).rgb * lerpResult31_g58631 ) * lerpResult31_g58631 * _MossBrightnessBottom ) );
				float temp_output_147_0_g58590 = _MossBlendStrengthBottom;
				float3 temp_cast_7 = (temp_output_118_0_g58590).xxx;
				float3 lerpResult122_g58590 = lerp( _NInfluence , temp_output_80_0_g58590 , _MossBlendNormalInfluenceBottom);
				float dotResult92_g58590 = dot( temp_cast_7 , lerpResult122_g58590 );
				float3 temp_cast_10 = (saturate( ( ( -mul( GetObjectToWorldMatrix(), float4( IN.ase_texcoord10.xyz , 0.0 ) ).xyz.y + _MossBlendOffsetBottom ) + temp_output_79_0_g58590 + temp_output_79_0_g58590 ) )).xxx;
				float dotResult94_g58590 = dot( temp_cast_10 , lerpResult122_g58590 );
				float HeightMask124_g58590 = saturate(pow(max( (((dotResult92_g58590*dotResult94_g58590)*4)+(dotResult94_g58590*2)), 0 ),_MossBlendStrengthHeightBottom));
				float WORLD_NORMAL_Y137_g58590 = ( ( 0.0 - WorldNormal.y ) + 1.0 );
				float lerpResult113_g58590 = lerp( 0.0 , ( temp_output_147_0_g58590 * HeightMask124_g58590 ) , WORLD_NORMAL_Y137_g58590);
				float Blend_BottomUp1699_g58567 = saturate( lerpResult113_g58590 );
				float temp_output_178_0_g58580 = Blend_BottomUp1699_g58567;
				float3 lerpResult163_g58580 = lerp( temp_output_72_0_g58567 , linearToGamma1887_g58567 , temp_output_178_0_g58580);
				float3 m_Bottom181_g58580 = lerpResult163_g58580;
				float3 lerpResult160_g58580 = lerp( lerpResult159_g58580 , lerpResult163_g58580 , temp_output_178_0_g58580);
				float3 m_Mixed181_g58580 = lerpResult160_g58580;
				float3 localBlendSwitchfloat3181_g58580 = BlendSwitchfloat3( m_switch181_g58580 , m_Top181_g58580 , m_Bottom181_g58580 , m_Mixed181_g58580 );
				float temp_output_1632_0_g58567 = ( _MossEnable + ( ( _CATEGORY_MOSS + _SPACE_MOSS ) * 0.0 ) );
				float3 lerpResult1463_g58567 = lerp( temp_output_72_0_g58567 , localBlendSwitchfloat3181_g58580 , temp_output_1632_0_g58567);
				...
				float BlendMode1721_g58567 = _MossMode;
				float temp_output_172_0_g58578 = BlendMode1721_g58567;
				float m_switch181_g58578 = temp_output_172_0_g58578;
				float temp_output_177_0_g58578 = Blend_TopDown220_g58567;
				float3 lerpResult159_g58578 = lerp( temp_output_73_0_g58567 , Map_Normal342_g58567 , temp_output_177_0_g58578);
				float3 m_Top181_g58578 = lerpResult159_g58578;
				float temp_output_178_0_g58578 = Blend_BottomUp1699_g58567;
				float3 lerpResult163_g58578 = lerp( temp_output_73_0_g58567 , Map_Normal342_g58567 , temp_output_178_0_g58578);
				float3 m_Bottom181_g58578 = lerpResult163_g58578;
				float3 lerpResult160_g58578 = lerp( lerpResult159_g58578 , lerpResult163_g58578 , temp_output_178_0_g58578);
				float3 m_Mixed181_g58578 = lerpResult160_g58578;
				float3 localBlendSwitchfloat3181_g58578 = BlendSwitchfloat3( m_switch181_g58578 , m_Top181_g58578 , m_Bottom181_g58578 , m_Mixed181_g58578 );
				float3 temp_output_1581_0_g58567 = BlendNormal( localBlendSwitchfloat3181_g58578 , temp_output_73_0_g58567 );
				...
				float temp_output_172_0_g58638 = BlendMode1721_g58567;
				float m_switch201_g58638 = temp_output_172_0_g58638;
				float temp_output_177_0_g58638 = Blend_TopDown220_g58567;
				float lerpResult159_g58638 = lerp( temp_output_269_0_g58567 , _MossMetallicStrength , temp_output_177_0_g58638);
				float m_Top201_g58638 = lerpResult159_g58638;
				float temp_output_178_0_g58638 = Blend_BottomUp1699_g58567;
				float lerpResult163_g58638 = lerp( temp_output_269_0_g58567 , _MossMetallicStrength , temp_output_178_0_g58638);
				float m_Bottom201_g58638 = lerpResult163_g58638;
				float lerpResult160_g58638 = lerp( lerpResult159_g58638 , lerpResult163_g58638 , temp_output_178_0_g58638);
				float m_Mixed201_g58638 = lerpResult160_g58638;
				float localBlendSwitchfloat201_g58638 = BlendSwitchfloat( m_switch201_g58638 , m_Top201_g58638 , m_Bottom201_g58638 , m_Mixed201_g58638 );
				float clampResult775_g58567 = clamp( localBlendSwitchfloat201_g58638 , 0.0 , 0.99 );
				...
				float temp_output_172_0_g58635 = BlendMode1721_g58567;
				float m_switch201_g58635 = temp_output_172_0_g58635;
				float temp_output_177_0_g58635 = Blend_TopDown220_g58567;
				float lerpResult159_g58635 = lerp( temp_output_258_0_g58567 , _MossSmoothnessStrength , temp_output_177_0_g58635);
				float m_Top201_g58635 = lerpResult159_g58635;
				float temp_output_178_0_g58635 = Blend_BottomUp1699_g58567;
				float lerpResult163_g58635 = lerp( temp_output_258_0_g58567 , _MossSmoothnessStrength , temp_output_178_0_g58635);
				float m_Bottom201_g58635 = lerpResult163_g58635;
				float lerpResult160_g58635 = lerp( lerpResult159_g58635 , lerpResult163_g58635 , temp_output_178_0_g58635);
				float m_Mixed201_g58635 = lerpResult160_g58635;
				float localBlendSwitchfloat201_g58635 = BlendSwitchfloat( m_switch201_g58635 , m_Top201_g58635 , m_Bottom201_g58635 , m_Mixed201_g58635 );
				float temp_output_298_0_g58567 = saturate( localBlendSwitchfloat201_g58635 );
				...
				float temp_output_172_0_g58641 = BlendMode1721_g58567;
				float m_switch201_g58641 = temp_output_172_0_g58641;
				float temp_output_1656_0_g58567 = saturate( ( 1.0 - _MossOcclusionStrengthAO ) );
				float temp_output_177_0_g58641 = Blend_TopDown220_g58567;
				float lerpResult159_g58641 = lerp( temp_output_801_0_g58567 , temp_output_1656_0_g58567 , temp_output_177_0_g58641);
				float m_Top201_g58641 = lerpResult159_g58641;
				float temp_output_178_0_g58641 = Blend_BottomUp1699_g58567;
				float lerpResult163_g58641 = lerp( temp_output_801_0_g58567 , temp_output_1656_0_g58567 , temp_output_178_0_g58641);
				float m_Bottom201_g58641 = lerpResult163_g58641;
				float lerpResult160_g58641 = lerp( lerpResult159_g58641 , lerpResult163_g58641 , temp_output_178_0_g58641);
				float m_Mixed201_g58641 = lerpResult160_g58641;
				float localBlendSwitchfloat201_g58641 = BlendSwitchfloat( m_switch201_g58641 , m_Top201_g58641 , m_Bottom201_g58641 , m_Mixed201_g58641 );
				float lerpResult1467_g58567 = lerp( temp_output_801_0_g58567 , localBlendSwitchfloat201_g58641 , temp_output_1632_0_g58567);
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float3 lerpResult122_g58590 = lerp( _NInfluence , temp_output_80_0_g58590 , _MossBlendNormalInfluenceBottom);
				float dotResult92_g58590 = dot( temp_cast_7 , lerpResult122_g58590 );
				float3 temp_cast_10 = (saturate( ( ( -mul( GetObjectToWorldMatrix(), float4( IN.ase_texcoord6.xyz , 0.0 ) ).xyz.y + _MossBlendOffsetBottom ) + temp_output_79_0_g58590 + temp_output_79_0_g58590 ) )).xxx;
				float dotResult94_g58590 = dot( temp_cast_10 , lerpResult122_g58590 );
				float HeightMask124_g58590 = saturate(pow(max( (((dotResult92_g58590*dotResult94_g58590)*4)+(dotResult94_g58590*2)), 0 ),_MossBlendStrengthHeightBottom));
				float WORLD_NORMAL_Y137_g58590 = ( ( 0.0 - ase_worldNormal.y ) + 1.0 );
				float lerpResult113_g58590 = lerp( 0.0 , ( temp_output_147_0_g58590 * HeightMask124_g58590 ) , WORLD_NORMAL_Y137_g58590);
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float3 lerpResult122_g58590 = lerp( _NInfluence , temp_output_80_0_g58590 , _MossBlendNormalInfluenceBottom);
				float dotResult92_g58590 = dot( temp_cast_7 , lerpResult122_g58590 );
				float3 temp_cast_10 = (saturate( ( ( -mul( GetObjectToWorldMatrix(), float4( IN.ase_texcoord4.xyz , 0.0 ) ).xyz.y + _MossBlendOffsetBottom ) + temp_output_79_0_g58590 + temp_output_79_0_g58590 ) )).xxx;
				float dotResult94_g58590 = dot( temp_cast_10 , lerpResult122_g58590 );
				float HeightMask124_g58590 = saturate(pow(max( (((dotResult92_g58590*dotResult94_g58590)*4)+(dotResult94_g58590*2)), 0 ),_MossBlendStrengthHeightBottom));
				float WORLD_NORMAL_Y137_g58590 = ( ( 0.0 - ase_worldNormal.y ) + 1.0 );
				float lerpResult113_g58590 = lerp( 0.0 , ( temp_output_147_0_g58590 * HeightMask124_g58590 ) , WORLD_NORMAL_Y137_g58590);
		...
		Pass
		{
						 ...
						 )
			{
				...
				float3 lerpResult122_g58590 = lerp( _NInfluence , temp_output_80_0_g58590 , _MossBlendNormalInfluenceBottom);
				float dotResult92_g58590 = dot( temp_cast_7 , lerpResult122_g58590 );
				float3 temp_cast_10 = (saturate( ( ( -mul( GetObjectToWorldMatrix(), float4( IN.ase_texcoord7.xyz , 0.0 ) ).xyz.y + _MossBlendOffsetBottom ) + temp_output_79_0_g58590 + temp_output_79_0_g58590 ) )).xxx;
				float dotResult94_g58590 = dot( temp_cast_10 , lerpResult122_g58590 );
				float HeightMask124_g58590 = saturate(pow(max( (((dotResult92_g58590*dotResult94_g58590)*4)+(dotResult94_g58590*2)), 0 ),_MossBlendStrengthHeightBottom));
				float WORLD_NORMAL_Y137_g58590 = ( ( 0.0 - WorldNormal.y ) + 1.0 );
				float lerpResult113_g58590 = lerp( 0.0 , ( temp_output_147_0_g58590 * HeightMask124_g58590 ) , WORLD_NORMAL_Y137_g58590);
