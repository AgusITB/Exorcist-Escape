...
Shader "DE Environment/Surface/Emission Moss"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float3 temp_output_83_0_g58591 = lerpResult31_g58631;
				float m_switch1_g58593 = _EmissiveRenderFace;
				float3 temp_output_696_0_g58591 = (_EmissiveColor).rgb;
				float3 temp_output_19_0_g58611 = temp_output_696_0_g58591;
				float temp_output_21_0_g58611 = _EmissiveIntensity;
				float lerpResult6_g58611 = lerp( temp_output_21_0_g58611 , ( temp_output_21_0_g58611 * _GlobalEmissionIntensity ) , _GlobalEmissionEnabled);
				float lerpResult9_g58611 = lerp( temp_output_21_0_g58611 , lerpResult6_g58611 , _EmissiveisGlobal);
				float3 temp_output_2_0_g58611 = ( temp_output_19_0_g58611 * lerpResult9_g58611 );
				float3 EMISSION_TINT111_g58591 = temp_output_2_0_g58611;
				float3 temp_output_690_0_g58591 = (_EmissiveGlowColor).rgb;
				float3 temp_output_19_0_g58606 = temp_output_690_0_g58591;
				float temp_output_21_0_g58606 = _EmissiveGlowIntensity;
				float lerpResult6_g58606 = lerp( temp_output_21_0_g58606 , ( temp_output_21_0_g58606 * _GlobalEmissionIntensity ) , _GlobalEmissionEnabled);
				float lerpResult9_g58606 = lerp( temp_output_21_0_g58606 , lerpResult6_g58606 , _EmissiveGlowisGlobal);
				float3 temp_output_2_0_g58606 = ( temp_output_19_0_g58606 * lerpResult9_g58606 );
				float3 EMISSION_TINTGLOW158_g58591 = temp_output_2_0_g58606;
				float localStochasticTiling2_g58630 = ( 0.0 );
				float2 UV2_g58630 = temp_output_1903_0_g58567;
				float4 TexelSize2_g58630 = _MossNormalMap_TexelSize;
				float4 Offsets2_g58630 = float4( 0,0,0,0 );
				...
				float3 tanNormal190_g58591 = unpack1541_g58567;
				float fresnelNdotV190_g58591 = dot( float3(dot(tanToWorld0,tanNormal190_g58591), dot(tanToWorld1,tanNormal190_g58591), dot(tanToWorld2,tanNormal190_g58591)), WorldViewDirection );
				float fresnelNode190_g58591 = ( 0.0 + 0.17 * pow( max( 1.0 - fresnelNdotV190_g58591 , 0.0001 ), 5.0 ) );
				float3 lerpResult195_g58591 = lerp( EMISSION_TINT111_g58591 , EMISSION_TINTGLOW158_g58591 , fresnelNode190_g58591);
				float3 lerpResult185_g58591 = lerp( EMISSION_TINT111_g58591 , lerpResult195_g58591 , _EmissiveGlowEnable);
				float3 temp_output_7_0_g58593 = lerpResult185_g58591;
				half4 color5_g58593 = IsGammaSpace() ? half4(0.003921569,0,0,0) : half4(0.000303527,0,0,0);
				float3 temp_output_6_0_g58593 = (color5_g58593).rgb;
				float dotResult8_g58596 = dot( WorldNormal , WorldViewDirection );
				float temp_output_18_0_g58593 = (1.0 + (sign( dotResult8_g58596 ) - -1.0) * (0.0 - 1.0) / (1.0 - -1.0));
				float3 lerpResult15_g58593 = lerp( temp_output_7_0_g58593 , temp_output_6_0_g58593 , temp_output_18_0_g58593);
				float3 m_Front1_g58593 = lerpResult15_g58593;
				float3 lerpResult16_g58593 = lerp( temp_output_6_0_g58593 , temp_output_7_0_g58593 , temp_output_18_0_g58593);
				float3 m_Back1_g58593 = lerpResult16_g58593;
				float3 m_Both1_g58593 = temp_output_7_0_g58593;
				float3 localEmissiveCullfloat3switch1_g58593 = EmissiveCullfloat3switch( m_switch1_g58593 , m_Front1_g58593 , m_Back1_g58593 , m_Both1_g58593 );
				float3 temp_output_507_0_g58591 = localEmissiveCullfloat3switch1_g58593;
				float3 lerpResult378_g58591 = lerp( temp_output_83_0_g58591 , ( temp_output_83_0_g58591 * saturate( temp_output_507_0_g58591 ) ) , _EmissiveAffectAlbedoBias);
				float temp_output_674_0_g58591 = ( _EmissiveEnable + ( ( _CATEGORY_EMISSION + _SPACE_EMISSION + _EmissionFlags ) * 0.0 ) );
				float3 lerpResult384_g58591 = lerp( temp_output_83_0_g58591 , lerpResult378_g58591 , temp_output_674_0_g58591);
				float3 linearToGamma1886_g58567 = FastLinearToSRGB( ( ( (_MossColorTop).rgb * lerpResult384_g58591 ) * lerpResult384_g58591 * _MossBrightnessTop ) );
				float temp_output_16_0_g58590 = _MossBlendStrength;
				...
				float3 temp_cast_6 = (saturate( ( ( mul( GetObjectToWorldMatrix(), float4( IN.ase_texcoord10.xyz , 0.0 ) ).xyz.y - ( 1.0 - _MossBlendOffset ) ) + temp_output_79_0_g58590 + temp_output_79_0_g58590 ) )).xxx;
				float dotResult93_g58590 = dot( temp_cast_6 , lerpResult90_g58590 );
				float HeightMask111_g58590 = saturate(pow(max( (((dotResult127_g58590*dotResult93_g58590)*4)+(dotResult93_g58590*2)), 0 ),_MossBlendStrengthHeight));
				float temp_output_95_0_g58590 = ( temp_output_16_0_g58590 * HeightMask111_g58590 );
				float WORLD_NORMAL_Z136_g58590 = ( 1.0 * WorldNormal.y );
				float lerpResult110_g58590 = lerp( 0.0 , temp_output_95_0_g58590 , WORLD_NORMAL_Z136_g58590);
				float3 temp_cast_7 = (0.5).xxx;
				float WORLD_NORMAL_X144_g58590 = ( ( abs( WorldNormal ) - temp_cast_7 ).x + 1.3 );
				float lerpResult129_g58590 = lerp( 0.0 , temp_output_95_0_g58590 , WORLD_NORMAL_X144_g58590);
				float lerpResult170_g58590 = lerp( lerpResult110_g58590 , ( lerpResult110_g58590 + lerpResult129_g58590 ) , _MossBlendSideStrength);
				float Blend_TopDown220_g58567 = saturate( lerpResult170_g58590 );
				...
				half4 color1404_g58567 = IsGammaSpace() ? half4(0.003921569,0,0,0) : half4(0.000303527,0,0,0);
				float3 temp_output_1921_0_g58567 = (color1404_g58567).rgb;
				half4 color26_g58591 = IsGammaSpace() ? half4(0.003921569,0,0,0) : half4(0.000303527,0,0,0);
				float3 temp_output_489_0_g58591 = (color26_g58591).rgb;
				float3 lerpResult65_g58591 = lerp( temp_output_489_0_g58591 , temp_output_507_0_g58591 , temp_output_674_0_g58591);
				float3 Emission1659_g58567 = lerpResult65_g58591;
				float temp_output_177_0_g58642 = Blend_TopDown220_g58567;
				float3 lerpResult197_g58642 = lerp( temp_output_1921_0_g58567 , Emission1659_g58567 , temp_output_177_0_g58642);
				float3 lerpResult1618_g58567 = lerp( temp_output_1921_0_g58567 , lerpResult197_g58642 , temp_output_1632_0_g58567);
				...
				float3 Emission = lerpResult1618_g58567;
				float3 Specular = 0.5;
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				o.ase_texcoord8.xy = vertexToFrag70_g58583;
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float3 tanNormal190_g58591 = unpack1541_g58567;
				float fresnelNdotV190_g58591 = dot( float3(dot(tanToWorld0,tanNormal190_g58591), dot(tanToWorld1,tanNormal190_g58591), dot(tanToWorld2,tanNormal190_g58591)), ase_worldViewDir );
				float fresnelNode190_g58591 = ( 0.0 + 0.17 * pow( max( 1.0 - fresnelNdotV190_g58591 , 0.0001 ), 5.0 ) );
				float3 lerpResult195_g58591 = lerp( EMISSION_TINT111_g58591 , EMISSION_TINTGLOW158_g58591 , fresnelNode190_g58591);
				float3 lerpResult185_g58591 = lerp( EMISSION_TINT111_g58591 , lerpResult195_g58591 , _EmissiveGlowEnable);
				float3 temp_output_7_0_g58593 = lerpResult185_g58591;
				...
				float dotResult8_g58596 = dot( ase_worldNormal , ase_worldViewDir );
				float temp_output_18_0_g58593 = (1.0 + (sign( dotResult8_g58596 ) - -1.0) * (0.0 - 1.0) / (1.0 - -1.0));
				float3 lerpResult15_g58593 = lerp( temp_output_7_0_g58593 , temp_output_6_0_g58593 , temp_output_18_0_g58593);
				float3 m_Front1_g58593 = lerpResult15_g58593;
				float3 lerpResult16_g58593 = lerp( temp_output_6_0_g58593 , temp_output_7_0_g58593 , temp_output_18_0_g58593);
				...
				float3 linearToGamma1886_g58567 = FastLinearToSRGB( ( ( (_MossColorTop).rgb * lerpResult384_g58591 ) * lerpResult384_g58591 * _MossBrightnessTop ) );
				float temp_output_16_0_g58590 = _MossBlendStrength;
				float2 vertexToFrag70_g58583 = IN.ase_texcoord8.xy;
				float4 transform1505_g58567 = mul(GetObjectToWorldMatrix(),IN.ase_texcoord9);
				float temp_output_79_0_g58590 = ( SAMPLE_TEXTURE2D( _MossNoiseMap, sampler_MossNoiseMap, vertexToFrag70_g58583 ).r - ( ( (transform1505_g58567).w - _MossNoiseOffset ) / _MossNoiseLength ) );
				float temp_output_118_0_g58590 = saturate( temp_output_79_0_g58590 );
				float3 temp_cast_2 = (temp_output_118_0_g58590).xxx;
				float3 _NInfluence = float3(1,1,1);
				...
				float3 lerpResult90_g58590 = lerp( _NInfluence , temp_output_80_0_g58590 , _MossBlendNormalInfluence);
				float dotResult127_g58590 = dot( temp_cast_2 , lerpResult90_g58590 );
				float3 temp_cast_6 = (saturate( ( ( mul( GetObjectToWorldMatrix(), float4( IN.ase_texcoord9.xyz , 0.0 ) ).xyz.y - ( 1.0 - _MossBlendOffset ) ) + temp_output_79_0_g58590 + temp_output_79_0_g58590 ) )).xxx;
				float dotResult93_g58590 = dot( temp_cast_6 , lerpResult90_g58590 );
				float HeightMask111_g58590 = saturate(pow(max( (((dotResult127_g58590*dotResult93_g58590)*4)+(dotResult93_g58590*2)), 0 ),_MossBlendStrengthHeight));
				float temp_output_95_0_g58590 = ( temp_output_16_0_g58590 * HeightMask111_g58590 );
				float WORLD_NORMAL_Z136_g58590 = ( 1.0 * ase_worldNormal.y );
				float lerpResult110_g58590 = lerp( 0.0 , temp_output_95_0_g58590 , WORLD_NORMAL_Z136_g58590);
				float3 temp_cast_7 = (0.5).xxx;
				float WORLD_NORMAL_X144_g58590 = ( ( abs( ase_worldNormal ) - temp_cast_7 ).x + 1.3 );
				float lerpResult129_g58590 = lerp( 0.0 , temp_output_95_0_g58590 , WORLD_NORMAL_X144_g58590);
				float lerpResult170_g58590 = lerp( lerpResult110_g58590 , ( lerpResult110_g58590 + lerpResult129_g58590 ) , _MossBlendSideStrength);
				float Blend_TopDown220_g58567 = saturate( lerpResult170_g58590 );
				float temp_output_177_0_g58632 = Blend_TopDown220_g58567;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float3 lerpResult90_g58590 = lerp( _NInfluence , temp_output_80_0_g58590 , _MossBlendNormalInfluence);
				float dotResult127_g58590 = dot( temp_cast_2 , lerpResult90_g58590 );
				float3 temp_cast_6 = (saturate( ( ( mul( GetObjectToWorldMatrix(), float4( IN.ase_texcoord7.xyz , 0.0 ) ).xyz.y - ( 1.0 - _MossBlendOffset ) ) + temp_output_79_0_g58590 + temp_output_79_0_g58590 ) )).xxx;
				float dotResult93_g58590 = dot( temp_cast_6 , lerpResult90_g58590 );
				float HeightMask111_g58590 = saturate(pow(max( (((dotResult127_g58590*dotResult93_g58590)*4)+(dotResult93_g58590*2)), 0 ),_MossBlendStrengthHeight));
				float temp_output_95_0_g58590 = ( temp_output_16_0_g58590 * HeightMask111_g58590 );
				float WORLD_NORMAL_Z136_g58590 = ( 1.0 * ase_worldNormal.y );
...
/*ASEBEGIN
Version=19303
Node;AmplifyShaderEditor.FunctionNode;449;672,-640;Inherit;False;DESF Core Lit;1;;57931;e0cdd7758f4404849b063afff4596424;39,442,2,1557,0,1749,0,1556,0,2284,0,2283,0,2213,0,2481,0,2411,0,2399,0,2172,0,2282,0,3300,0,3301,0,3299,0,2132,0,3146,0,2311,0,3108,0,3119,0,3076,0,3408,0,3291,0,3290,0,3289,0,3287,0,96,0,2591,0,2559,0,1368,0,2125,0,2131,0,2028,0,1333,0,2126,0,1896,0,1415,0,830,0,2523,1;1;1234;FLOAT3;0,0,0;False;17;FLOAT3;38;FLOAT3;35;FLOAT;37;FLOAT3;1922;FLOAT;33;FLOAT;34;FLOAT;46;FLOAT;814;FLOAT;1660;FLOAT3;656;FLOAT3;657;FLOAT3;655;FLOAT3;1235;FLOAT3;2760;SAMPLERSTATE;1819;SAMPLERSTATE;1824;SAMPLERSTATE;1818
Node;AmplifyShaderEditor.FunctionNode;421;1056,-640;Inherit;False;DESF Module Moss;161;;58567;e79f0fabe78a15e44bdbbf0ff893d6a8;20,908,2,1833,1,1851,1,1708,1,1714,1,1715,1,1716,1,1710,1,1709,1,1713,1,1071,0,1074,0,1075,0,1246,0,1072,0,1073,0,1070,0,1449,1,1447,1,1199,1;6;72;FLOAT3;1,1,1;False;73;FLOAT3;1,1,1;False;269;FLOAT;0.1;False;258;FLOAT;0;False;801;FLOAT;0;False;1165;FLOAT3;0,0,0;False;7;FLOAT3;0;FLOAT3;68;FLOAT3;1181;FLOAT;270;FLOAT;259;FLOAT;813;FLOAT3;860
