...
Shader "DE Environment/Surface/Height Detail"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				float3 temp_output_1234_0_g57922 = _Vector8;
				...
				float3 Displacment2502_g57922 = (SAMPLE_TEXTURE2D_LOD( _ParallaxMap, sampler_ParallaxMap, UV213_g57922, 0.0 )).rgb;
				float3 lerpResult2554_g57922 = lerp( Displacment2502_g57922 , ( 1.0 - Displacment2502_g57922 ) , _DisplacementBlendInversion);
				float3 lerpResult2551_g57922 = lerp( _Vector8 , ( v.normalOS * ( lerpResult2554_g57922 * _DisplacementStrength ) ) , ( _DisplacementEnable + ( ( _CATEGORY_DISPLACEMENT + _SPACE_DISPLACEMENT ) * 0.0 ) ));
				...
				float3 vertexValue = ( temp_output_1234_0_g57922 + lerpResult2551_g57922 );
						 ...
						 ) : SV_Target
			{
				...
				float2 UV119_g58318 = UV213_g57922;
				...
				float3 lerpResult2520_g57922 = lerp( unpack1891_g57922 , localCombineSamplesSmooth150_g58318 , _DisplacementNormalReconstructed);
				float DisplacementEnable2553_g57922 = _DisplacementEnable;
				float3 lerpResult2522_g57922 = lerp( unpack1891_g57922 , lerpResult2520_g57922 , DisplacementEnable2553_g57922);
				float3 temp_output_38_0_g57888 = lerpResult2522_g57922;
				...
				float3 break2680_g57922 = lerpResult2522_g57922;
