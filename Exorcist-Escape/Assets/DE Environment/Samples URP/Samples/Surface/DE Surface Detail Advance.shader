...
Shader "DE Environment/Surface/Detail Advance"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float4 tex2DNode2050_g57857 = SAMPLE_TEXTURE2D( _MaskMap, sampler_MaskMap, UV213_g57857 );
				float MASK_B1377_g57857 = tex2DNode2050_g57857.b;
				
				float MASK_G158_g57857 = tex2DNode2050_g57857.g;
				float temp_output_2651_0_g57857 = ( 1.0 - MASK_G158_g57857 );
				float lerpResult2650_g57857 = lerp( MASK_G158_g57857 , temp_output_2651_0_g57857 , _SmoothnessSource);
				float temp_output_2693_0_g57857 = ( lerpResult2650_g57857 * _SmoothnessStrength );
				...
				float lerpResult2636_g57857 = lerp( temp_output_2693_0_g57857 , ( temp_output_2693_0_g57857 - fresnelNode2685_g57857 ) , _SmoothnessFresnelEnable);
				
				float MASK_R1378_g57857 = tex2DNode2050_g57857.r;
				float lerpResult3415_g57857 = lerp( 1.0 , MASK_R1378_g57857 , _OcclusionStrengthAO);
				float lerpResult3414_g57857 = lerp( 1.0 , IN.ase_color.a , _OcclusionStrengthAO);
				float lerpResult2709_g57857 = lerp( lerpResult3415_g57857 , lerpResult3414_g57857 , _OcclusionSource);
				float temp_output_2730_0_g57857 = saturate( lerpResult2709_g57857 );
				...
				float3 Emission = 0;
				float3 Specular = 0.5;
				float Metallic = ( _MetallicStrength * MASK_B1377_g57857 );
				float Smoothness = saturate( lerpResult2636_g57857 );
				float Occlusion = temp_output_2730_0_g57857;
				float Alpha = 1;
...
ASEEND*/
//CHKSM=6D7B87E9C558E9308FD19DF8F4FF0417FB796B1E