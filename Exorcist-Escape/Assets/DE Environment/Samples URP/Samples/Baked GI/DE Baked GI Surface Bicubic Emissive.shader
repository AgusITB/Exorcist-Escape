...
Shader "DE Environment/Baked GI/Surface Bicubic Emissive"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				float2 temp_output_1955_0_g58271 = (_MainUVs).xy;
				float2 temp_output_1953_0_g58271 = (_MainUVs).zw;
				float2 Offset235_g58525 = temp_output_1953_0_g58271;
				float2 temp_output_41_0_g58525 = ( ( localfloat2switchUVMode80_g58525 * temp_output_1955_0_g58271 ) + Offset235_g58525 );
				float2 vertexToFrag70_g58525 = temp_output_41_0_g58525;
				o.ase_texcoord8.xy = vertexToFrag70_g58525;
				
				float temp_output_6_0_g58267 = _EmissivePanningRotation;
				float temp_output_200_0_g58267 = radians( temp_output_6_0_g58267 );
				float temp_output_13_0_g58267 = cos( temp_output_200_0_g58267 );
				float2 temp_output_9_0_g58267 = float2( 0.5,0.5 );
				float2 break39_g58267 = ( v.texcoord.xy - temp_output_9_0_g58267 );
				float temp_output_14_0_g58267 = sin( temp_output_200_0_g58267 );
				float2 appendResult36_g58267 = (float2(( ( temp_output_13_0_g58267 * break39_g58267.x ) + ( temp_output_14_0_g58267 * break39_g58267.y ) ) , ( ( temp_output_13_0_g58267 * break39_g58267.y ) - ( temp_output_14_0_g58267 * break39_g58267.x ) )));
				float2 Offset235_g58267 = (_EmissiveColorMapUVs).zw;
				float2 temp_output_41_0_g58267 = ( ( ( appendResult36_g58267 * ( (_EmissiveColorMapUVs).xy / 1.0 ) ) + temp_output_9_0_g58267 ) + Offset235_g58267 );
				float2 _ConstantAnchor = float2(0.5,0.5);
				float2 vertexToFrag70_g58267 = ( temp_output_41_0_g58267 - ( ( ( (_EmissiveColorMapUVs).xy / 1.0 ) * _ConstantAnchor ) - _ConstantAnchor ) );
				o.ase_texcoord9.zw = vertexToFrag70_g58267;
						 ...
						 ) : SV_Target
			{
				...
				float localStochasticTiling159_g58300 = ( 0.0 );
				float2 vertexToFrag70_g58525 = IN.ase_texcoord8.xy;
				float2 UV213_g58271 = vertexToFrag70_g58525;
				float2 UV159_g58300 = UV213_g58271;
				float4 TexelSize159_g58300 = _BumpMap_TexelSize;
				float4 Offsets159_g58300 = float4( 0,0,0,0 );
				float2 Weights159_g58300 = float2( 0,0 );
				{
				UV159_g58300 = UV159_g58300 * TexelSize159_g58300.zw - 0.5;
				float2 f = frac( UV159_g58300 );
				UV159_g58300 -= f;
				...
				float4 c = float4( UV159_g58300.x - 0.5, UV159_g58300.x + 1.5, UV159_g58300.y - 0.5, UV159_g58300.y + 1.5 );
				float4 s = float4( xc.x + xc.y, xc.z + xc.w, yc.x + yc.y, yc.z + yc.w );
				float w0 = s.x / ( s.x + s.y );
				float w1 = s.z / ( s.z + s.w );
				Offsets159_g58300 = ( c + float4( xc.y, xc.w, yc.y, yc.w ) / s ) * TexelSize159_g58300.xyxy;
				Weights159_g58300 = float2( w0, w1 );
				}
				float4 Input_FetchOffsets70_g58299 = Offsets159_g58300;
				float2 Input_FetchWeights143_g58299 = Weights159_g58300;
				float2 break46_g58299 = Input_FetchWeights143_g58299;
				float4 lerpResult20_g58299 = lerp( SAMPLE_TEXTURE2D( _BumpMap, sampler_BumpMap, (Input_FetchOffsets70_g58299).yw ) , SAMPLE_TEXTURE2D( _BumpMap, sampler_BumpMap, (Input_FetchOffsets70_g58299).xw ) , break46_g58299.x);
				float4 lerpResult40_g58299 = lerp( SAMPLE_TEXTURE2D( _BumpMap, sampler_BumpMap, (Input_FetchOffsets70_g58299).yz ) , SAMPLE_TEXTURE2D( _BumpMap, sampler_BumpMap, (Input_FetchOffsets70_g58299).xz ) , break46_g58299.x);
				float4 lerpResult22_g58299 = lerp( lerpResult20_g58299 , lerpResult40_g58299 , break46_g58299.y);
				float4 Output_Fetch2D44_g58299 = lerpResult22_g58299;
				float4 NORMAL_RGBA1382_g58271 = Output_Fetch2D44_g58299;
				float3 unpack1891_g58271 = UnpackNormalScale( NORMAL_RGBA1382_g58271, _NormalStrength );
				unpack1891_g58271.z = lerp( 1, unpack1891_g58271.z, saturate(_NormalStrength) );
				float3 temp_output_1987_35 = unpack1891_g58271;
				...
				float3 temp_output_1923_0_g58271 = (_BaseColor).rgb;
				float localStochasticTiling159_g58289 = ( 0.0 );
				float2 UV159_g58289 = UV213_g58271;
				float4 TexelSize159_g58289 = _MainTex_TexelSize;
				float4 Offsets159_g58289 = float4( 0,0,0,0 );
				float2 Weights159_g58289 = float2( 0,0 );
				{
				UV159_g58289 = UV159_g58289 * TexelSize159_g58289.zw - 0.5;
				float2 f = frac( UV159_g58289 );
				UV159_g58289 -= f;
				float4 xn = float4( 1.0, 2.0, 3.0, 4.0 ) - f.xxxx;
				float4 yn = float4( 1.0, 2.0, 3.0, 4.0 ) - f.yyyy;
				float4 xs = xn * xn * xn;
				...
				float4 xc = float4( xv.xyz, 6.0 - xv.x - xv.y - xv.z );
				float4 yc = float4( yv.xyz, 6.0 - yv.x - yv.y - yv.z );
				float4 c = float4( UV159_g58289.x - 0.5, UV159_g58289.x + 1.5, UV159_g58289.y - 0.5, UV159_g58289.y + 1.5 );
				float4 s = float4( xc.x + xc.y, xc.z + xc.w, yc.x + yc.y, yc.z + yc.w );
				float w0 = s.x / ( s.x + s.y );
				float w1 = s.z / ( s.z + s.w );
				Offsets159_g58289 = ( c + float4( xc.y, xc.w, yc.y, yc.w ) / s ) * TexelSize159_g58289.xyxy;
				Weights159_g58289 = float2( w0, w1 );
				}
				float4 Input_FetchOffsets70_g58295 = Offsets159_g58289;
				float2 Input_FetchWeights143_g58295 = Weights159_g58289;
				float2 break46_g58295 = Input_FetchWeights143_g58295;
				float4 lerpResult20_g58295 = lerp( SAMPLE_TEXTURE2D( _MainTex, sampler_MainTex, (Input_FetchOffsets70_g58295).yw ) , SAMPLE_TEXTURE2D( _MainTex, sampler_MainTex, (Input_FetchOffsets70_g58295).xw ) , break46_g58295.x);
				float4 lerpResult40_g58295 = lerp( SAMPLE_TEXTURE2D( _MainTex, sampler_MainTex, (Input_FetchOffsets70_g58295).yz ) , SAMPLE_TEXTURE2D( _MainTex, sampler_MainTex, (Input_FetchOffsets70_g58295).xz ) , break46_g58295.x);
				float4 lerpResult22_g58295 = lerp( lerpResult20_g58295 , lerpResult40_g58295 , break46_g58295.y);
				float4 Output_Fetch2D44_g58295 = lerpResult22_g58295;
				float3 ALBEDO_RGBA1381_g58271 = (Output_Fetch2D44_g58295).rgb;
				float3 temp_output_3_0_g58271 = ( temp_output_1923_0_g58271 * ALBEDO_RGBA1381_g58271 * _Brightness );
				float3 temp_output_1987_38 = temp_output_3_0_g58271;
				...
				half4 color26_g58263 = IsGammaSpace() ? half4(0.003921569,0,0,0) : half4(0.000303527,0,0,0);
				float3 temp_output_489_0_g58263 = (color26_g58263).rgb;
				float m_switch690_g58263 = _EmissiveRenderFace;
				float3 temp_output_83_0_g58263 = temp_output_1987_38;
				float3 temp_output_19_0_g58265 = (_EmissiveColor).rgb;
				float temp_output_21_0_g58265 = _EmissiveIntensity;
				float3 temp_output_26_0_g58265 = ( temp_output_19_0_g58265 * temp_output_21_0_g58265 );
				float3 temp_output_459_22_g58263 = temp_output_26_0_g58265;
				float2 vertexToFrag70_g58267 = IN.ase_texcoord9.zw;
				float3 lerpResult679_g58263 = lerp( temp_output_83_0_g58263 , temp_output_459_22_g58263 , (SAMPLE_TEXTURE2D( _EmissiveColorMap, sampler_MainTex, vertexToFrag70_g58267 )).rgb);
				float3 lerpResult369_g58263 = lerp( temp_output_83_0_g58263 , lerpResult679_g58263 , saturate( ( 1.0 - ( ( distance( (_EmissiveColorMaskingColor).rgb , temp_output_83_0_g58263 ) - _EmissiveColorMaskingRange ) / max( _EmissiveColorMaskingFuzziness , 1E-05 ) ) ) ));
				float3 lerpResult374_g58263 = lerp( lerpResult679_g58263 , lerpResult369_g58263 , _EmissiveColorMaskingEnable);
				float3 Albedo_In99_g58263 = temp_output_83_0_g58263;
				float dotResult695_g58263 = dot( WorldNormal , WorldViewDirection );
				float temp_output_696_0_g58263 = (1.0 + (sign( dotResult695_g58263 ) - -1.0) * (0.0 - 1.0) / (1.0 - -1.0));
				float3 lerpResult689_g58263 = lerp( lerpResult374_g58263 , Albedo_In99_g58263 , temp_output_696_0_g58263);
				float3 m_Front690_g58263 = lerpResult689_g58263;
				float3 lerpResult697_g58263 = lerp( Albedo_In99_g58263 , lerpResult374_g58263 , temp_output_696_0_g58263);
				float3 m_Back690_g58263 = lerpResult697_g58263;
				float3 m_Both690_g58263 = lerpResult374_g58263;
				float3 localEmissiveCullfloat3switch690_g58263 = EmissiveCullfloat3switch( m_switch690_g58263 , m_Front690_g58263 , m_Back690_g58263 , m_Both690_g58263 );
				float3 lerpResult65_g58263 = lerp( temp_output_489_0_g58263 , localEmissiveCullfloat3switch690_g58263 , ( _EmissiveEnable + ( ( _CATEGORY_EMISSION + _SPACE_EMISSION + _EmissionFlags ) * 0.0 ) ));
				
				float localStochasticTiling159_g58292 = ( 0.0 );
				float2 UV159_g58292 = UV213_g58271;
				float4 TexelSize159_g58292 = _MaskMap_TexelSize;
				...
				float4 Input_FetchOffsets70_g58294 = Offsets159_g58292;
				float2 Input_FetchWeights143_g58294 = Weights159_g58292;
				float2 break46_g58294 = Input_FetchWeights143_g58294;
				float4 lerpResult20_g58294 = lerp( SAMPLE_TEXTURE2D( _MaskMap, sampler_MaskMap, (Input_FetchOffsets70_g58294).yw ) , SAMPLE_TEXTURE2D( _MaskMap, sampler_MaskMap, (Input_FetchOffsets70_g58294).xw ) , break46_g58294.x);
				float4 lerpResult40_g58294 = lerp( SAMPLE_TEXTURE2D( _MaskMap, sampler_MaskMap, (Input_FetchOffsets70_g58294).yz ) , SAMPLE_TEXTURE2D( _MaskMap, sampler_MaskMap, (Input_FetchOffsets70_g58294).xz ) , break46_g58294.x);
				float4 lerpResult22_g58294 = lerp( lerpResult20_g58294 , lerpResult40_g58294 , break46_g58294.y);
				float4 Output_Fetch2D44_g58294 = lerpResult22_g58294;
				float4 break50_g58294 = Output_Fetch2D44_g58294;
				float MASK_B1377_g58271 = break50_g58294.b;
				
				float MASK_G158_g58271 = break50_g58294.g;
				float temp_output_2651_0_g58271 = ( 1.0 - MASK_G158_g58271 );
				float lerpResult2650_g58271 = lerp( MASK_G158_g58271 , temp_output_2651_0_g58271 , _SmoothnessSource);
				float temp_output_2693_0_g58271 = ( lerpResult2650_g58271 * _SmoothnessStrength );
				float2 appendResult2645_g58271 = (float2(WorldViewDirection.xy));
				float3 appendResult2644_g58271 = (float3(appendResult2645_g58271 , ( WorldViewDirection.z / 1.06 )));
				float3 break2680_g58271 = unpack1891_g58271;
				float3 normalizeResult2641_g58271 = normalize( ( ( WorldTangent * break2680_g58271.x ) + ( WorldBiTangent * break2680_g58271.y ) + ( WorldNormal * break2680_g58271.z ) ) );
				float3 Normal_Per_Pixel2690_g58271 = normalizeResult2641_g58271;
				float fresnelNdotV2685_g58271 = dot( normalize( Normal_Per_Pixel2690_g58271 ), appendResult2644_g58271 );
				float fresnelNode2685_g58271 = ( 0.0 + ( 1.0 - _SmoothnessFresnelScale ) * pow( max( 1.0 - fresnelNdotV2685_g58271 , 0.0001 ), _SmoothnessFresnelPower ) );
				float lerpResult2636_g58271 = lerp( temp_output_2693_0_g58271 , ( temp_output_2693_0_g58271 - fresnelNode2685_g58271 ) , _SmoothnessFresnelEnable);
				
				float MASK_R1378_g58271 = break50_g58294.r;
				float lerpResult3415_g58271 = lerp( 1.0 , MASK_R1378_g58271 , _OcclusionStrengthAO);
				float lerpResult3414_g58271 = lerp( 1.0 , IN.ase_color.a , _OcclusionStrengthAO);
				float lerpResult2709_g58271 = lerp( lerpResult3415_g58271 , lerpResult3414_g58271 , _OcclusionSource);
				float temp_output_2730_0_g58271 = saturate( lerpResult2709_g58271 );
				...
				float3 Emission = lerpResult65_g58263;
				float3 Specular = 0.5;
				float Metallic = ( _MetallicStrength * MASK_B1377_g58271 );
				float Smoothness = saturate( lerpResult2636_g58271 );
				float Occlusion = temp_output_2730_0_g58271;
				float Alpha = 1;
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				float temp_output_13_0_g58267 = cos( temp_output_200_0_g58267 );
				float2 temp_output_9_0_g58267 = float2( 0.5,0.5 );
				float2 break39_g58267 = ( v.texcoord0.xy - temp_output_9_0_g58267 );
				float temp_output_14_0_g58267 = sin( temp_output_200_0_g58267 );
				float2 appendResult36_g58267 = (float2(( ( temp_output_13_0_g58267 * break39_g58267.x ) + ( temp_output_14_0_g58267 * break39_g58267.y ) ) , ( ( temp_output_13_0_g58267 * break39_g58267.y ) - ( temp_output_14_0_g58267 * break39_g58267.x ) )));
				float2 Offset235_g58267 = (_EmissiveColorMapUVs).zw;
				float2 temp_output_41_0_g58267 = ( ( ( appendResult36_g58267 * ( (_EmissiveColorMapUVs).xy / 1.0 ) ) + temp_output_9_0_g58267 ) + Offset235_g58267 );
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float3 lerpResult374_g58263 = lerp( lerpResult679_g58263 , lerpResult369_g58263 , _EmissiveColorMaskingEnable);
				float3 Albedo_In99_g58263 = temp_output_83_0_g58263;
				float dotResult695_g58263 = dot( ase_worldNormal , ase_worldViewDir );
				float temp_output_696_0_g58263 = (1.0 + (sign( dotResult695_g58263 ) - -1.0) * (0.0 - 1.0) / (1.0 - -1.0));
				float3 lerpResult689_g58263 = lerp( lerpResult374_g58263 , Albedo_In99_g58263 , temp_output_696_0_g58263);
				float3 m_Front690_g58263 = lerpResult689_g58263;
				float3 lerpResult697_g58263 = lerp( Albedo_In99_g58263 , lerpResult374_g58263 , temp_output_696_0_g58263);
...
Node;AmplifyShaderEditor.FunctionNode;1972;-7616,-4656;Inherit;False;DESF Module Emission Baked;161;;58263;e63fb1ab597bae24ab95c456de610223;2,575,1,376,1;2;83;FLOAT3;0,0,0;False;613;SAMPLERSTATE;;False;1;FLOAT3;0
Node;AmplifyShaderEditor.FunctionNode;1987;-8000,-4608;Inherit;False;DESF Core Lit;1;;58271;e0cdd7758f4404849b063afff4596424;39,442,2,1557,0,1749,0,1556,0,2284,2,2283,2,2213,2,2481,2,2411,2,2399,2,2172,2,2282,2,3300,2,3301,2,3299,2,2132,2,3146,2,2311,2,3108,0,3119,0,3076,0,3408,0,3291,0,3290,0,3289,0,3287,0,96,0,2591,0,2559,0,1368,0,2125,0,2131,0,2028,0,1333,0,2126,0,1896,0,1415,0,830,0,2523,1;1;1234;FLOAT3;0,0,0;False;17;FLOAT3;38;FLOAT3;35;FLOAT;37;FLOAT3;1922;FLOAT;33;FLOAT;34;FLOAT;46;FLOAT;814;FLOAT;1660;FLOAT3;656;FLOAT3;657;FLOAT3;655;FLOAT3;1235;FLOAT3;2760;SAMPLERSTATE;1819;SAMPLERSTATE;1824;SAMPLERSTATE;1818
Node;AmplifyShaderEditor.FunctionNode;1986;-7632,-4432;Inherit;False;DESF Module Lighting;186;;58567;fcb6e6c168e1c7445afa5890558bc54f;11,184,1,1277,0,1278,0,1279,0,1282,0,1281,0,1276,0,508,0,507,1,463,6,1381,1;8;218;FLOAT3;0,0,0;False;33;FLOAT3;0,0,1;False;1263;FLOAT;0;False;1262;FLOAT;0;False;1261;FLOAT;0;False;1260;FLOAT;0;False;1265;FLOAT2;0,0;False;1266;FLOAT2;0,0;False;1;FLOAT3;220
Node;AmplifyShaderEditor.FunctionNode;1988;-7632,-4304;Inherit;False;DESF Module Baked GI;179;;58572;b6a189f4451929648b1c71f1360a6ff5;9,1300,1,1281,0,1282,0,973,1,974,1,975,1,951,1,954,1,971,1;4;33;FLOAT3;0,0,1;False;902;FLOAT3;0,0,1;False;1265;FLOAT2;0,0;False;1266;FLOAT2;0,0;False;2;FLOAT3;792;FLOAT3;790
