...
Shader "DE Environment/Baked GI/Surface Bicubic Specular Emissive"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				float2 temp_output_1955_0_g58263 = (_MainUVs).xy;
				float2 temp_output_1953_0_g58263 = (_MainUVs).zw;
				float2 Offset235_g58525 = temp_output_1953_0_g58263;
				float2 temp_output_41_0_g58525 = ( ( localfloat2switchUVMode80_g58525 * temp_output_1955_0_g58263 ) + Offset235_g58525 );
				float2 vertexToFrag70_g58525 = temp_output_41_0_g58525;
				o.ase_texcoord8.xy = vertexToFrag70_g58525;
				
				float temp_output_6_0_g58183 = _EmissivePanningRotation;
				float temp_output_200_0_g58183 = radians( temp_output_6_0_g58183 );
				float temp_output_13_0_g58183 = cos( temp_output_200_0_g58183 );
				float2 temp_output_9_0_g58183 = float2( 0.5,0.5 );
				float2 break39_g58183 = ( v.texcoord.xy - temp_output_9_0_g58183 );
				float temp_output_14_0_g58183 = sin( temp_output_200_0_g58183 );
				float2 appendResult36_g58183 = (float2(( ( temp_output_13_0_g58183 * break39_g58183.x ) + ( temp_output_14_0_g58183 * break39_g58183.y ) ) , ( ( temp_output_13_0_g58183 * break39_g58183.y ) - ( temp_output_14_0_g58183 * break39_g58183.x ) )));
				float2 Offset235_g58183 = (_EmissiveColorMapUVs).zw;
				float2 temp_output_41_0_g58183 = ( ( ( appendResult36_g58183 * ( (_EmissiveColorMapUVs).xy / 1.0 ) ) + temp_output_9_0_g58183 ) + Offset235_g58183 );
				float2 _ConstantAnchor = float2(0.5,0.5);
				float2 vertexToFrag70_g58183 = ( temp_output_41_0_g58183 - ( ( ( (_EmissiveColorMapUVs).xy / 1.0 ) * _ConstantAnchor ) - _ConstantAnchor ) );
				o.ase_texcoord9.zw = vertexToFrag70_g58183;
						 ...
						 ) : SV_Target
			{
				...
				float2 UV213_g58263 = vertexToFrag70_g58525;
				float2 UV159_g58292 = UV213_g58263;
				float4 TexelSize159_g58292 = _BumpMap_TexelSize;
				...
				float4 Input_FetchOffsets70_g58291 = Offsets159_g58292;
				float2 Input_FetchWeights143_g58291 = Weights159_g58292;
				float2 break46_g58291 = Input_FetchWeights143_g58291;
				float4 lerpResult20_g58291 = lerp( SAMPLE_TEXTURE2D( _BumpMap, sampler_BumpMap, (Input_FetchOffsets70_g58291).yw ) , SAMPLE_TEXTURE2D( _BumpMap, sampler_BumpMap, (Input_FetchOffsets70_g58291).xw ) , break46_g58291.x);
				float4 lerpResult40_g58291 = lerp( SAMPLE_TEXTURE2D( _BumpMap, sampler_BumpMap, (Input_FetchOffsets70_g58291).yz ) , SAMPLE_TEXTURE2D( _BumpMap, sampler_BumpMap, (Input_FetchOffsets70_g58291).xz ) , break46_g58291.x);
				float4 lerpResult22_g58291 = lerp( lerpResult20_g58291 , lerpResult40_g58291 , break46_g58291.y);
				float4 Output_Fetch2D44_g58291 = lerpResult22_g58291;
				float4 NORMAL_RGBA1382_g58263 = Output_Fetch2D44_g58291;
				float3 unpack1891_g58263 = UnpackNormalScale( NORMAL_RGBA1382_g58263, _NormalStrength );
				unpack1891_g58263.z = lerp( 1, unpack1891_g58263.z, saturate(_NormalStrength) );
				float3 temp_output_1987_35 = unpack1891_g58263;
				float3 temp_output_33_0_g58567 = temp_output_1987_35;
				...
				float3 temp_output_1923_0_g58263 = (_BaseColor).rgb;
				float localStochasticTiling159_g58281 = ( 0.0 );
				float2 UV159_g58281 = UV213_g58263;
				float4 TexelSize159_g58281 = _MainTex_TexelSize;
				float4 Offsets159_g58281 = float4( 0,0,0,0 );
				float2 Weights159_g58281 = float2( 0,0 );
				{
				UV159_g58281 = UV159_g58281 * TexelSize159_g58281.zw - 0.5;
				float2 f = frac( UV159_g58281 );
				UV159_g58281 -= f;
				float4 xn = float4( 1.0, 2.0, 3.0, 4.0 ) - f.xxxx;
				float4 yn = float4( 1.0, 2.0, 3.0, 4.0 ) - f.yyyy;
				float4 xs = xn * xn * xn;
				...
				float4 xc = float4( xv.xyz, 6.0 - xv.x - xv.y - xv.z );
				float4 yc = float4( yv.xyz, 6.0 - yv.x - yv.y - yv.z );
				float4 c = float4( UV159_g58281.x - 0.5, UV159_g58281.x + 1.5, UV159_g58281.y - 0.5, UV159_g58281.y + 1.5 );
				float4 s = float4( xc.x + xc.y, xc.z + xc.w, yc.x + yc.y, yc.z + yc.w );
				float w0 = s.x / ( s.x + s.y );
				float w1 = s.z / ( s.z + s.w );
				Offsets159_g58281 = ( c + float4( xc.y, xc.w, yc.y, yc.w ) / s ) * TexelSize159_g58281.xyxy;
				Weights159_g58281 = float2( w0, w1 );
				}
				float4 Input_FetchOffsets70_g58287 = Offsets159_g58281;
				float2 Input_FetchWeights143_g58287 = Weights159_g58281;
				float2 break46_g58287 = Input_FetchWeights143_g58287;
				float4 lerpResult20_g58287 = lerp( SAMPLE_TEXTURE2D( _MainTex, sampler_MainTex, (Input_FetchOffsets70_g58287).yw ) , SAMPLE_TEXTURE2D( _MainTex, sampler_MainTex, (Input_FetchOffsets70_g58287).xw ) , break46_g58287.x);
				float4 lerpResult40_g58287 = lerp( SAMPLE_TEXTURE2D( _MainTex, sampler_MainTex, (Input_FetchOffsets70_g58287).yz ) , SAMPLE_TEXTURE2D( _MainTex, sampler_MainTex, (Input_FetchOffsets70_g58287).xz ) , break46_g58287.x);
				float4 lerpResult22_g58287 = lerp( lerpResult20_g58287 , lerpResult40_g58287 , break46_g58287.y);
				float4 Output_Fetch2D44_g58287 = lerpResult22_g58287;
				float3 ALBEDO_RGBA1381_g58263 = (Output_Fetch2D44_g58287).rgb;
				float3 temp_output_3_0_g58263 = ( temp_output_1923_0_g58263 * ALBEDO_RGBA1381_g58263 * _Brightness );
				float3 temp_output_1987_38 = temp_output_3_0_g58263;
				float3 temp_output_218_0_g58567 = temp_output_1987_38;
				float3 temp_output_467_0_g58567 = saturate( ( ( temp_output_1307_0_g58567 + lerpResult450_g58567 ) * temp_output_218_0_g58567 ) );
				
				half4 color26_g58179 = IsGammaSpace() ? half4(0.003921569,0,0,0) : half4(0.000303527,0,0,0);
				float3 temp_output_489_0_g58179 = (color26_g58179).rgb;
				float m_switch690_g58179 = _EmissiveRenderFace;
				float3 temp_output_83_0_g58179 = temp_output_1987_38;
				float3 temp_output_19_0_g58181 = (_EmissiveColor).rgb;
				float temp_output_21_0_g58181 = _EmissiveIntensity;
				float3 temp_output_26_0_g58181 = ( temp_output_19_0_g58181 * temp_output_21_0_g58181 );
				float3 temp_output_459_22_g58179 = temp_output_26_0_g58181;
				float2 vertexToFrag70_g58183 = IN.ase_texcoord9.zw;
				float3 lerpResult679_g58179 = lerp( temp_output_83_0_g58179 , temp_output_459_22_g58179 , (SAMPLE_TEXTURE2D( _EmissiveColorMap, sampler_MainTex, vertexToFrag70_g58183 )).rgb);
				float3 lerpResult369_g58179 = lerp( temp_output_83_0_g58179 , lerpResult679_g58179 , saturate( ( 1.0 - ( ( distance( (_EmissiveColorMaskingColor).rgb , temp_output_83_0_g58179 ) - _EmissiveColorMaskingRange ) / max( _EmissiveColorMaskingFuzziness , 1E-05 ) ) ) ));
				float3 lerpResult374_g58179 = lerp( lerpResult679_g58179 , lerpResult369_g58179 , _EmissiveColorMaskingEnable);
				float3 Albedo_In99_g58179 = temp_output_83_0_g58179;
				float dotResult695_g58179 = dot( WorldNormal , WorldViewDirection );
				float temp_output_696_0_g58179 = (1.0 + (sign( dotResult695_g58179 ) - -1.0) * (0.0 - 1.0) / (1.0 - -1.0));
				float3 lerpResult689_g58179 = lerp( lerpResult374_g58179 , Albedo_In99_g58179 , temp_output_696_0_g58179);
				float3 m_Front690_g58179 = lerpResult689_g58179;
				float3 lerpResult697_g58179 = lerp( Albedo_In99_g58179 , lerpResult374_g58179 , temp_output_696_0_g58179);
				float3 m_Back690_g58179 = lerpResult697_g58179;
				float3 m_Both690_g58179 = lerpResult374_g58179;
				float3 localEmissiveCullfloat3switch690_g58179 = EmissiveCullfloat3switch( m_switch690_g58179 , m_Front690_g58179 , m_Back690_g58179 , m_Both690_g58179 );
				float3 lerpResult65_g58179 = lerp( temp_output_489_0_g58179 , localEmissiveCullfloat3switch690_g58179 , ( _EmissiveEnable + ( ( _CATEGORY_EMISSION + _SPACE_EMISSION + _EmissionFlags ) * 0.0 ) ));
				
				float m_switch112_g58556 = _SpecularMode;
				float3 temp_output_143_0_g58557 = SafeNormalize(_MainLightPosition.xyz);
				float3 tanNormal153_g58556 = unpack1891_g58263;
				...
				float localStochasticTiling159_g58284 = ( 0.0 );
				float2 UV159_g58284 = UV213_g58263;
				float4 TexelSize159_g58284 = _MaskMap_TexelSize;
				float4 Offsets159_g58284 = float4( 0,0,0,0 );
				float2 Weights159_g58284 = float2( 0,0 );
				{
				UV159_g58284 = UV159_g58284 * TexelSize159_g58284.zw - 0.5;
				float2 f = frac( UV159_g58284 );
				UV159_g58284 -= f;
				float4 xn = float4( 1.0, 2.0, 3.0, 4.0 ) - f.xxxx;
				float4 yn = float4( 1.0, 2.0, 3.0, 4.0 ) - f.yyyy;
				float4 xs = xn * xn * xn;
				...
				float4 xc = float4( xv.xyz, 6.0 - xv.x - xv.y - xv.z );
				float4 yc = float4( yv.xyz, 6.0 - yv.x - yv.y - yv.z );
				float4 c = float4( UV159_g58284.x - 0.5, UV159_g58284.x + 1.5, UV159_g58284.y - 0.5, UV159_g58284.y + 1.5 );
				float4 s = float4( xc.x + xc.y, xc.z + xc.w, yc.x + yc.y, yc.z + yc.w );
				float w0 = s.x / ( s.x + s.y );
				float w1 = s.z / ( s.z + s.w );
				Offsets159_g58284 = ( c + float4( xc.y, xc.w, yc.y, yc.w ) / s ) * TexelSize159_g58284.xyxy;
				Weights159_g58284 = float2( w0, w1 );
				}
				float4 Input_FetchOffsets70_g58286 = Offsets159_g58284;
				float2 Input_FetchWeights143_g58286 = Weights159_g58284;
				float2 break46_g58286 = Input_FetchWeights143_g58286;
				float4 lerpResult20_g58286 = lerp( SAMPLE_TEXTURE2D( _MaskMap, sampler_MaskMap, (Input_FetchOffsets70_g58286).yw ) , SAMPLE_TEXTURE2D( _MaskMap, sampler_MaskMap, (Input_FetchOffsets70_g58286).xw ) , break46_g58286.x);
				float4 lerpResult40_g58286 = lerp( SAMPLE_TEXTURE2D( _MaskMap, sampler_MaskMap, (Input_FetchOffsets70_g58286).yz ) , SAMPLE_TEXTURE2D( _MaskMap, sampler_MaskMap, (Input_FetchOffsets70_g58286).xz ) , break46_g58286.x);
				float4 lerpResult22_g58286 = lerp( lerpResult20_g58286 , lerpResult40_g58286 , break46_g58286.y);
				float4 Output_Fetch2D44_g58286 = lerpResult22_g58286;
				float4 break50_g58286 = Output_Fetch2D44_g58286;
				float MASK_G158_g58263 = break50_g58286.g;
				float temp_output_2651_0_g58263 = ( 1.0 - MASK_G158_g58263 );
				float lerpResult2650_g58263 = lerp( MASK_G158_g58263 , temp_output_2651_0_g58263 , _SmoothnessSource);
				float temp_output_2693_0_g58263 = ( lerpResult2650_g58263 * _SmoothnessStrength );
				float2 appendResult2645_g58263 = (float2(WorldViewDirection.xy));
				float3 appendResult2644_g58263 = (float3(appendResult2645_g58263 , ( WorldViewDirection.z / 1.06 )));
				float3 break2680_g58263 = unpack1891_g58263;
				float3 normalizeResult2641_g58263 = normalize( ( ( WorldTangent * break2680_g58263.x ) + ( WorldBiTangent * break2680_g58263.y ) + ( WorldNormal * break2680_g58263.z ) ) );
				float3 Normal_Per_Pixel2690_g58263 = normalizeResult2641_g58263;
				float fresnelNdotV2685_g58263 = dot( normalize( Normal_Per_Pixel2690_g58263 ), appendResult2644_g58263 );
				float fresnelNode2685_g58263 = ( 0.0 + ( 1.0 - _SmoothnessFresnelScale ) * pow( max( 1.0 - fresnelNdotV2685_g58263 , 0.0001 ), _SmoothnessFresnelPower ) );
				float lerpResult2636_g58263 = lerp( temp_output_2693_0_g58263 , ( temp_output_2693_0_g58263 - fresnelNode2685_g58263 ) , _SmoothnessFresnelEnable);
				
				float MASK_R1378_g58263 = break50_g58286.r;
				float lerpResult3415_g58263 = lerp( 1.0 , MASK_R1378_g58263 , _OcclusionStrengthAO);
				float lerpResult3414_g58263 = lerp( 1.0 , IN.ase_color.a , _OcclusionStrengthAO);
				float lerpResult2709_g58263 = lerp( lerpResult3415_g58263 , lerpResult3414_g58263 , _OcclusionSource);
				float temp_output_2730_0_g58263 = saturate( lerpResult2709_g58263 );
				
				float localSampleLightmapBicubic821_g58572 = ( 0.0 );
				float3 temp_output_33_0_g58572 = temp_output_1987_35;
				...
				float3 Normal = temp_output_1987_35;
				float3 Emission = lerpResult65_g58179;
				float3 Specular = lerpResult80_g58556;
				float Metallic = 0;
				float Smoothness = saturate( lerpResult2636_g58263 );
				float Occlusion = temp_output_2730_0_g58263;
				float Alpha = 1;
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				float temp_output_13_0_g58183 = cos( temp_output_200_0_g58183 );
				float2 temp_output_9_0_g58183 = float2( 0.5,0.5 );
				float2 break39_g58183 = ( v.texcoord0.xy - temp_output_9_0_g58183 );
				float temp_output_14_0_g58183 = sin( temp_output_200_0_g58183 );
				float2 appendResult36_g58183 = (float2(( ( temp_output_13_0_g58183 * break39_g58183.x ) + ( temp_output_14_0_g58183 * break39_g58183.y ) ) , ( ( temp_output_13_0_g58183 * break39_g58183.y ) - ( temp_output_14_0_g58183 * break39_g58183.x ) )));
				float2 Offset235_g58183 = (_EmissiveColorMapUVs).zw;
				float2 temp_output_41_0_g58183 = ( ( ( appendResult36_g58183 * ( (_EmissiveColorMapUVs).xy / 1.0 ) ) + temp_output_9_0_g58183 ) + Offset235_g58183 );
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float3 lerpResult374_g58179 = lerp( lerpResult679_g58179 , lerpResult369_g58179 , _EmissiveColorMaskingEnable);
				float3 Albedo_In99_g58179 = temp_output_83_0_g58179;
				float dotResult695_g58179 = dot( ase_worldNormal , ase_worldViewDir );
				float temp_output_696_0_g58179 = (1.0 + (sign( dotResult695_g58179 ) - -1.0) * (0.0 - 1.0) / (1.0 - -1.0));
				float3 lerpResult689_g58179 = lerp( lerpResult374_g58179 , Albedo_In99_g58179 , temp_output_696_0_g58179);
				float3 m_Front690_g58179 = lerpResult689_g58179;
				float3 lerpResult697_g58179 = lerp( Albedo_In99_g58179 , lerpResult374_g58179 , temp_output_696_0_g58179);
...
Node;AmplifyShaderEditor.FunctionNode;1972;-7616,-4672;Inherit;False;DESF Module Emission Baked;161;;58179;e63fb1ab597bae24ab95c456de610223;2,575,1,376,1;2;83;FLOAT3;0,0,0;False;613;SAMPLERSTATE;;False;1;FLOAT3;0
Node;AmplifyShaderEditor.FunctionNode;1987;-8032,-4608;Inherit;False;DESF Core Lit;1;;58263;e0cdd7758f4404849b063afff4596424;39,442,2,1557,0,1749,0,1556,0,2284,2,2283,2,2213,2,2481,2,2411,2,2399,2,2172,2,2282,2,3300,2,3301,2,3299,2,2132,2,3146,2,2311,2,3108,0,3119,0,3076,0,3408,0,3291,0,3290,0,3289,0,3287,0,96,0,2591,0,2559,0,1368,0,2125,0,2131,0,2028,0,1333,0,2126,0,1896,0,1415,0,830,0,2523,1;1;1234;FLOAT3;0,0,0;False;17;FLOAT3;38;FLOAT3;35;FLOAT;37;FLOAT3;1922;FLOAT;33;FLOAT;34;FLOAT;46;FLOAT;814;FLOAT;1660;FLOAT3;656;FLOAT3;657;FLOAT3;655;FLOAT3;1235;FLOAT3;2760;SAMPLERSTATE;1819;SAMPLERSTATE;1824;SAMPLERSTATE;1818
Node;AmplifyShaderEditor.FunctionNode;1986;-7648,-4416;Inherit;False;DESF Module Lighting;186;;58567;fcb6e6c168e1c7445afa5890558bc54f;11,184,1,1277,0,1278,0,1279,0,1282,0,1281,0,1276,0,508,0,507,1,463,6,1381,1;8;218;FLOAT3;0,0,0;False;33;FLOAT3;0,0,1;False;1263;FLOAT;0;False;1262;FLOAT;0;False;1261;FLOAT;0;False;1260;FLOAT;0;False;1265;FLOAT2;0,0;False;1266;FLOAT2;0,0;False;1;FLOAT3;220
Node;AmplifyShaderEditor.FunctionNode;1988;-7648,-4304;Inherit;False;DESF Module Baked GI;179;;58572;b6a189f4451929648b1c71f1360a6ff5;9,1300,1,1281,0,1282,0,973,1,974,1,975,1,951,1,954,1,971,1;4;33;FLOAT3;0,0,1;False;902;FLOAT3;0,0,1;False;1265;FLOAT2;0,0;False;1266;FLOAT2;0,0;False;2;FLOAT3;792;FLOAT3;790
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;1976;-7309.438,-4608;Float;False;False;-1;2;DE_ShaderGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;ExtraPrePass;0;0;ExtraPrePass;5;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;5;True;12;all;0;False;True;1;1;False;;0;False;;0;1;False;;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;0;False;False;0;Hidden/DE/Utility/Fallback;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;1978;-7309.438,-4605.389;Float;False;False;-1;2;DE_ShaderGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;ShadowCaster;0;2;ShadowCaster;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;5;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;False;False;True;False;False;False;False;0;False;;False;False;False;False;False;False;False;False;False;True;1;False;;True;3;False;;False;True;1;LightMode=ShadowCaster;False;False;0;Hidden/DE/Utility/Fallback;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;1979;-7309.438,-4605.389;Float;False;False;-1;2;DE_ShaderGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;DepthOnly;0;3;DepthOnly;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;5;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;False;False;True;False;False;False;False;0;False;;False;False;False;False;False;False;False;False;False;True;1;False;;False;False;True;1;LightMode=DepthOnly;False;False;0;Hidden/DE/Utility/Fallback;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;1980;-7309.438,-4605.389;Float;False;False;-1;2;DE_ShaderGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;Meta;0;4;Meta;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;5;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;2;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=Meta;False;False;0;Hidden/DE/Utility/Fallback;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;1981;-7309.438,-4605.389;Float;False;False;-1;2;DE_ShaderGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;Universal2D;0;5;Universal2D;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;5;True;12;all;0;False;True;1;1;False;;0;False;;1;1;False;;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;False;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;1;LightMode=Universal2D;False;False;0;Hidden/DE/Utility/Fallback;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;1982;-7309.438,-4605.389;Float;False;False;-1;2;DE_ShaderGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;DepthNormals;0;6;DepthNormals;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;5;True;12;all;0;False;True;1;1;False;;0;False;;0;1;False;;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;False;;True;3;False;;False;True;1;LightMode=DepthNormals;False;False;0;Hidden/DE/Utility/Fallback;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;1983;-7309.438,-4605.389;Float;False;False;-1;2;DE_ShaderGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;GBuffer;0;7;GBuffer;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;5;True;12;all;0;False;True;1;1;False;;0;False;;1;1;False;;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;1;LightMode=UniversalGBuffer;False;False;0;Hidden/DE/Utility/Fallback;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;1984;-7309.438,-4605.389;Float;False;False;-1;2;DE_ShaderGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;SceneSelectionPass;0;8;SceneSelectionPass;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;5;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;2;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=SceneSelectionPass;False;False;0;Hidden/DE/Utility/Fallback;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;1985;-7309.438,-4605.389;Float;False;False;-1;2;DE_ShaderGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;ScenePickingPass;0;9;ScenePickingPass;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;5;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=Picking;False;False;0;Hidden/DE/Utility/Fallback;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;1977;-7296,-4608;Float;False;True;-1;2;DE_ShaderGUI;0;12;DE Environment/Baked GI/Surface Bicubic Specular Emissive;94348b07e5e8bab40bd6c8a1e3df54cd;True;Forward;0;1;Forward;21;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;True;True;0;True;_Cull;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;5;True;12;all;0;False;True;1;1;False;;0;False;;1;1;False;;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;1;LightMode=UniversalForward;False;False;0;Hidden/DE/Utility/Fallback;0;0;Standard;39;Workflow;0;638176260081908397;Surface;0;0;  Refraction Model;0;0;  Blend;0;0;Two Sided;1;0;Fragment Normal Space,InvertActionOnDeselection;0;0;Forward Only;0;0;Transmission;0;0;  Transmission Shadow;0.5,True,_ASETransmissionShadow;0;Translucency;0;0;  Translucency Strength;1,True,_ASETranslucencyStrength;0;  Normal Distortion;0.5,True,_ASETranslucencyNormalDistortion;0;  Scattering;2,True,_ASETranslucencyScattering;0;  Direct;0.9,True,_ASETranslucencyScattering;0;  Ambient;0.1,True,_ASETranslucencyAmbient;0;  Shadow;0.5,True,_ASETranslucencyShadow;0;Cast Shadows;1;0;  Use Shadow Threshold;0;0;GPU Instancing;1;0;LOD CrossFade;1;0;Built-in Fog;1;0;_FinalColorxAlpha;0;0;Meta Pass;1;0;Override Baked GI;1;638176260115335361;Extra Pre Pass;0;0;Tessellation;0;0;  Phong;0;0;  Strength;0.5,True,_TessellationPhong;0;  Type;0;0;  Tess;16,True,_TessellationStrength;0;  Min;10,True,_TessellationDistanceMin;0;  Max;25,True,_TessellationDistanceMax;0;  Edge Length;16,False,;0;  Max Displacement;25,False,;0;Write Depth;0;0;  Early Z;0;0;Vertex Position,InvertActionOnDeselection;1;0;Debug Display;0;0;Clear Coat;0;0;0;10;False;True;True;True;True;True;True;True;True;True;False;;True;0
WireConnection;1972;83;1987;38
WireConnection;1972;613;1987;1819
WireConnection;1986;218;1987;38
WireConnection;1986;33;1987;35
WireConnection;1988;33;1987;35
WireConnection;1988;902;1987;35
WireConnection;1977;0;1986;220
WireConnection;1977;1;1987;35
WireConnection;1977;2;1972;0
WireConnection;1977;9;1987;1922
WireConnection;1977;4;1987;33
WireConnection;1977;5;1987;34
WireConnection;1977;11;1988;792
ASEEND*/
//CHKSM=27E790CE7BB23AA6F6F29424BBEF7A318D7B5E29