...
Shader  "DE Environment/Decal/Standard Flipbook"
{
	Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
			...
			)
			{
				...
				float temp_output_6_0_g57927 = _UVRotation;
				float temp_output_200_0_g57927 = radians( temp_output_6_0_g57927 );
				float temp_output_13_0_g57927 = cos( temp_output_200_0_g57927 );
				float2 temp_output_9_0_g57927 = float2( 0.5,0.5 );
				float2 break39_g57927 = ( texCoord0 - temp_output_9_0_g57927 );
				float temp_output_14_0_g57927 = sin( temp_output_200_0_g57927 );
				float2 appendResult36_g57927 = (float2(( ( temp_output_13_0_g57927 * break39_g57927.x ) + ( temp_output_14_0_g57927 * break39_g57927.y ) ) , ( ( temp_output_13_0_g57927 * break39_g57927.y ) - ( temp_output_14_0_g57927 * break39_g57927.x ) )));
				float2 Offset235_g57927 = float2( 0,0 );
				float2 temp_output_41_0_g57927 = ( ( ( appendResult36_g57927 * ( float2( 1,1 ) / 1.0 ) ) + temp_output_9_0_g57927 ) + Offset235_g57927 );
				float2 _ConstantAnchor = float2(0.5,0.5);
				float2 break1032_g57928 = ( temp_output_41_0_g57927 - ( ( ( float2( 1,1 ) / 1.0 ) * _ConstantAnchor ) - _ConstantAnchor ) );
				float2 appendResult1035_g57928 = (float2(frac( break1032_g57928.x ) , frac( break1032_g57928.y )));
				float temp_output_980_0_g57928 = _Columns;
				float temp_output_994_0_g57928 = _Rows;
				float2 appendResult978_g57928 = (float2(temp_output_980_0_g57928 , temp_output_994_0_g57928));
				float temp_output_968_0_g57928 = ( temp_output_980_0_g57928 * temp_output_994_0_g57928 );
				float2 appendResult971_g57928 = (float2(temp_output_968_0_g57928 , temp_output_994_0_g57928));
				float Time63_g57927 = _TimeParameters.x;
				float Columns1028_g57928 = temp_output_980_0_g57928;
				float Rows1027_g57928 = temp_output_994_0_g57928;
				float temp_output_1023_0_g57928 = ( fmod( Time63_g57927 , ( Columns1028_g57928 * Rows1027_g57928 ) ) * _Speed );
				float clampResult1019_g57928 = clamp( _DecalID , 1E-05 , ( temp_output_968_0_g57928 - 1.0 ) );
				float temp_output_1043_0_g57928 = frac( ( ( temp_output_1023_0_g57928 + ( clampResult1019_g57928 + 1E-05 ) ) / temp_output_968_0_g57928 ) );
				float2 appendResult969_g57928 = (float2(temp_output_1043_0_g57928 , ( 1.0 - temp_output_1043_0_g57928 )));
				float2 temp_output_1000_0_g57928 = ( ( appendResult1035_g57928 / appendResult978_g57928 ) + ( floor( ( appendResult971_g57928 * appendResult969_g57928 ) ) / appendResult978_g57928 ) );
				float2 temp_output_593_0_g44348 = temp_output_1000_0_g57928;
				float4 tex2DNode205_g44348 = SAMPLE_TEXTURE2D_GRAD( _BaseColorMap, sampler_BaseColorMap, temp_output_593_0_g44348, ddx( temp_output_593_0_g44348 ), ddy( temp_output_593_0_g44348 ) );
				...
				float3 unpack297_g44348 = UnpackNormalScale( SAMPLE_TEXTURE2D_GRAD( _NormalMap, sampler_NormalMap, temp_output_593_0_g44348, ddx( temp_output_593_0_g44348 ), ddy( temp_output_593_0_g44348 ) ), ( _NormalStrength + ( ( _CATEGORY_DECALMAP + 0.0 + _SPACE_DECALMAP + _CATEGORY_COLOR + _SPACE_COLOR ) * 0.0 ) ) );
				...
				float4 tex2DNode203_g44348 = SAMPLE_TEXTURE2D_GRAD( _MaskMap, sampler_BaseColorMap, temp_output_593_0_g44348, ddx( temp_output_593_0_g44348 ), ddy( temp_output_593_0_g44348 ) );
        ...
        Pass
        {
			...
			)
			{
				...
				float3 temp_output_187_0_g44348 = ( ( temp_output_312_0_g44348 * temp_output_26_0_g57922 ) * (SAMPLE_TEXTURE2D_GRAD( _EmissiveColorMap, sampler_BaseColorMap, temp_output_593_0_g44348, ddx( temp_output_593_0_g44348 ), ddy( temp_output_593_0_g44348 ) )).rgb );
        ...
        Pass
        {
			...
			)
			{
				...
				float temp_output_13_0_g57927 = cos( temp_output_200_0_g57927 );
				float2 temp_output_9_0_g57927 = float2( 0.5,0.5 );
				float2 break39_g57927 = ( packedInput.texCoord0.xy - temp_output_9_0_g57927 );
				float temp_output_14_0_g57927 = sin( temp_output_200_0_g57927 );
				float2 appendResult36_g57927 = (float2(( ( temp_output_13_0_g57927 * break39_g57927.x ) + ( temp_output_14_0_g57927 * break39_g57927.y ) ) , ( ( temp_output_13_0_g57927 * break39_g57927.y ) - ( temp_output_14_0_g57927 * break39_g57927.x ) )));
				float2 Offset235_g57927 = float2( 0,0 );
				float2 temp_output_41_0_g57927 = ( ( ( appendResult36_g57927 * ( float2( 1,1 ) / 1.0 ) ) + temp_output_9_0_g57927 ) + Offset235_g57927 );
        ...
        Pass
        {
			...
			)
			{
				...
				float temp_output_13_0_g57927 = cos( temp_output_200_0_g57927 );
				float2 temp_output_9_0_g57927 = float2( 0.5,0.5 );
				float2 break39_g57927 = ( packedInput.ase_texcoord.xy - temp_output_9_0_g57927 );
				float temp_output_14_0_g57927 = sin( temp_output_200_0_g57927 );
				float2 appendResult36_g57927 = (float2(( ( temp_output_13_0_g57927 * break39_g57927.x ) + ( temp_output_14_0_g57927 * break39_g57927.y ) ) , ( ( temp_output_13_0_g57927 * break39_g57927.y ) - ( temp_output_14_0_g57927 * break39_g57927.x ) )));
				float2 Offset235_g57927 = float2( 0,0 );
				float2 temp_output_41_0_g57927 = ( ( ( appendResult36_g57927 * ( float2( 1,1 ) / 1.0 ) ) + temp_output_9_0_g57927 ) + Offset235_g57927 );
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;60;0,-128;Float;False;True;-1;2;DE_ShaderGUI;0;14;DE Environment/Decal/Standard Flipbook;c2a467ab6d5391a4ea692226d82ffefd;True;DecalScreenSpaceProjector;0;2;DecalScreenSpaceProjector;9;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;5;RenderPipeline=UniversalPipeline;PreviewType=Plane;DisableBatching=LODFading=DisableBatching;ShaderGraphShader=true;ShaderGraphTargetId=UniversalDecalSubTarget;True;3;True;12;all;0;False;True;2;5;False;;10;False;;0;1;False;;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;True;1;False;;False;False;False;False;False;False;False;False;False;False;False;True;2;False;;True;2;False;;False;True;1;LightMode=DecalScreenSpaceProjector;False;False;0;Hidden/DE/Utility/Fallback;0;0;Standard;7;Affect BaseColor;1;0;Affect Normal;1;0;Blend;1;0;Affect MAOS;1;638177061783727014;Affect Emission;1;638177061790908082;Support LOD CrossFade;1;638177061796794082;Angle Fade;1;0;0;9;True;True;True;True;True;True;True;True;True;False;;True;0
WireConnection;60;0;57;92
WireConnection;60;1;57;91
WireConnection;60;2;57;89
WireConnection;60;3;57;86
WireConnection;60;4;57;90
WireConnection;60;5;57;87
WireConnection;60;6;57;88
WireConnection;60;7;57;85
WireConnection;60;8;57;84
ASEEND*/
//CHKSM=49AB3E6D7338BDA48E7F618C9D5EB04792B57181