...
Shader  "DE Environment/Decal/Light Point"
{
	Properties
    {
        ...
        _Brightness1("Brightness", Range( 0 , 50)) = 50
        _EdgeSharpness("Edge Sharpness", Float) = 0.3
    ...
    SubShader
    {
        ...
        Pass
        {
			...
			float3 URPGetMainLightColor46_g44371( out float3 Color )
			{
			...
			)
			{
				...
				float3 worldToObj30_g44371 = mul( GetWorldToObjectMatrix(), float4( positionWS, 1 ) ).xyz;
				float temp_output_21_0_g44371 = saturate( ( worldToObj30_g44371.y + 0.5 ) );
				float temp_output_19_0_g44371 = pow( temp_output_21_0_g44371 , 5.0 );
				float temp_output_20_0_g44371 = ( 1.0 - temp_output_21_0_g44371 );
				float3 break15_g44371 = ( worldToObj30_g44371 * float3( 2,2,2 ) );
				float2 appendResult12_g44371 = (float2(break15_g44371.x , break15_g44371.z));
				float smoothstepResult10_g44371 = smoothstep( temp_output_20_0_g44371 , ( ( ( 1.0 - temp_output_19_0_g44371 ) * 0.1 ) + temp_output_20_0_g44371 ) , ( 1.0 - ( ( 1.0 - ( distance( appendResult12_g44371 , float2( 0,0 ) ) * _Offset ) ) * _EdgeSharpness ) ));
				float temp_output_8_0_g44371 = ( temp_output_19_0_g44371 * ( 1.0 - smoothstepResult10_g44371 ) * _Brightness1 );
				float3 temp_output_66_0_g44371 = (_EmissiveColor).rgb;
				float3 Color46_g44371 = float3( 0,0,0 );
				float3 localURPGetMainLightColor46_g44371 = URPGetMainLightColor46_g44371( Color46_g44371 );
				float3 lerpResult42_g44371 = lerp( temp_output_66_0_g44371 , ( temp_output_66_0_g44371 * Color46_g44371 ) , _GetMainLightColor);
				float3 temp_output_5_0_g44371 = ( temp_output_8_0_g44371 * lerpResult42_g44371 );
				

				surfaceDescription.BaseColor = temp_output_5_0_g44371;
				surfaceDescription.Alpha = ( 1.0 - 0.99 );
        ...
        Pass
        {
			...
			)
			{
				...
				float3 temp_output_66_0_g44371 = (_EmissiveColor).rgb;
				float3 temp_output_19_0_g44372 = temp_output_66_0_g44371;
				float temp_output_21_0_g44372 = ( _EmissiveIntensity + ( _EmissionFlags * 0.0 ) );
				float3 temp_output_26_0_g44372 = ( temp_output_19_0_g44372 * temp_output_21_0_g44372 );
				float3 worldToObj30_g44371 = mul( GetWorldToObjectMatrix(), float4( positionWS, 1 ) ).xyz;
				float temp_output_21_0_g44371 = saturate( ( worldToObj30_g44371.y + 0.5 ) );
				float temp_output_19_0_g44371 = pow( temp_output_21_0_g44371 , 5.0 );
				float temp_output_20_0_g44371 = ( 1.0 - temp_output_21_0_g44371 );
				...
				float smoothstepResult10_g44371 = smoothstep( temp_output_20_0_g44371 , ( ( ( 1.0 - temp_output_19_0_g44371 ) * 0.1 ) + temp_output_20_0_g44371 ) , ( 1.0 - ( ( 1.0 - ( distance( appendResult12_g44371 , float2( 0,0 ) ) * _Offset ) ) * _EdgeSharpness ) ));
				float temp_output_8_0_g44371 = ( temp_output_19_0_g44371 * ( 1.0 - smoothstepResult10_g44371 ) * _Brightness1 );
				float3 lerpResult58_g44371 = lerp( float3( 0,0,0 ) , temp_output_26_0_g44372 , temp_output_8_0_g44371);
				

				surfaceDescription.Alpha = ( 1.0 - 0.99 );

				#if defined( _MATERIAL_AFFECTS_EMISSION )
					surfaceDescription.Emission = lerpResult58_g44371;
				#endif
        ...
        Pass
        {
			...
			)
			{
				...
				float3 worldToObj30_g44371 = mul( GetWorldToObjectMatrix(), float4( packedInput.positionWS, 1 ) ).xyz;
				float temp_output_21_0_g44371 = saturate( ( worldToObj30_g44371.y + 0.5 ) );
				float temp_output_19_0_g44371 = pow( temp_output_21_0_g44371 , 5.0 );
				float temp_output_20_0_g44371 = ( 1.0 - temp_output_21_0_g44371 );
				float3 break15_g44371 = ( worldToObj30_g44371 * float3( 2,2,2 ) );
        ...
        Pass
        {
			...
			)
			{
				...
				float3 worldToObj30_g44371 = mul( GetWorldToObjectMatrix(), float4( ase_worldPos, 1 ) ).xyz;
				float temp_output_21_0_g44371 = saturate( ( worldToObj30_g44371.y + 0.5 ) );
				float temp_output_19_0_g44371 = pow( temp_output_21_0_g44371 , 5.0 );
				float temp_output_20_0_g44371 = ( 1.0 - temp_output_21_0_g44371 );
				float3 break15_g44371 = ( worldToObj30_g44371 * float3( 2,2,2 ) );
				...
				float3 BaseColor = temp_output_5_0_g44371;
...
/*ASEBEGIN
Version=19303
Node;AmplifyShaderEditor.FunctionNode;70;-320,-128;Inherit;False;DESF Core Decal Light Point;0;;44371;61ae7e992485efa4f8621a120d98a61c;2,63,1,49,1;0;3;FLOAT3;52;FLOAT;36;FLOAT3;2
