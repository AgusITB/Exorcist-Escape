...
Shader  "DE Environment/Decal/Light Spot"
{
	Properties
    {
        ...
        [HDR]_EmissiveColor("Light Color", Color) = (1,1,1,0)
        [DE_DrawerToggleNoKeyword]_GetMainLightColor("Get Main Light Color", Float) = 0
        _Brightness2("Brightness", Range( 0 , 50)) = 1
    ...
    SubShader
    {
        ...
        Pass
        {
			...
			float3 URPGetMainLightColor46_g43387( out float3 Color )
			{
			...
			)
			{
				...
				float3 worldToObj68_g43387 = mul( GetWorldToObjectMatrix(), float4( positionWS, 1 ) ).xyz;
				float temp_output_67_0_g43387 = saturate( ( worldToObj68_g43387.y + 0.5 ) );
				float temp_output_80_0_g43387 = pow( temp_output_67_0_g43387 , 5.0 );
				float temp_output_84_0_g43387 = ( 1.0 - temp_output_67_0_g43387 );
				float3 break64_g43387 = ( worldToObj68_g43387 * float3( 2,2,2 ) );
				float2 appendResult63_g43387 = (float2(break64_g43387.x , break64_g43387.z));
				float smoothstepResult72_g43387 = smoothstep( temp_output_84_0_g43387 , ( ( ( 1.0 - temp_output_80_0_g43387 ) * 0.1 ) + temp_output_84_0_g43387 ) , ( 1.0 - ( ( 1.0 - ( distance( appendResult63_g43387 , float2( 0,0 ) ) * _Offset ) ) * _EdgeSharpness ) ));
				float temp_output_78_0_g43387 = ( temp_output_80_0_g43387 * ( 1.0 - smoothstepResult72_g43387 ) * _Brightness2 );
				float3 temp_output_53_0_g43387 = (_EmissiveColor).rgb;
				float3 Color46_g43387 = float3( 0,0,0 );
				float3 localURPGetMainLightColor46_g43387 = URPGetMainLightColor46_g43387( Color46_g43387 );
				float3 lerpResult36_g43387 = lerp( temp_output_53_0_g43387 , ( temp_output_53_0_g43387 * Color46_g43387 ) , _GetMainLightColor);
				float3 temp_output_37_0_g43387 = ( temp_output_78_0_g43387 * lerpResult36_g43387 );
				

				surfaceDescription.BaseColor = temp_output_37_0_g43387;
				surfaceDescription.Alpha = ( 1.0 - 0.91 );
        ...
        Pass
        {
			...
			)
			{
				...
				float3 temp_output_53_0_g43387 = (_EmissiveColor).rgb;
				float3 temp_output_19_0_g43388 = temp_output_53_0_g43387;
				float temp_output_21_0_g43388 = ( _EmissiveIntensity + ( _EmissionFlags * 0.0 ) );
				float3 temp_output_26_0_g43388 = ( temp_output_19_0_g43388 * temp_output_21_0_g43388 );
				float3 worldToObj68_g43387 = mul( GetWorldToObjectMatrix(), float4( positionWS, 1 ) ).xyz;
				float temp_output_67_0_g43387 = saturate( ( worldToObj68_g43387.y + 0.5 ) );
				float temp_output_80_0_g43387 = pow( temp_output_67_0_g43387 , 5.0 );
				float temp_output_84_0_g43387 = ( 1.0 - temp_output_67_0_g43387 );
				...
				float smoothstepResult72_g43387 = smoothstep( temp_output_84_0_g43387 , ( ( ( 1.0 - temp_output_80_0_g43387 ) * 0.1 ) + temp_output_84_0_g43387 ) , ( 1.0 - ( ( 1.0 - ( distance( appendResult63_g43387 , float2( 0,0 ) ) * _Offset ) ) * _EdgeSharpness ) ));
				float temp_output_78_0_g43387 = ( temp_output_80_0_g43387 * ( 1.0 - smoothstepResult72_g43387 ) * _Brightness2 );
				float3 lerpResult60_g43387 = lerp( float3( 0,0,0 ) , temp_output_26_0_g43388 , temp_output_78_0_g43387);
				

				surfaceDescription.Alpha = ( 1.0 - 0.91 );

				#if defined( _MATERIAL_AFFECTS_EMISSION )
					surfaceDescription.Emission = lerpResult60_g43387;
				#endif
        ...
        Pass
        {
			...
			)
			{
				...
				float3 worldToObj68_g43387 = mul( GetWorldToObjectMatrix(), float4( packedInput.positionWS, 1 ) ).xyz;
				float temp_output_67_0_g43387 = saturate( ( worldToObj68_g43387.y + 0.5 ) );
				float temp_output_80_0_g43387 = pow( temp_output_67_0_g43387 , 5.0 );
				float temp_output_84_0_g43387 = ( 1.0 - temp_output_67_0_g43387 );
				float3 break64_g43387 = ( worldToObj68_g43387 * float3( 2,2,2 ) );
        ...
        Pass
        {
			...
			)
			{
				...
				float3 worldToObj68_g43387 = mul( GetWorldToObjectMatrix(), float4( ase_worldPos, 1 ) ).xyz;
				float temp_output_67_0_g43387 = saturate( ( worldToObj68_g43387.y + 0.5 ) );
				float temp_output_80_0_g43387 = pow( temp_output_67_0_g43387 , 5.0 );
				float temp_output_84_0_g43387 = ( 1.0 - temp_output_67_0_g43387 );
				float3 break64_g43387 = ( worldToObj68_g43387 * float3( 2,2,2 ) );
				...
				float3 BaseColor = temp_output_37_0_g43387;
...
/*ASEBEGIN
Version=19303
Node;AmplifyShaderEditor.FunctionNode;78;-256,-128;Inherit;False;DESF Core Decal Light Spot;0;;43387;22687b8e2186895409e1e43f30d7a8b0;2,55,1,58,1;0;3;FLOAT3;57;FLOAT;42;FLOAT3;39
