...
Shader  "DE Environment/Decal/Shadow Blob"
{
	Properties
    {
        [HideInInspector] _AlphaCutoff("Alpha Cutoff ", Range(0, 1)) = 0.5
        [HideInInspector] _EmissionColor("Emission Color", Color) = (1,1,1,1)
        [DE_DrawerCategory(DECAL,true,_EmissiveColor,0,0)]_CATEGORY_DECAL("CATEGORY_DECAL", Float) = 1
        [HDR]_EmissiveColor("Shadow Color", Color) = (0.03,0.03,0.03,0)
        _EdgeSharpness("Edge Sharpness", Float) = 5.5
        _Offset("Offset", Float) = 1.2
        ...
        [DE_DrawerSpace(10)]_SPACE_DECAL("SPACE_DECAL", Float) = 0
    ...
    SubShader
    {
        ...
        Pass
        {
			...
			)
			{
				...
				float3 temp_output_153_0_g44354 = (_EmissiveColor).rgb;
				float3 worldToObj107_g44354 = mul( GetWorldToObjectMatrix(), float4( positionWS, 1 ) ).xyz;
				float3 appendResult96_g44354 = (float3(worldToObj107_g44354.x , ( 1.0 - ( 0.5 + worldToObj107_g44354.y ) ) , worldToObj107_g44354.z));
				float temp_output_108_0_g44354 = saturate( ( ( 1.0 - ( distance( appendResult96_g44354 , float3( 0,0,0 ) ) * _Offset ) ) * _EdgeSharpness ) );
				float3 lerpResult127_g44354 = lerp( temp_output_153_0_g44354 , float3( 0,0,0 ) , temp_output_108_0_g44354);
				float3 temp_output_111_0_g44354 = saturate( lerpResult127_g44354 );
				

				surfaceDescription.BaseColor = temp_output_111_0_g44354;
				surfaceDescription.Alpha = temp_output_108_0_g44354;
				surfaceDescription.NormalTS = float3(0.0f, 0.0f, 1.0f);
				surfaceDescription.NormalAlpha = 1;

				#if defined( _MATERIAL_AFFECTS_MAOS )
					surfaceDescription.Metallic = ( _MetallicStrength + ( ( _CATEGORY_DECAL + _SPACE_DECAL ) * 0.0 ) );
					surfaceDescription.Occlusion = saturate( ( 1.0 - _OcclusionStrengthAO ) );
					surfaceDescription.Smoothness =_SmoothnessStrength;
					surfaceDescription.MAOSAlpha = temp_output_108_0_g44354;
				#endif
        ...
        Pass
        {
			...
			)
			{
				...
				half4 color125_g44354 = IsGammaSpace() ? half4(0,0,0,0) : half4(0,0,0,0);
				float3 temp_output_153_0_g44354 = (_EmissiveColor).rgb;
				float3 temp_output_19_0_g44355 = temp_output_153_0_g44354;
				float temp_output_21_0_g44355 = ( _EmissiveIntensity + ( _EmissionFlags * 0.0 ) );
				float3 temp_output_26_0_g44355 = ( temp_output_19_0_g44355 * temp_output_21_0_g44355 );
				float3 lerpResult126_g44354 = lerp( (color125_g44354).rgb , temp_output_26_0_g44355 , temp_output_108_0_g44354);
				

				surfaceDescription.Alpha = temp_output_108_0_g44354;

				#if defined( _MATERIAL_AFFECTS_EMISSION )
					surfaceDescription.Emission = lerpResult126_g44354;
				#endif
        ...
        Pass
        {
			...
			)
			{
				...
				float3 temp_output_153_0_g44354 = (_EmissiveColor).rgb;
				float3 worldToObj107_g44354 = mul( GetWorldToObjectMatrix(), float4( packedInput.positionWS, 1 ) ).xyz;
				float3 appendResult96_g44354 = (float3(worldToObj107_g44354.x , ( 1.0 - ( 0.5 + worldToObj107_g44354.y ) ) , worldToObj107_g44354.z));
				float temp_output_108_0_g44354 = saturate( ( ( 1.0 - ( distance( appendResult96_g44354 , float3( 0,0,0 ) ) * _Offset ) ) * _EdgeSharpness ) );
				float3 lerpResult127_g44354 = lerp( temp_output_153_0_g44354 , float3( 0,0,0 ) , temp_output_108_0_g44354);
				float3 temp_output_111_0_g44354 = saturate( lerpResult127_g44354 );
        ...
        Pass
        {
			...
			)
			{
				...
				float3 worldToObj107_g44354 = mul( GetWorldToObjectMatrix(), float4( ase_worldPos, 1 ) ).xyz;
				float3 appendResult96_g44354 = (float3(worldToObj107_g44354.x , ( 1.0 - ( 0.5 + worldToObj107_g44354.y ) ) , worldToObj107_g44354.z));
				float temp_output_108_0_g44354 = saturate( ( ( 1.0 - ( distance( appendResult96_g44354 , float3( 0,0,0 ) ) * _Offset ) ) * _EdgeSharpness ) );
				float3 lerpResult127_g44354 = lerp( temp_output_153_0_g44354 , float3( 0,0,0 ) , temp_output_108_0_g44354);
				float3 temp_output_111_0_g44354 = saturate( lerpResult127_g44354 );
				...
				float3 BaseColor = temp_output_111_0_g44354;
