...
Shader  "DE Environment/Decal/Water Caustic"
{
	Properties
    {
        [HideInInspector] _EmissionColor("Emission Color", Color) = (1,1,1,1)
        [HideInInspector] _AlphaCutoff("Alpha Cutoff ", Range(0, 1)) = 0.5
        [DE_DrawerCategory(DECAL,true,_TextureArray,0,0)]_CATEGORY_DECAL("CATEGORY_DECAL", Float) = 1
        [NoScaleOffset][DE_DrawerTextureSingleLine]_TextureArray("Caustic Array Texture", 2DArray) = "white" {}
        _CausticRotation("Caustic Rotation", Float) = 0
        _CausticFrames("Caustic Frames", Float) = 16
        _CausticFPS("Caustic FPS", Float) = 16
        _CausticStrength("Caustic Strength", Range( 0 , 5)) = 2.29
        _CausticOpacity("Caustic Opacity", Range( 0 , 1)) = 0
        _CausticBlending("Caustic Blending", Range( 0 , 10)) = 1.13
        [HDR]_CausticChannel01Color("Caustic Channel 01 Color", Color) = (0.772549,0.772549,0.772549,1)
        _CausticChannel01("Caustic Channel 01", Range( 0 , 1)) = 0
        [HDR]_CausticChannel02Color("Caustic Channel 02 Color", Color) = (0.7215686,0.7215686,0.7215686,1)
        _CausticChannel02("Caustic Channel 02", Range( 0 , 100)) = 3.9
        [HDR]_CausticChannel03Color("Caustic Channel 03 Color", Color) = (0.4235294,0.3490196,0.227451,0.6313726)
        _CausticChannel03("Caustic Channel 03", Range( 0 , 1)) = 0.019
    ...
    SubShader
    {
        ...
        Pass
        {
			...
			half4 _CausticChannel01Color;
			half4 _CausticChannel02Color;
			half4 _CausticChannel03Color;
			float _SPACE_DECAL;
			float _CATEGORY_DECAL;
			half _CausticRotation;
			half _CausticFPS;
			half _CausticFrames;
			half _CausticChannel01;
			half _CausticChannel02;
			half _CausticBlending;
			half _CausticChannel03;
			...
			)
			{
				...
				float temp_output_6_0_g43345 = _CausticRotation;
				float temp_output_200_0_g43345 = radians( temp_output_6_0_g43345 );
				float temp_output_13_0_g43345 = cos( temp_output_200_0_g43345 );
				float2 temp_output_9_0_g43345 = float2( 0.5,0.5 );
				float2 break39_g43345 = ( texCoord0 - temp_output_9_0_g43345 );
				float temp_output_14_0_g43345 = sin( temp_output_200_0_g43345 );
				float2 appendResult36_g43345 = (float2(( ( temp_output_13_0_g43345 * break39_g43345.x ) + ( temp_output_14_0_g43345 * break39_g43345.y ) ) , ( ( temp_output_13_0_g43345 * break39_g43345.y ) - ( temp_output_14_0_g43345 * break39_g43345.x ) )));
				float2 Offset235_g43345 = float2( 0,0 );
				float2 temp_output_41_0_g43345 = ( ( ( appendResult36_g43345 * ( float2( 1,1 ) / 1.0 ) ) + temp_output_9_0_g43345 ) + Offset235_g43345 );
				float2 _ConstantAnchor = float2(0.5,0.5);
				float2 temp_output_59_0_g43344 = ( temp_output_41_0_g43345 - ( ( ( float2( 1,1 ) / 1.0 ) * _ConstantAnchor ) - _ConstantAnchor ) );
				float4 tex2DArrayNode29_g43344 = SAMPLE_TEXTURE2D_ARRAY_GRAD( _TextureArray, sampler_TextureArray, temp_output_59_0_g43344,( ( ( _TimeParameters.x ) * _CausticFPS ) % _CausticFrames ), ddx( temp_output_59_0_g43344 ), ddy( temp_output_59_0_g43344 ) );
				float3 temp_output_60_0_g43344 = (tex2DArrayNode29_g43344).rgb;
				float3 temp_output_61_0_g43344 = (_CausticChannel01Color).rgb;
				float3 blendOpSrc27_g43344 = temp_output_61_0_g43344;
				float3 blendOpDest27_g43344 = temp_output_60_0_g43344;
				float3 lerpResult34_g43344 = lerp( ( saturate( (( blendOpDest27_g43344 > 0.5 ) ? ( 1.0 - 2.0 * ( 1.0 - blendOpDest27_g43344 ) * ( 1.0 - blendOpSrc27_g43344 ) ) : ( 2.0 * blendOpDest27_g43344 * blendOpSrc27_g43344 ) ) )) , temp_output_61_0_g43344 , _CausticChannel01);
				float3 lerpResult24_g43344 = lerp( temp_output_60_0_g43344 , lerpResult34_g43344 , tex2DArrayNode29_g43344.a);
				float3 temp_output_62_0_g43344 = (_CausticChannel02Color).rgb;
				float3 blendOpSrc36_g43344 = temp_output_62_0_g43344;
				float3 blendOpDest36_g43344 = lerpResult24_g43344;
				float3 lerpResult18_g43344 = lerp( ( saturate( ( blendOpSrc36_g43344 * blendOpDest36_g43344 ) )) , temp_output_62_0_g43344 , _CausticChannel02);
				float clampResult22_g43344 = clamp( ( tex2DArrayNode29_g43344.r * _CausticBlending ) , 0.0 , 1.0 );
				float3 lerpResult14_g43344 = lerp( lerpResult24_g43344 , lerpResult18_g43344 , clampResult22_g43344);
				float3 temp_output_63_0_g43344 = (_CausticChannel03Color).rgb;
				float3 blendOpSrc1_g43344 = lerpResult14_g43344;
				float3 blendOpDest1_g43344 = temp_output_63_0_g43344;
				float3 lerpResult10_g43344 = lerp( ( saturate( (( blendOpDest1_g43344 > 0.5 ) ? ( 1.0 - 2.0 * ( 1.0 - blendOpDest1_g43344 ) * ( 1.0 - blendOpSrc1_g43344 ) ) : ( 2.0 * blendOpDest1_g43344 * blendOpSrc1_g43344 ) ) )) , temp_output_63_0_g43344 , _CausticChannel03);
				float3 lerpResult9_g43344 = lerp( lerpResult14_g43344 , lerpResult10_g43344 , tex2DArrayNode29_g43344.g);
				float3 temp_output_25_0_g43344 = ( lerpResult9_g43344 * _CausticStrength );
				

				surfaceDescription.BaseColor = temp_output_25_0_g43344;
				surfaceDescription.Alpha = ( tex2DArrayNode29_g43344.a * ( 1.0 - _CausticOpacity ) );
        ...
        Pass
        {
			...
			)
			{
				...
				float temp_output_13_0_g43345 = cos( temp_output_200_0_g43345 );
				float2 temp_output_9_0_g43345 = float2( 0.5,0.5 );
				float2 break39_g43345 = ( packedInput.texCoord0.xy - temp_output_9_0_g43345 );
				float temp_output_14_0_g43345 = sin( temp_output_200_0_g43345 );
				float2 appendResult36_g43345 = (float2(( ( temp_output_13_0_g43345 * break39_g43345.x ) + ( temp_output_14_0_g43345 * break39_g43345.y ) ) , ( ( temp_output_13_0_g43345 * break39_g43345.y ) - ( temp_output_14_0_g43345 * break39_g43345.x ) )));
				float2 Offset235_g43345 = float2( 0,0 );
				float2 temp_output_41_0_g43345 = ( ( ( appendResult36_g43345 * ( float2( 1,1 ) / 1.0 ) ) + temp_output_9_0_g43345 ) + Offset235_g43345 );
        ...
        Pass
        {
			...
			)
			{
				...
				float temp_output_13_0_g43345 = cos( temp_output_200_0_g43345 );
				float2 temp_output_9_0_g43345 = float2( 0.5,0.5 );
				float2 break39_g43345 = ( packedInput.ase_texcoord.xy - temp_output_9_0_g43345 );
				float temp_output_14_0_g43345 = sin( temp_output_200_0_g43345 );
				float2 appendResult36_g43345 = (float2(( ( temp_output_13_0_g43345 * break39_g43345.x ) + ( temp_output_14_0_g43345 * break39_g43345.y ) ) , ( ( temp_output_13_0_g43345 * break39_g43345.y ) - ( temp_output_14_0_g43345 * break39_g43345.x ) )));
				float2 Offset235_g43345 = float2( 0,0 );
				float2 temp_output_41_0_g43345 = ( ( ( appendResult36_g43345 * ( float2( 1,1 ) / 1.0 ) ) + temp_output_9_0_g43345 ) + Offset235_g43345 );
				...
				float3 BaseColor = temp_output_25_0_g43344;
...
/*ASEBEGIN
Version=19303
Node;AmplifyShaderEditor.FunctionNode;24;-384,0;Inherit;False;DESF Core Decal Water Caustic;0;;43344;b37845ae95c100b45802696dbd854d45;1,46,1;0;2;FLOAT3;39;FLOAT;38
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;27;0,0;Float;False;True;-1;2;DE_ShaderGUI;0;14;DE Environment/Decal/Water Caustic;c2a467ab6d5391a4ea692226d82ffefd;True;DecalScreenSpaceProjector;0;2;DecalScreenSpaceProjector;9;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;5;RenderPipeline=UniversalPipeline;PreviewType=Plane;DisableBatching=LODFading=DisableBatching;ShaderGraphShader=true;ShaderGraphTargetId=UniversalDecalSubTarget;True;3;True;12;all;0;False;True;2;5;False;;10;False;;0;1;False;;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;True;1;False;;False;False;False;False;False;False;False;False;False;False;False;True;2;False;;True;2;False;;False;True;1;LightMode=DecalScreenSpaceProjector;False;False;0;Hidden/DE/Utility/Fallback;0;0;Standard;7;Affect BaseColor;1;0;Affect Normal;1;0;Blend;1;0;Affect MAOS;0;0;Affect Emission;0;0;Support LOD CrossFade;0;0;Angle Fade;1;0;0;9;True;False;True;True;True;False;True;True;True;False;;True;0
WireConnection;27;0;24;39
WireConnection;27;1;24;38
ASEEND*/
//CHKSM=C952FD4BB21A2E01D47310B4D14A2F5C87A18326