...
Shader  "DE Environment/Decal/Water Caustic Flow"
{
	Properties
    {
        [HideInInspector] _AlphaCutoff("Alpha Cutoff ", Range(0, 1)) = 0.5
        [HideInInspector] _EmissionColor("Emission Color", Color) = (1,1,1,1)
        [DE_DrawerCategory(DECAL,true,_CausticMap,0,0)]_CATEGORY_DECAL("CATEGORY_DECAL", Float) = 1
        [DE_DrawerTextureSingleLine]_CausticMap("Caustic Map", 2D) = "white" {}
        _CausticOpacity("Caustic Opacity", Range( 0 , 1)) = 0.5
        _CausticSpeed("Caustic Speed", Range( 0 , 1)) = 0.25
        [Normal][DE_DrawerTextureSingleLine]_CausticNormal("Caustic Normal", 2D) = "bump" {}
        _CausticNormalStrength("Normal Strength", Range( 0 , 0.25)) = 0.05
        _EdgeSharpness("Edge Sharpness", Range( 0.1 , 1)) = 0.5
    ...
    SubShader
    {
        ...
        Pass
        {
			...
			half _CausticSpeed;
			half _CausticNormalStrength;
			half _CausticOpacity;
			float _CATEGORY_DECAL;
			...
			TEXTURE2D(_CausticNormal);
			SAMPLER(sampler_CausticNormal);
			...
			float2 DecalTransforms463_g58060( float2 UV )
			{
			...
			float2 DecalTransforms464_g58060( float2 UV )
			{
				#if (SHADERPASS == SHADERPASS_DBUFFER_PROJECTOR) || (SHADERPASS == SHADERPASS_FORWARD_EMISSIVE_PROJECTOR)
					float4x4 normalToWorld = UNITY_ACCESS_INSTANCED_PROP(Decal, _NormalToWorld);
					float2 scale = float2(normalToWorld[3][0], normalToWorld[3][1]);
			...
			)
			{
				...
				float3 worldToObjDir449_g58060 = mul( GetWorldToObjectMatrix(), float4( positionWS, 0 ) ).xyz;
				float3 break441_g58060 = ( worldToObjDir449_g58060 * ( 1.0 - worldToObjDir449_g58060 ) );
				float temp_output_443_0_g58060 = ( ( break441_g58060.x * break441_g58060.y ) * ( break441_g58060.z * break441_g58060.z ) );
				float3 temp_output_82_0_g58062 = ( positionWS - _WorldSpaceCameraPos );
				float3 temp_output_78_0_g58062 = cross( ddy( temp_output_82_0_g58062 ) , ddx( temp_output_82_0_g58062 ) );
				float3 normalizeResult87_g58062 = ASESafeNormalize( temp_output_78_0_g58062 );
				float3 temp_output_424_0_g58060 = round( abs( normalizeResult87_g58062 ) );
				float2 lerpResult410_g58060 = lerp( (positionWS).yz , (positionWS).xz , (temp_output_424_0_g58060).y);
				float2 lerpResult411_g58060 = lerp( lerpResult410_g58060 , (positionWS).xy , (temp_output_424_0_g58060).z);
				float temp_output_459_0_g58060 = ( _TimeParameters.x * _CausticSpeed );
				float2 UV463_g58060 = ( lerpResult411_g58060 + ( temp_output_459_0_g58060 * float2( 0.6,0.3 ) ) );
				float2 localDecalTransforms463_g58060 = DecalTransforms463_g58060( UV463_g58060 );
				float3 unpack416_g58060 = UnpackNormalScale( SAMPLE_TEXTURE2D( _CausticNormal, sampler_CausticNormal, ( ( lerpResult411_g58060 * float2( 0.4,0.4 ) ) + ( temp_output_459_0_g58060 * float2( 0,0.3 ) ) ) ), _CausticNormalStrength );
				unpack416_g58060.z = lerp( 1, unpack416_g58060.z, saturate(_CausticNormalStrength) );
				float3 tex2DNode416_g58060 = unpack416_g58060;
				float2 appendResult454_g58060 = (float2(tex2DNode416_g58060.r , tex2DNode416_g58060.g));
				float2 temp_output_451_0_g58060 = ( ( appendResult454_g58060 * float2( 2,2 ) ) - float2( 1,1 ) );
				float4 tex2DNode418_g58060 = SAMPLE_TEXTURE2D( _CausticMap, sampler_CausticMap, ( localDecalTransforms463_g58060 + temp_output_451_0_g58060 ) );
				float2 UV464_g58060 = ( lerpResult411_g58060 + ( temp_output_459_0_g58060 * float2( -0.6,-0.3 ) ) );
				float2 localDecalTransforms464_g58060 = DecalTransforms464_g58060( UV464_g58060 );
				float4 tex2DNode437_g58060 = SAMPLE_TEXTURE2D( _CausticMap, sampler_CausticMap, ( temp_output_451_0_g58060 + localDecalTransforms464_g58060 ) );
				float3 temp_output_448_0_g58060 = saturate( ( saturate( ( ( temp_output_443_0_g58060 * temp_output_443_0_g58060 ) * _EdgeSharpness ) ) * ( (tex2DNode418_g58060).rgb + (tex2DNode437_g58060).rgb ) ) );
				
				float temp_output_185_0_g58060 = ( _CausticOpacity + ( ( _CATEGORY_DECAL + _SPACE_DECALMAP ) * 0.0 ) );
				

				surfaceDescription.BaseColor = temp_output_448_0_g58060;
				surfaceDescription.Alpha = ( saturate( ( temp_output_185_0_g58060 * 10.0 ) ) * saturate( (0.0 + (( ( tex2DNode418_g58060.r * tex2DNode418_g58060.r ) + ( tex2DNode437_g58060.r * tex2DNode437_g58060.r ) ) - 0.0) * (( ( saturate( ( temp_output_185_0_g58060 + -0.1 ) ) * 50.0 ) + 1.0 ) - 0.0) / (1.0 - 0.0)) ) );
        ...
        Pass
        {
			...
			)
			{
				...
				float3 worldToObjDir449_g58060 = mul( GetWorldToObjectMatrix(), float4( packedInput.positionWS, 0 ) ).xyz;
				float3 break441_g58060 = ( worldToObjDir449_g58060 * ( 1.0 - worldToObjDir449_g58060 ) );
				float temp_output_443_0_g58060 = ( ( break441_g58060.x * break441_g58060.y ) * ( break441_g58060.z * break441_g58060.z ) );
				float3 temp_output_82_0_g58062 = ( packedInput.positionWS - _WorldSpaceCameraPos );
				float3 temp_output_78_0_g58062 = cross( ddy( temp_output_82_0_g58062 ) , ddx( temp_output_82_0_g58062 ) );
				float3 normalizeResult87_g58062 = ASESafeNormalize( temp_output_78_0_g58062 );
				float3 temp_output_424_0_g58060 = round( abs( normalizeResult87_g58062 ) );
				float2 lerpResult410_g58060 = lerp( (packedInput.positionWS).yz , (packedInput.positionWS).xz , (temp_output_424_0_g58060).y);
				float2 lerpResult411_g58060 = lerp( lerpResult410_g58060 , (packedInput.positionWS).xy , (temp_output_424_0_g58060).z);
				float temp_output_459_0_g58060 = ( _TimeParameters.x * _CausticSpeed );
				float2 UV463_g58060 = ( lerpResult411_g58060 + ( temp_output_459_0_g58060 * float2( 0.6,0.3 ) ) );
				float2 localDecalTransforms463_g58060 = DecalTransforms463_g58060( UV463_g58060 );
				float3 unpack416_g58060 = UnpackNormalScale( SAMPLE_TEXTURE2D( _CausticNormal, sampler_CausticNormal, ( ( lerpResult411_g58060 * float2( 0.4,0.4 ) ) + ( temp_output_459_0_g58060 * float2( 0,0.3 ) ) ) ), _CausticNormalStrength );
        ...
        Pass
        {
			...
			)
			{
				...
				float3 worldToObjDir449_g58060 = mul( GetWorldToObjectMatrix(), float4( ase_worldPos, 0 ) ).xyz;
				float3 break441_g58060 = ( worldToObjDir449_g58060 * ( 1.0 - worldToObjDir449_g58060 ) );
				float temp_output_443_0_g58060 = ( ( break441_g58060.x * break441_g58060.y ) * ( break441_g58060.z * break441_g58060.z ) );
				float3 temp_output_82_0_g58062 = ( ase_worldPos - _WorldSpaceCameraPos );
				float3 temp_output_78_0_g58062 = cross( ddy( temp_output_82_0_g58062 ) , ddx( temp_output_82_0_g58062 ) );
				float3 normalizeResult87_g58062 = ASESafeNormalize( temp_output_78_0_g58062 );
				float3 temp_output_424_0_g58060 = round( abs( normalizeResult87_g58062 ) );
				float2 lerpResult410_g58060 = lerp( (ase_worldPos).yz , (ase_worldPos).xz , (temp_output_424_0_g58060).y);
				float2 lerpResult411_g58060 = lerp( lerpResult410_g58060 , (ase_worldPos).xy , (temp_output_424_0_g58060).z);
				float temp_output_459_0_g58060 = ( _TimeParameters.x * _CausticSpeed );
				float2 UV463_g58060 = ( lerpResult411_g58060 + ( temp_output_459_0_g58060 * float2( 0.6,0.3 ) ) );
				float2 localDecalTransforms463_g58060 = DecalTransforms463_g58060( UV463_g58060 );
				float3 unpack416_g58060 = UnpackNormalScale( SAMPLE_TEXTURE2D( _CausticNormal, sampler_CausticNormal, ( ( lerpResult411_g58060 * float2( 0.4,0.4 ) ) + ( temp_output_459_0_g58060 * float2( 0,0.3 ) ) ) ), _CausticNormalStrength );
				...
				float3 BaseColor = temp_output_448_0_g58060;
