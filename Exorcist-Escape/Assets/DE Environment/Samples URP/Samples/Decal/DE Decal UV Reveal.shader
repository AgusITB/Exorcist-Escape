...
Shader  "DE Environment/Decal/UV Reveal"
{
	Properties
    {
   ...
   //          #if ASE_SRP_VERSION >=140009
			...
			float3 GetMainLightColorNode10_g58326( out float3 Color )
			{
			...
			float3 Blackbody345_g58320( float Temperature )
			{
			...
			)
			{
				...
				float3 temp_output_433_0_g58320 = (_DecalColor).rgb;
				float3 Color10_g58326 = float3( 0,0,0 );
				float3 localGetMainLightColorNode10_g58326 = GetMainLightColorNode10_g58326( Color10_g58326 );
				float3 lerpResult440_g58320 = lerp( temp_output_433_0_g58320 , ( temp_output_433_0_g58320 * Color10_g58326 ) , ( _DecalMainLightInfluence + ( ( _CATEGORY_COLOR + _SPACE_COLOR ) * 0.0 ) ));
				float temp_output_6_0_g58328 = _UVRotation;
				float temp_output_200_0_g58328 = radians( temp_output_6_0_g58328 );
				float temp_output_13_0_g58328 = cos( temp_output_200_0_g58328 );
				float2 temp_output_9_0_g58328 = float2( 0.5,0.5 );
				float2 break39_g58328 = ( texCoord0 - temp_output_9_0_g58328 );
				float temp_output_14_0_g58328 = sin( temp_output_200_0_g58328 );
				float2 appendResult36_g58328 = (float2(( ( temp_output_13_0_g58328 * break39_g58328.x ) + ( temp_output_14_0_g58328 * break39_g58328.y ) ) , ( ( temp_output_13_0_g58328 * break39_g58328.y ) - ( temp_output_14_0_g58328 * break39_g58328.x ) )));
				float2 Offset235_g58328 = float2( 0,0 );
				float2 temp_output_41_0_g58328 = ( ( ( appendResult36_g58328 * ( float2( 1,1 ) / 1.0 ) ) + temp_output_9_0_g58328 ) + Offset235_g58328 );
				float2 _ConstantAnchor = float2(0.5,0.5);
				float2 temp_output_643_0_g58320 = ( temp_output_41_0_g58328 - ( ( ( float2( 1,1 ) / 1.0 ) * _ConstantAnchor ) - _ConstantAnchor ) );
				float4 tex2DNode531_g58320 = SAMPLE_TEXTURE2D_GRAD( _BaseColorMap, sampler_BaseColorMap, temp_output_643_0_g58320, ddx( temp_output_643_0_g58320 ), ddy( temp_output_643_0_g58320 ) );
				float3 temp_output_365_0_g58320 = (tex2DNode531_g58320).rgb;
				float3 temp_output_367_0_g58320 = ( lerpResult440_g58320 * temp_output_365_0_g58320 );
				float3 lerpResult626_g58320 = lerp( temp_output_367_0_g58320 , ( temp_output_367_0_g58320 * (unity_ColorSpaceDouble).rgb ) , _DecalColorSpaceDouble);
				float3 normalizedWorldNormal = normalize( worldNormal );
				float3 ase_worldViewDir = ( _WorldSpaceCameraPos.xyz - positionWS );
				ase_worldViewDir = SafeNormalize( ase_worldViewDir );
				float dotResult8_g58327 = dot( normalizedWorldNormal , ase_worldViewDir );
				float temp_output_623_23_g58320 = dotResult8_g58327;
				float3 worldPosValue187_g58335 = positionWS;
				float3 WorldPosition431_g58335 = worldPosValue187_g58335;
				float4 screenPos = packedInput.ase_texcoord1;
				float4 ase_screenPosNorm = screenPos / screenPos.w;
				ase_screenPosNorm.z = ( UNITY_NEAR_CLIP_VALUE >= 0 ) ? ase_screenPosNorm.z : ase_screenPosNorm.z * 0.5 + 0.5;
				float2 ScreenUV190_g58335 = (ase_screenPosNorm).xy;
				float2 ScreenUV431_g58335 = ScreenUV190_g58335;
				float3 localAdditionalLightsFlat14x431_g58335 = AdditionalLightsFlat14x( WorldPosition431_g58335 , ScreenUV431_g58335 );
				float3 normalizeResult385_g58320 = ASESafeNormalize( localAdditionalLightsFlat14x431_g58335 );
				float3 temp_output_343_0_g58320 = (_DecalUVLightFilteredColor).rgb;
				float lerpResult348_g58320 = lerp( 1000.0 , 7800.0 , _DecalUVLightThresholdTemp);
				float Temperature345_g58320 = abs( lerpResult348_g58320 );
				float3 localBlackbody345_g58320 = Blackbody345_g58320( Temperature345_g58320 );
				float3 normalizeResult353_g58320 = ASESafeNormalize( ( temp_output_343_0_g58320 * localBlackbody345_g58320 ) );
				float dotResult354_g58320 = dot( normalizeResult385_g58320 , normalizeResult353_g58320 );
				float temp_output_356_0_g58320 =  ( dotResult354_g58320 - _DecalUVLightThreshold > 1.0 ? 0.0 : dotResult354_g58320 - _DecalUVLightThreshold <= 1.0 && dotResult354_g58320 + _DecalUVLightThreshold >= 1.0 ? 1.0 : 0.0 ) ;
				float temp_output_387_0_g58320 = ( temp_output_623_23_g58320 * temp_output_356_0_g58320 );
				float temp_output_394_0_g58320 = ( _DecalUVLightEnable + ( ( _CATEGORY_UVLIGHTREVEAL + _SPACE_UVLIGHTREVEAL ) * 0.0 ) );
				float3 lerpResult424_g58320 = lerp( float3( 0,0,0 ) , ( lerpResult626_g58320 * temp_output_387_0_g58320 ) , temp_output_394_0_g58320);
				
				float BaseColor_Alpha621_g58320 = ( tex2DNode531_g58320.a * temp_output_387_0_g58320 );
				float temp_output_574_0_g58320 = ( 1.0 - ( _DecalOpacityGlobal + ( ( _CATEGORY_OPACITY + _SPACE_OPACITY ) * 0.0 ) ) );
				float temp_output_575_0_g58320 = ( BaseColor_Alpha621_g58320 * temp_output_574_0_g58320 );
				float lerpResult485_g58320 = lerp( 0.0 , temp_output_575_0_g58320 , temp_output_394_0_g58320);
				
				float3 unpack377_g58320 = UnpackNormalScale( SAMPLE_TEXTURE2D_GRAD( _NormalMap, sampler_NormalMap, temp_output_643_0_g58320, ddx( temp_output_643_0_g58320 ), ddy( temp_output_643_0_g58320 ) ), ( _NormalStrength + ( ( _CATEGORY_DECALMAP + _SPACE_DECALMAP ) * 0.0 ) ) );
				unpack377_g58320.z = lerp( 1, unpack377_g58320.z, saturate(( _NormalStrength + ( ( _CATEGORY_DECALMAP + _SPACE_DECALMAP ) * 0.0 ) )) );
				float3 lerpResult411_g58320 = lerp( float3( 0,0,1 ) , ( unpack377_g58320 * ( temp_output_623_23_g58320 * temp_output_356_0_g58320 ) ) , temp_output_394_0_g58320);
				
				float4 tex2DNode565_g58320 = SAMPLE_TEXTURE2D_GRAD( _MaskMap, sampler_BaseColorMap, temp_output_643_0_g58320, ddx( temp_output_643_0_g58320 ), ddy( temp_output_643_0_g58320 ) );
				float temp_output_576_0_g58320 = ( tex2DNode565_g58320.b * temp_output_574_0_g58320 );
				float lerpResult578_g58320 = lerp( temp_output_575_0_g58320 , temp_output_576_0_g58320 , _DecalOpacityNormalChannel);
				float lerpResult583_g58320 = lerp( 0.0 , lerpResult578_g58320 , temp_output_394_0_g58320);
				
				float lerpResult577_g58320 = lerp( temp_output_575_0_g58320 , temp_output_576_0_g58320 , _DecalOpacityMOASChannel);
				float lerpResult584_g58320 = lerp( 0.0 , lerpResult577_g58320 , temp_output_394_0_g58320);
				

				surfaceDescription.BaseColor = lerpResult424_g58320;
				surfaceDescription.Alpha = lerpResult485_g58320;
				surfaceDescription.NormalTS = lerpResult411_g58320;
				surfaceDescription.NormalAlpha = lerpResult583_g58320;

				#if defined( _MATERIAL_AFFECTS_MAOS )
					surfaceDescription.Metallic = ( tex2DNode565_g58320.r * _MetallicStrength );
					surfaceDescription.Occlusion = saturate( ( tex2DNode565_g58320.g * ( 1.0 - _OcclusionStrengthAO ) ) );
					surfaceDescription.Smoothness =( tex2DNode565_g58320.b * _SmoothnessStrength );
					surfaceDescription.MAOSAlpha = lerpResult584_g58320;
				#endif
   ...
   //          #if ASE_SRP_VERSION >=140009
			...
			)
			{
				...
				half4 color545_g58320 = IsGammaSpace() ? half4(0.003921569,0,0,0) : half4(0.000303527,0,0,0);
				float3 temp_output_548_0_g58320 = (color545_g58320).rgb;
				float3 temp_output_540_0_g58320 = ( ( (_EmissiveColor).rgb * ( ( _DecalEmissiveIntensity + ( ( _CATEGORY_EMISSION + _SPACE_EMISSION ) * 0.0 ) ) + ( _EmissionFlags * 0.0 ) ) ) * (SAMPLE_TEXTURE2D_GRAD( _EmissiveColorMap, sampler_BaseColorMap, temp_output_643_0_g58320, ddx( temp_output_643_0_g58320 ), ddy( temp_output_643_0_g58320 ) )).rgb );
				float3 lerpResult547_g58320 = lerp( temp_output_548_0_g58320 , ( temp_output_575_0_g58320 * temp_output_540_0_g58320 ) , _DecalEmissiveEnable);
				float3 lerpResult588_g58320 = lerp( temp_output_548_0_g58320 , lerpResult547_g58320 , temp_output_394_0_g58320);
				

				surfaceDescription.Alpha = lerpResult485_g58320;

				#if defined( _MATERIAL_AFFECTS_EMISSION )
					surfaceDescription.Emission = lerpResult588_g58320;
				#endif
   ...
   //          #if ASE_SRP_VERSION >=140009
			...
			)
			{
				...
				float3 lerpResult626_g58320 = lerp( temp_output_367_0_g58320 , ( temp_output_367_0_g58320 * (unity_ColorSpaceDouble).rgb ) , _DecalColorSpaceDouble);
				float3 normalizedWorldNormal = normalize( worldNormal );
				float dotResult8_g58327 = dot( normalizedWorldNormal , packedInput.viewDirectionWS );
				float temp_output_623_23_g58320 = dotResult8_g58327;
				float3 worldPosValue187_g58335 = positionWS;
				float3 WorldPosition431_g58335 = worldPosValue187_g58335;
   ...
   //          #if ASE_SRP_VERSION >=140009
			...
			)
			{
				...
				float temp_output_13_0_g58328 = cos( temp_output_200_0_g58328 );
				float2 temp_output_9_0_g58328 = float2( 0.5,0.5 );
				float2 break39_g58328 = ( packedInput.texCoord0.xy - temp_output_9_0_g58328 );
				float temp_output_14_0_g58328 = sin( temp_output_200_0_g58328 );
				float2 appendResult36_g58328 = (float2(( ( temp_output_13_0_g58328 * break39_g58328.x ) + ( temp_output_14_0_g58328 * break39_g58328.y ) ) , ( ( temp_output_13_0_g58328 * break39_g58328.y ) - ( temp_output_14_0_g58328 * break39_g58328.x ) )));
				float2 Offset235_g58328 = float2( 0,0 );
				float2 temp_output_41_0_g58328 = ( ( ( appendResult36_g58328 * ( float2( 1,1 ) / 1.0 ) ) + temp_output_9_0_g58328 ) + Offset235_g58328 );
				...
				float dotResult8_g58327 = dot( normalizedWorldNormal , ase_worldViewDir );
				float temp_output_623_23_g58320 = dotResult8_g58327;
				float3 worldPosValue187_g58335 = packedInput.positionWS;
				float3 WorldPosition431_g58335 = worldPosValue187_g58335;
   ...
   //          #if ASE_SRP_VERSION >=140009
			...
			)
			{
				...
				float temp_output_13_0_g58328 = cos( temp_output_200_0_g58328 );
				float2 temp_output_9_0_g58328 = float2( 0.5,0.5 );
				float2 break39_g58328 = ( packedInput.ase_texcoord.xy - temp_output_9_0_g58328 );
				float temp_output_14_0_g58328 = sin( temp_output_200_0_g58328 );
				float2 appendResult36_g58328 = (float2(( ( temp_output_13_0_g58328 * break39_g58328.x ) + ( temp_output_14_0_g58328 * break39_g58328.y ) ) , ( ( temp_output_13_0_g58328 * break39_g58328.y ) - ( temp_output_14_0_g58328 * break39_g58328.x ) )));
				float2 Offset235_g58328 = float2( 0,0 );
				float2 temp_output_41_0_g58328 = ( ( ( appendResult36_g58328 * ( float2( 1,1 ) / 1.0 ) ) + temp_output_9_0_g58328 ) + Offset235_g58328 );
				...
				float dotResult8_g58327 = dot( normalizedWorldNormal , ase_worldViewDir );
				float temp_output_623_23_g58320 = dotResult8_g58327;
				float3 worldPosValue187_g58335 = ase_worldPos;
				float3 WorldPosition431_g58335 = worldPosValue187_g58335;
				...
				float3 BaseColor = lerpResult424_g58320;
