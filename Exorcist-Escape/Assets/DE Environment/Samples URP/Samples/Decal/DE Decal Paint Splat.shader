...
Shader  "DE Environment/Decal/Paint Splat"
{
	Properties
    {
        ...
        [HDR]_EmissiveColor("Paint Color", Color) = (0,0.6544204,1.059274,0)
    ...
    SubShader
    {
        ...
        Pass
        {
			...
			)
			{
				...
				float3 temp_output_45_0_g43391 = (_EmissiveColor).rgb;
				
				float2 Offset235_g44345 = float2( 0,0 );
				float2 temp_output_41_0_g44345 = ( ( texCoord0 * float2( 1,1 ) ) + Offset235_g44345 );
				float2 temp_output_75_0_g43391 = temp_output_41_0_g44345;
				float2 break40_g43391 = temp_output_75_0_g43391;
				float2 appendResult35_g43391 = (float2(break40_g43391.x , break40_g43391.y));
				float simplePerlin2D28_g43391 = snoise( temp_output_75_0_g43391*_NoiseScale );
				simplePerlin2D28_g43391 = simplePerlin2D28_g43391*0.5 + 0.5;
				float temp_output_30_0_g43391 = step( pow( ( distance( appendResult35_g43391 , float2( 0.5,0.5 ) ) * 2.0 ) , _EdgeSharpness ) , simplePerlin2D28_g43391 );
				

				surfaceDescription.BaseColor = temp_output_45_0_g43391;
				surfaceDescription.Alpha = temp_output_30_0_g43391;
				...
				surfaceDescription.NormalAlpha = 1;
					...
					surfaceDescription.MAOSAlpha = temp_output_30_0_g43391;
				#endif
        ...
        Pass
        {
			...
			)
			{
				...
				half4 color49_g43391 = IsGammaSpace() ? half4(0,0,0,0) : half4(0,0,0,0);
				float3 temp_output_45_0_g43391 = (_EmissiveColor).rgb;
				float3 temp_output_19_0_g43392 = temp_output_45_0_g43391;
				float temp_output_21_0_g43392 = ( _EmissiveIntensity + ( _EmissionFlags * 0.0 ) );
				float lerpResult6_g43392 = lerp( temp_output_21_0_g43392 , ( temp_output_21_0_g43392 * _GlobalEmissionIntensity ) , _GlobalEmissionEnabled);
				float lerpResult9_g43392 = lerp( temp_output_21_0_g43392 , lerpResult6_g43392 , _EmissiveisGlobal);
				float3 temp_output_2_0_g43392 = ( temp_output_19_0_g43392 * lerpResult9_g43392 );
				float3 lerpResult47_g43391 = lerp( (color49_g43391).rgb , temp_output_2_0_g43392 , temp_output_30_0_g43391);
				

				surfaceDescription.Alpha = temp_output_30_0_g43391;

				#if defined( _MATERIAL_AFFECTS_EMISSION )
					surfaceDescription.Emission = lerpResult47_g43391;
				#endif
        ...
        Pass
        {
			...
			)
			{
				...
				float2 Offset235_g44345 = float2( 0,0 );
				float2 temp_output_41_0_g44345 = ( ( packedInput.texCoord0.xy * float2( 1,1 ) ) + Offset235_g44345 );
				float2 temp_output_75_0_g43391 = temp_output_41_0_g44345;
				float2 break40_g43391 = temp_output_75_0_g43391;
				float2 appendResult35_g43391 = (float2(break40_g43391.x , break40_g43391.y));
				float simplePerlin2D28_g43391 = snoise( temp_output_75_0_g43391*_NoiseScale );
        ...
        Pass
        {
			...
			)
			{
				...
				float3 BaseColor = temp_output_45_0_g43391;
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;65;0,-128;Float;False;True;-1;2;DE_ShaderGUI;0;14;DE Environment/Decal/Paint Splat;c2a467ab6d5391a4ea692226d82ffefd;True;DecalScreenSpaceProjector;0;2;DecalScreenSpaceProjector;9;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;5;RenderPipeline=UniversalPipeline;PreviewType=Plane;DisableBatching=LODFading=DisableBatching;ShaderGraphShader=true;ShaderGraphTargetId=UniversalDecalSubTarget;True;3;True;12;all;0;False;True;2;5;False;;10;False;;0;1;False;;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;True;1;False;;False;False;False;False;False;False;False;False;False;False;False;True;2;False;;True;2;False;;False;True;1;LightMode=DecalScreenSpaceProjector;False;False;0;Hidden/DE/Utility/Fallback;0;0;Standard;7;Affect BaseColor;1;0;Affect Normal;0;638177060559617279;Blend;1;0;Affect MAOS;1;638177060530766179;Affect Emission;1;638177060538219719;Support LOD CrossFade;1;638177060544175906;Angle Fade;1;0;0;9;True;True;True;True;True;True;True;True;True;False;;False;0
WireConnection;65;0;62;17
WireConnection;65;1;62;16
WireConnection;65;7;62;37
WireConnection;65;8;62;55
ASEEND*/
//CHKSM=9044B5425659DF7D6B868A0BA763DE7F43B62CB6