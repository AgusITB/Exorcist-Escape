...
Shader "DE Environment/Dissolve/Cutout Wind Translucency"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
						...
						, bool ase_vface : SV_IsFrontFace ) : SV_Target
			{
				...
				half4 color201_g58658 = IsGammaSpace() ? half4(0,0,0,0) : half4(0,0,0,0);
				float3 temp_output_348_0_g58658 = (color201_g58658).rgb;
				float temp_output_142_0_g58658 = ( _DissolveStrenght * 15.0 );
				...
				float temp_output_174_0_g58658 = temp_output_98_0_g58604;
				float eyeDepth = IN.ase_texcoord8.z;
				float temp_output_155_0_g58658 = ( _DissolveFadeStart + _ProjectionParams.y );
				float temp_output_156_0_g58658 = ( ( eyeDepth + -temp_output_155_0_g58658 ) / ( _DissolveFadeEnd - temp_output_155_0_g58658 ) );
				float4 ase_screenPosNorm = ScreenPos / ScreenPos.w;
				ase_screenPosNorm.z = ( UNITY_NEAR_CLIP_VALUE >= 0 ) ? ase_screenPosNorm.z : ase_screenPosNorm.z * 0.5 + 0.5;
				float dither165_g58658 = DitherNoiseTex(ase_screenPosNorm, _DissolveDitherMap, sampler_DissolveDitherMap, _DissolveDitherMap_TexelSize);
				float lerpResult305_g58658 = lerp( temp_output_156_0_g58658 , ( temp_output_156_0_g58658 - dither165_g58658 ) , _DissolveDitherEnable);
				float3 appendResult102_g58658 = (float3(WorldPosition.x , WorldPosition.y , WorldPosition.z));
				float smoothstepResult118_g58658 = smoothstep( 0.0 , 1.0 , ( 1.0 - ( ( distance( _WorldSpaceCameraPos , appendResult102_g58658 ) - _DissolveFadeStart ) / ( _DissolveFadeEnd - _DissolveFadeStart ) ) ));
				float temp_output_327_0_g58658 = ( _DissolveEnable + ( ( _CATEGORY_DISSOLVE + _SPACE_DISSOLVE ) * 0.0 ) );
				float lerpResult300_g58658 = lerp( lerpResult305_g58658 , saturate( smoothstepResult118_g58658 ) , temp_output_327_0_g58658);
				float temp_output_249_0_g58658 = ( lerpResult300_g58658 * temp_output_174_0_g58658 );
				float FADE_MODE189_g58658 = _DissolveFadeEnable;
				float lerpResult295_g58658 = lerp( temp_output_174_0_g58658 , temp_output_249_0_g58658 , FADE_MODE189_g58658);
				float FADE124_g58658 = lerpResult295_g58658;
				float lerpResult131_g58658 = lerp( 0.0 , temp_output_142_0_g58658 , FADE124_g58658);
				float lerpResult294_g58658 = lerp( temp_output_142_0_g58658 , lerpResult131_g58658 , _DissolveFadeEnable);
				float2 Offset235_g58659 = (_DissolveUVs).zw;
				float2 temp_output_41_0_g58659 = ( ( IN.ase_texcoord9.xy * (_DissolveUVs).xy ) + Offset235_g58659 );
				float temp_output_42_0_g58658 = ( (-0.6 + (( 1.0 - lerpResult294_g58658 ) - 0.0) * (0.6 - -0.6) / (1.0 - 0.0)) + SAMPLE_TEXTURE2D( _DissolveNoise, sampler_DissolveNoise, temp_output_41_0_g58659 ).r );
				float clampResult45_g58658 = clamp( (-4.0 + (temp_output_42_0_g58658 - 0.0) * (4.0 - -4.0) / (1.0 - 0.0)) , 0.0 , 1.0 );
				float temp_output_46_0_g58658 = ( 1.0 - clampResult45_g58658 );
				float2 appendResult47_g58658 = (float2(temp_output_46_0_g58658 , 0.0));
				float3 lerpResult298_g58658 = lerp( temp_output_348_0_g58658 , ( ( temp_output_46_0_g58658 + temp_output_348_0_g58658 ) * (SAMPLE_TEXTURE2D( _DissolveRamp, sampler_DissolveNoise, appendResult47_g58658 )).rgb ) , temp_output_327_0_g58658);
				...
				float temp_output_181_0_g58658 = ( temp_output_42_0_g58658 * temp_output_174_0_g58658 );
				float lerpResult299_g58658 = lerp( FADE124_g58658 , temp_output_181_0_g58658 , temp_output_327_0_g58658);
				

				float3 BaseColor = temp_output_3_0_g58558;
				float3 Normal = switchResult58_g58574;
				float3 Emission = lerpResult298_g58658;
				float3 Specular = 0.5;
				...
				float Alpha = lerpResult299_g58658;
		...
		Pass
		{
						 ...
						 ) : SV_TARGET
			{
				...
				float lerpResult294_g58658 = lerp( temp_output_142_0_g58658 , lerpResult131_g58658 , _DissolveFadeEnable);
				float2 Offset235_g58659 = (_DissolveUVs).zw;
				float2 temp_output_41_0_g58659 = ( ( IN.ase_texcoord4.xy * (_DissolveUVs).xy ) + Offset235_g58659 );
				float temp_output_42_0_g58658 = ( (-0.6 + (( 1.0 - lerpResult294_g58658 ) - 0.0) * (0.6 - -0.6) / (1.0 - 0.0)) + SAMPLE_TEXTURE2D( _DissolveNoise, sampler_DissolveNoise, temp_output_41_0_g58659 ).r );
				float temp_output_181_0_g58658 = ( temp_output_42_0_g58658 * temp_output_174_0_g58658 );
				float lerpResult299_g58658 = lerp( FADE124_g58658 , temp_output_181_0_g58658 , temp_output_327_0_g58658);
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float lerpResult294_g58658 = lerp( temp_output_142_0_g58658 , lerpResult131_g58658 , _DissolveFadeEnable);
				float2 Offset235_g58659 = (_DissolveUVs).zw;
				float2 temp_output_41_0_g58659 = ( ( IN.ase_texcoord6.xy * (_DissolveUVs).xy ) + Offset235_g58659 );
				float temp_output_42_0_g58658 = ( (-0.6 + (( 1.0 - lerpResult294_g58658 ) - 0.0) * (0.6 - -0.6) / (1.0 - 0.0)) + SAMPLE_TEXTURE2D( _DissolveNoise, sampler_DissolveNoise, temp_output_41_0_g58659 ).r );
				float clampResult45_g58658 = clamp( (-4.0 + (temp_output_42_0_g58658 - 0.0) * (4.0 - -4.0) / (1.0 - 0.0)) , 0.0 , 1.0 );
				float temp_output_46_0_g58658 = ( 1.0 - clampResult45_g58658 );
				float2 appendResult47_g58658 = (float2(temp_output_46_0_g58658 , 0.0));
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN ) : SV_TARGET
			{
				...
				float dither165_g58658 = DitherNoiseTex(ase_screenPosNorm, _DissolveDitherMap, sampler_DissolveDitherMap, _DissolveDitherMap_TexelSize);
				float lerpResult305_g58658 = lerp( temp_output_156_0_g58658 , ( temp_output_156_0_g58658 - dither165_g58658 ) , _DissolveDitherEnable);
				float3 appendResult102_g58658 = (float3(ase_worldPos.x , ase_worldPos.y , ase_worldPos.z));
				float smoothstepResult118_g58658 = smoothstep( 0.0 , 1.0 , ( 1.0 - ( ( distance( _WorldSpaceCameraPos , appendResult102_g58658 ) - _DissolveFadeStart ) / ( _DissolveFadeEnd - _DissolveFadeStart ) ) ));
				float temp_output_327_0_g58658 = ( _DissolveEnable + ( ( _CATEGORY_DISSOLVE + _SPACE_DISSOLVE ) * 0.0 ) );
				float lerpResult300_g58658 = lerp( lerpResult305_g58658 , saturate( smoothstepResult118_g58658 ) , temp_output_327_0_g58658);
				float temp_output_249_0_g58658 = ( lerpResult300_g58658 * temp_output_174_0_g58658 );
				...
				float lerpResult294_g58658 = lerp( temp_output_142_0_g58658 , lerpResult131_g58658 , _DissolveFadeEnable);
				float2 Offset235_g58659 = (_DissolveUVs).zw;
				float2 temp_output_41_0_g58659 = ( ( IN.ase_texcoord3.xy * (_DissolveUVs).xy ) + Offset235_g58659 );
				float temp_output_42_0_g58658 = ( (-0.6 + (( 1.0 - lerpResult294_g58658 ) - 0.0) * (0.6 - -0.6) / (1.0 - 0.0)) + SAMPLE_TEXTURE2D( _DissolveNoise, sampler_DissolveNoise, temp_output_41_0_g58659 ).r );
				float temp_output_181_0_g58658 = ( temp_output_42_0_g58658 * temp_output_174_0_g58658 );
				float lerpResult299_g58658 = lerp( FADE124_g58658 , temp_output_181_0_g58658 , temp_output_327_0_g58658);
				

				surfaceDescription.Alpha = lerpResult299_g58658;
...
/*ASEBEGIN
Version=19303
Node;AmplifyShaderEditor.FunctionNode;2871;-4896,-3584;Inherit;False;DESF Weather Wind;184;;58555;b135a554f7e4d0b41bba02c61b34ae74;5,3133,1,2371,1,2432,1,3138,0,3139,0;0;1;FLOAT3;2190
Node;AmplifyShaderEditor.CommentaryNode;2911;-4347.764,-4318.815;Inherit;False;331.8818;635.2449;TRANSLUCENCY ASE;7;2913;2914;2915;2916;2917;2918;2919;;0,0,0,1;0;0
Node;AmplifyShaderEditor.FunctionNode;2877;-4672,-3584;Inherit;False;DESF Core Lit;2;;58558;e0cdd7758f4404849b063afff4596424;39,442,2,1557,0,1749,0,1556,0,2284,0,2283,0,2213,0,2481,0,2411,0,2399,0,2172,0,2282,0,3300,0,3301,0,3299,0,2132,0,3146,0,2311,0,3108,0,3119,0,3076,0,3408,0,3291,0,3290,0,3289,0,3287,0,96,0,2591,0,2559,0,1368,0,2125,0,2131,0,2028,0,1333,0,2126,1,1896,0,1415,0,830,0,2523,1;1;1234;FLOAT3;0,0,0;False;17;FLOAT3;38;FLOAT3;35;FLOAT;37;FLOAT3;1922;FLOAT;33;FLOAT;34;FLOAT;46;FLOAT;814;FLOAT;1660;FLOAT3;656;FLOAT3;657;FLOAT3;655;FLOAT3;1235;FLOAT3;2760;SAMPLERSTATE;1819;SAMPLERSTATE;1824;SAMPLERSTATE;1818
Node;AmplifyShaderEditor.StickyNoteNode;2912;-4706.936,-4313.833;Inherit;False;333;403.2999;;;0,0,0,1;_ASETransmissionShadow$$_ASETranslucencyStrength$_ASETranslucencyNormalDistortion$_ASETranslucencyScattering$_ASETranslucencyDirect$_ASETranslucencyAmbient$_ASETranslucencyShadow;0;0
Node;AmplifyShaderEditor.RangedFloatNode;202;-4192,-3232;Inherit;False;Property;_MaskClipValue;Mask Clip Value;1;0;Create;True;1;;0;0;True;0;False;0.57;0.57;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;2878;-4304,-3648;Inherit;False;DESF Module Dissolve;170;;58658;c18c6a51f7ef1204bbd962806cd4208d;4,262,1,266,1,265,1,303,0;2;267;FLOAT3;0,0,0;False;174;FLOAT;1;False;2;FLOAT3;0;FLOAT;21
Node;AmplifyShaderEditor.RangedFloatNode;2919;-4320,-3776;Inherit;False;Property;_ASETranslucencyShadow;ASE Translucency Shadow ;169;0;Create;False;1;;0;0;True;0;False;0.5;0.5;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;2918;-4320,-3856;Inherit;False;Property;_ASETranslucencyAmbient;ASE Translucency Ambient;168;0;Create;False;1;;0;0;True;0;False;0.8339342;0.8339342;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;2917;-4320,-3936;Inherit;False;Property;_ASETranslucencyDirect;ASE Translucency Direct ;167;0;Create;False;1;;0;0;True;0;False;0.9;0.9;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;2916;-4320,-4016;Inherit;False;Property;_ASETranslucencyScattering;ASE Translucency Scattering ;166;0;Create;False;1;;0;0;True;0;False;2;2;1;50;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;2915;-4320,-4096;Inherit;False;Property;_ASETranslucencyNormalDistortion;ASE Translucency Normal Distortion ;165;0;Create;False;1;;0;0;True;0;False;0.2735869;0.2735869;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;2914;-4320,-4176;Inherit;False;Property;_ASETranslucencyStrength;ASE Translucency Strength;164;0;Create;False;1;;0;0;True;0;False;1;1;1;50;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;2913;-4320,-4256;Inherit;False;Property;_ASETransmissionShadow;ASE Transmission Shadow;163;0;Create;False;1;;0;1;UnityEngine.Rendering.CompareFunction;True;0;False;0.5;0.5;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;2920;-4688,-4128;Inherit;False;Property;_CATEGORY_TRANSLUCENCYASE;CATEGORY_TRANSLUCENCY ASE;162;0;Create;True;0;0;0;True;1;DE_DrawerCategory(TRANSLUCENCY ASE,true,_ASETranslucencyStrength,0,0);False;0;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;2921;-4688,-4048;Inherit;False;Property;_SPACE_TRANSLUCENCYASE;SPACE_TRANSLUCENCYASE;183;0;Create;True;0;0;0;True;1;DE_DrawerSpace(10);False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.IntNode;2895;-3968,-3680;Inherit;False;Property;_Cull;Render Face;0;2;[HideInInspector];[Enum];Create;False;0;0;1;Front,2,Back,1,Both,0;True;0;False;2;2;False;0;1;INT;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;2942;-3964.744,-3584;Float;False;False;-1;2;DE_ShaderGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;ExtraPrePass;0;0;ExtraPrePass;5;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;5;True;12;all;0;False;True;1;1;False;;0;False;;0;1;False;;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;0;False;False;0;Hidden/DE/Utility/Fallback;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;2944;-3964.744,-3639.608;Float;False;False;-1;2;DE_ShaderGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;ShadowCaster;0;2;ShadowCaster;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;5;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;False;False;True;False;False;False;False;0;False;;False;False;False;False;False;False;False;False;False;True;1;False;;True;3;False;;False;True;1;LightMode=ShadowCaster;False;False;0;Hidden/DE/Utility/Fallback;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;2945;-3964.744,-3639.608;Float;False;False;-1;2;DE_ShaderGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;DepthOnly;0;3;DepthOnly;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;5;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;False;False;True;False;False;False;False;0;False;;False;False;False;False;False;False;False;False;False;True;1;False;;False;False;True;1;LightMode=DepthOnly;False;False;0;Hidden/DE/Utility/Fallback;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;2946;-3964.744,-3639.608;Float;False;False;-1;2;DE_ShaderGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;Meta;0;4;Meta;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;5;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;2;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=Meta;False;False;0;Hidden/DE/Utility/Fallback;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;2947;-3964.744,-3639.608;Float;False;False;-1;2;DE_ShaderGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;Universal2D;0;5;Universal2D;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;5;True;12;all;0;False;True;1;1;False;;0;False;;1;1;False;;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;False;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;1;LightMode=Universal2D;False;False;0;Hidden/DE/Utility/Fallback;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;2948;-3964.744,-3639.608;Float;False;False;-1;2;DE_ShaderGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;DepthNormals;0;6;DepthNormals;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;5;True;12;all;0;False;True;1;1;False;;0;False;;0;1;False;;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;False;;True;3;False;;False;True;1;LightMode=DepthNormalsOnly;False;False;0;Hidden/DE/Utility/Fallback;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;2949;-3964.744,-3639.608;Float;False;False;-1;2;DE_ShaderGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;GBuffer;0;7;GBuffer;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;5;True;12;all;0;False;True;1;1;False;;0;False;;0;1;False;;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;1;LightMode=UniversalGBuffer;False;False;0;Hidden/DE/Utility/Fallback;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;2950;-3964.744,-3639.608;Float;False;False;-1;2;DE_ShaderGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;SceneSelectionPass;0;8;SceneSelectionPass;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;5;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;2;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=SceneSelectionPass;False;False;0;Hidden/DE/Utility/Fallback;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;2951;-3964.744,-3639.608;Float;False;False;-1;2;DE_ShaderGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;ScenePickingPass;0;9;ScenePickingPass;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;5;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=Picking;False;False;0;Hidden/DE/Utility/Fallback;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;2943;-3968,-3584;Float;False;True;-1;2;DE_ShaderGUI;0;12;DE Environment/Dissolve/Cutout Wind Translucency;94348b07e5e8bab40bd6c8a1e3df54cd;True;Forward;0;1;Forward;21;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;True;True;0;True;_Cull;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;5;True;12;all;0;False;True;1;1;False;;0;False;;1;1;False;;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;1;LightMode=UniversalForwardOnly;False;False;0;Hidden/DE/Utility/Fallback;0;0;Standard;39;Workflow;1;0;Surface;0;0;  Refraction Model;0;0;  Blend;0;0;Two Sided;1;0;Fragment Normal Space,InvertActionOnDeselection;0;0;Forward Only;1;638176361267216741;Transmission;1;638176361281293852;  Transmission Shadow;0.5,True,_ASETransmissionShadow;638176361596033025;Translucency;1;638176361291160947;  Translucency Strength;1,True,_ASETranslucencyStrength;638176361700628797;  Normal Distortion;0.5,True,_ASETranslucencyNormalDistortion;638176361724013792;  Scattering;2,True,_ASETranslucencyScattering;638176361748209341;  Direct;0.9,True,_ASETranslucencyScattering;638176361774781382;  Ambient;0.1,True,_ASETranslucencyAmbient;638176361811095494;  Shadow;0.5,True,_ASETranslucencyShadow;638176361861083763;Cast Shadows;1;0;  Use Shadow Threshold;1;638176361318331069;GPU Instancing;1;0;LOD CrossFade;1;0;Built-in Fog;1;0;_FinalColorxAlpha;0;0;Meta Pass;1;0;Override Baked GI;0;0;Extra Pre Pass;0;0;Tessellation;0;0;  Phong;0;0;  Strength;0.5,True,_TessellationPhong;0;  Type;0;0;  Tess;16,True,_TessellationStrength;0;  Min;10,True,_TessellationDistanceMin;0;  Max;25,True,_TessellationDistanceMax;0;  Edge Length;16,False,;0;  Max Displacement;25,False,;0;Write Depth;0;0;  Early Z;0;0;Vertex Position,InvertActionOnDeselection;1;0;Debug Display;0;0;Clear Coat;0;0;0;10;False;True;True;True;True;True;True;False;True;True;False;;True;0
WireConnection;2877;1234;2871;2190
WireConnection;2878;174;2877;46
WireConnection;2943;0;2877;38
WireConnection;2943;1;2877;35
WireConnection;2943;2;2878;0
WireConnection;2943;3;2877;37
WireConnection;2943;4;2877;33
WireConnection;2943;5;2877;34
WireConnection;2943;6;2878;21
WireConnection;2943;7;202;0
WireConnection;2943;16;2877;1660
WireConnection;2943;8;2877;1235
ASEEND*/
//CHKSM=1D34D6DAE5FD31573D691AF7E71A4B70145379DE