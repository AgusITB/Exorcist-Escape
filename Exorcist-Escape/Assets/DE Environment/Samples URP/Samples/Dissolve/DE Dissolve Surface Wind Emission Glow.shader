...
Shader "DE Environment/Dissolve/Surface Wind Emission Glow"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				float2 temp_output_1955_0_g57979 = (_MainUVs).xy;
				float2 temp_output_1953_0_g57979 = (_MainUVs).zw;
				float2 Offset235_g58525 = temp_output_1953_0_g57979;
				float2 temp_output_41_0_g58525 = ( ( localfloat2switchUVMode80_g58525 * temp_output_1955_0_g57979 ) + Offset235_g58525 );
						 ...
						 ) : SV_Target
			{
				...
				float3 temp_output_1923_0_g57979 = (_BaseColor).rgb;
				float2 vertexToFrag70_g58525 = IN.ase_texcoord8.xy;
				float2 UV213_g57979 = vertexToFrag70_g58525;
				float4 tex2DNode2048_g57979 = SAMPLE_TEXTURE2D( _MainTex, sampler_MainTex, UV213_g57979 );
				float3 ALBEDO_RGBA1381_g57979 = (tex2DNode2048_g57979).rgb;
				float3 temp_output_3_0_g57979 = ( temp_output_1923_0_g57979 * ALBEDO_RGBA1381_g57979 * _Brightness );
				float3 temp_output_83_0_g58567 = temp_output_3_0_g57979;
				...
				float4 NORMAL_RGBA1382_g57979 = SAMPLE_TEXTURE2D( _BumpMap, sampler_BumpMap, UV213_g57979 );
				float3 unpack1891_g57979 = UnpackNormalScale( NORMAL_RGBA1382_g57979, _NormalStrength );
				unpack1891_g57979.z = lerp( 1, unpack1891_g57979.z, saturate(_NormalStrength) );
				float3 temp_output_453_35 = unpack1891_g57979;
				float3 tanToWorld0 = float3( WorldTangent.x, WorldBiTangent.x, WorldNormal.x );
				float3 tanToWorld1 = float3( WorldTangent.y, WorldBiTangent.y, WorldNormal.y );
				float3 tanToWorld2 = float3( WorldTangent.z, WorldBiTangent.z, WorldNormal.z );
				float3 tanNormal190_g58567 = temp_output_453_35;
				...
				float temp_output_142_0_g58605 = ( _DissolveStrenght * 15.0 );
				float eyeDepth = IN.ase_texcoord8.z;
				float temp_output_155_0_g58605 = ( _DissolveFadeStart + _ProjectionParams.y );
				float temp_output_156_0_g58605 = ( ( eyeDepth + -temp_output_155_0_g58605 ) / ( _DissolveFadeEnd - temp_output_155_0_g58605 ) );
				float4 ase_screenPosNorm = ScreenPos / ScreenPos.w;
				ase_screenPosNorm.z = ( UNITY_NEAR_CLIP_VALUE >= 0 ) ? ase_screenPosNorm.z : ase_screenPosNorm.z * 0.5 + 0.5;
				float dither165_g58605 = DitherNoiseTex(ase_screenPosNorm, _DissolveDitherMap, sampler_DissolveDitherMap, _DissolveDitherMap_TexelSize);
				float lerpResult305_g58605 = lerp( temp_output_156_0_g58605 , ( temp_output_156_0_g58605 - dither165_g58605 ) , _DissolveDitherEnable);
				float3 appendResult102_g58605 = (float3(WorldPosition.x , WorldPosition.y , WorldPosition.z));
				float smoothstepResult118_g58605 = smoothstep( 0.0 , 1.0 , ( 1.0 - ( ( distance( _WorldSpaceCameraPos , appendResult102_g58605 ) - _DissolveFadeStart ) / ( _DissolveFadeEnd - _DissolveFadeStart ) ) ));
				float temp_output_327_0_g58605 = ( _DissolveEnable + ( ( _CATEGORY_DISSOLVE + _SPACE_DISSOLVE ) * 0.0 ) );
				float lerpResult300_g58605 = lerp( lerpResult305_g58605 , saturate( smoothstepResult118_g58605 ) , temp_output_327_0_g58605);
				float FADE_MODE189_g58605 = _DissolveFadeEnable;
				float lerpResult295_g58605 = lerp( 1.0 , lerpResult300_g58605 , FADE_MODE189_g58605);
				float FADE124_g58605 = lerpResult295_g58605;
				float lerpResult131_g58605 = lerp( 0.0 , temp_output_142_0_g58605 , FADE124_g58605);
				float lerpResult294_g58605 = lerp( temp_output_142_0_g58605 , lerpResult131_g58605 , _DissolveFadeEnable);
				float2 Offset235_g58606 = (_DissolveUVs).zw;
				float2 temp_output_41_0_g58606 = ( ( IN.ase_texcoord9.xy * (_DissolveUVs).xy ) + Offset235_g58606 );
				float temp_output_42_0_g58605 = ( (-0.6 + (( 1.0 - lerpResult294_g58605 ) - 0.0) * (0.6 - -0.6) / (1.0 - 0.0)) + SAMPLE_TEXTURE2D( _DissolveNoise, sampler_DissolveNoise, temp_output_41_0_g58606 ).r );
				float clampResult45_g58605 = clamp( (-4.0 + (temp_output_42_0_g58605 - 0.0) * (4.0 - -4.0) / (1.0 - 0.0)) , 0.0 , 1.0 );
				float temp_output_46_0_g58605 = ( 1.0 - clampResult45_g58605 );
				float2 appendResult47_g58605 = (float2(temp_output_46_0_g58605 , 0.0));
				float3 lerpResult298_g58605 = lerp( lerpResult65_g58567 , ( ( temp_output_46_0_g58605 + lerpResult65_g58567 ) * (SAMPLE_TEXTURE2D( _DissolveRamp, sampler_DissolveNoise, appendResult47_g58605 )).rgb ) , temp_output_327_0_g58605);
				
				float4 tex2DNode2050_g57979 = SAMPLE_TEXTURE2D( _MaskMap, sampler_MaskMap, UV213_g57979 );
				float MASK_B1377_g57979 = tex2DNode2050_g57979.b;
				
				float MASK_G158_g57979 = tex2DNode2050_g57979.g;
				float temp_output_2651_0_g57979 = ( 1.0 - MASK_G158_g57979 );
				float lerpResult2650_g57979 = lerp( MASK_G158_g57979 , temp_output_2651_0_g57979 , _SmoothnessSource);
				float temp_output_2693_0_g57979 = ( lerpResult2650_g57979 * _SmoothnessStrength );
				float2 appendResult2645_g57979 = (float2(WorldViewDirection.xy));
				float3 appendResult2644_g57979 = (float3(appendResult2645_g57979 , ( WorldViewDirection.z / 1.06 )));
				float3 break2680_g57979 = unpack1891_g57979;
				float3 normalizeResult2641_g57979 = normalize( ( ( WorldTangent * break2680_g57979.x ) + ( WorldBiTangent * break2680_g57979.y ) + ( WorldNormal * break2680_g57979.z ) ) );
				float3 Normal_Per_Pixel2690_g57979 = normalizeResult2641_g57979;
				float fresnelNdotV2685_g57979 = dot( normalize( Normal_Per_Pixel2690_g57979 ), appendResult2644_g57979 );
				float fresnelNode2685_g57979 = ( 0.0 + ( 1.0 - _SmoothnessFresnelScale ) * pow( max( 1.0 - fresnelNdotV2685_g57979 , 0.0001 ), _SmoothnessFresnelPower ) );
				float lerpResult2636_g57979 = lerp( temp_output_2693_0_g57979 , ( temp_output_2693_0_g57979 - fresnelNode2685_g57979 ) , _SmoothnessFresnelEnable);
				
				float MASK_R1378_g57979 = tex2DNode2050_g57979.r;
				float lerpResult3415_g57979 = lerp( 1.0 , MASK_R1378_g57979 , _OcclusionStrengthAO);
				float lerpResult3414_g57979 = lerp( 1.0 , IN.ase_color.a , _OcclusionStrengthAO);
				float lerpResult2709_g57979 = lerp( lerpResult3415_g57979 , lerpResult3414_g57979 , _OcclusionSource);
				float temp_output_2730_0_g57979 = saturate( lerpResult2709_g57979 );
				
				float lerpResult299_g58605 = lerp( FADE124_g58605 , temp_output_42_0_g58605 , temp_output_327_0_g58605);
				

				float3 BaseColor = lerpResult384_g58567;
				float3 Normal = temp_output_453_35;
				float3 Emission = lerpResult298_g58605;
				float3 Specular = 0.5;
				float Metallic = ( _MetallicStrength * MASK_B1377_g57979 );
				float Smoothness = saturate( lerpResult2636_g57979 );
				float Occlusion = temp_output_2730_0_g57979;
				float Alpha = lerpResult299_g58605;
		...
		Pass
		{
						 ...
						 ) : SV_TARGET
			{
				...
				float lerpResult294_g58605 = lerp( temp_output_142_0_g58605 , lerpResult131_g58605 , _DissolveFadeEnable);
				float2 Offset235_g58606 = (_DissolveUVs).zw;
				float2 temp_output_41_0_g58606 = ( ( IN.ase_texcoord3.yz * (_DissolveUVs).xy ) + Offset235_g58606 );
				float temp_output_42_0_g58605 = ( (-0.6 + (( 1.0 - lerpResult294_g58605 ) - 0.0) * (0.6 - -0.6) / (1.0 - 0.0)) + SAMPLE_TEXTURE2D( _DissolveNoise, sampler_DissolveNoise, temp_output_41_0_g58606 ).r );
				float lerpResult299_g58605 = lerp( FADE124_g58605 , temp_output_42_0_g58605 , temp_output_327_0_g58605);
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float lerpResult294_g58605 = lerp( temp_output_142_0_g58605 , lerpResult131_g58605 , _DissolveFadeEnable);
				float2 Offset235_g58606 = (_DissolveUVs).zw;
				float2 temp_output_41_0_g58606 = ( ( IN.ase_texcoord7.xy * (_DissolveUVs).xy ) + Offset235_g58606 );
				float temp_output_42_0_g58605 = ( (-0.6 + (( 1.0 - lerpResult294_g58605 ) - 0.0) * (0.6 - -0.6) / (1.0 - 0.0)) + SAMPLE_TEXTURE2D( _DissolveNoise, sampler_DissolveNoise, temp_output_41_0_g58606 ).r );
				float lerpResult299_g58605 = lerp( FADE124_g58605 , temp_output_42_0_g58605 , temp_output_327_0_g58605);
		...
		Pass
		{
						 ...
						 )
			{
				...
				float lerpResult294_g58605 = lerp( temp_output_142_0_g58605 , lerpResult131_g58605 , _DissolveFadeEnable);
				float2 Offset235_g58606 = (_DissolveUVs).zw;
				float2 temp_output_41_0_g58606 = ( ( IN.ase_texcoord6.xy * (_DissolveUVs).xy ) + Offset235_g58606 );
				float temp_output_42_0_g58605 = ( (-0.6 + (( 1.0 - lerpResult294_g58605 ) - 0.0) * (0.6 - -0.6) / (1.0 - 0.0)) + SAMPLE_TEXTURE2D( _DissolveNoise, sampler_DissolveNoise, temp_output_41_0_g58606 ).r );
				float lerpResult299_g58605 = lerp( FADE124_g58605 , temp_output_42_0_g58605 , temp_output_327_0_g58605);
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN ) : SV_TARGET
			{
				...
				float3 appendResult102_g58605 = (float3(ase_worldPos.x , ase_worldPos.y , ase_worldPos.z));
				float smoothstepResult118_g58605 = smoothstep( 0.0 , 1.0 , ( 1.0 - ( ( distance( _WorldSpaceCameraPos , appendResult102_g58605 ) - _DissolveFadeStart ) / ( _DissolveFadeEnd - _DissolveFadeStart ) ) ));
				float temp_output_327_0_g58605 = ( _DissolveEnable + ( ( _CATEGORY_DISSOLVE + _SPACE_DISSOLVE ) * 0.0 ) );
				float lerpResult300_g58605 = lerp( lerpResult305_g58605 , saturate( smoothstepResult118_g58605 ) , temp_output_327_0_g58605);
				float FADE_MODE189_g58605 = _DissolveFadeEnable;
				...
				float lerpResult294_g58605 = lerp( temp_output_142_0_g58605 , lerpResult131_g58605 , _DissolveFadeEnable);
				float2 Offset235_g58606 = (_DissolveUVs).zw;
				float2 temp_output_41_0_g58606 = ( ( IN.ase_texcoord2.xy * (_DissolveUVs).xy ) + Offset235_g58606 );
				float temp_output_42_0_g58605 = ( (-0.6 + (( 1.0 - lerpResult294_g58605 ) - 0.0) * (0.6 - -0.6) / (1.0 - 0.0)) + SAMPLE_TEXTURE2D( _DissolveNoise, sampler_DissolveNoise, temp_output_41_0_g58606 ).r );
				float lerpResult299_g58605 = lerp( FADE124_g58605 , temp_output_42_0_g58605 , temp_output_327_0_g58605);
				

				surfaceDescription.Alpha = lerpResult299_g58605;
...
/*ASEBEGIN
Version=19303
Node;AmplifyShaderEditor.FunctionNode;401;160,-640;Inherit;False;DESF Weather Wind;244;;57976;b135a554f7e4d0b41bba02c61b34ae74;5,3133,0,2371,0,2432,0,3138,0,3139,0;0;1;FLOAT3;2190
Node;AmplifyShaderEditor.FunctionNode;453;384,-640;Inherit;False;DESF Core Lit;2;;57979;e0cdd7758f4404849b063afff4596424;39,442,2,1557,0,1749,0,1556,0,2284,0,2283,0,2213,0,2481,0,2411,0,2399,0,2172,0,2282,0,3300,0,3301,0,3299,0,2132,0,3146,0,2311,0,3108,0,3119,0,3076,0,3408,0,3291,0,3290,0,3289,0,3287,0,96,0,2591,0,2559,0,1368,0,2125,0,2131,0,2028,0,1333,0,2126,0,1896,0,1415,0,830,0,2523,1;1;1234;FLOAT3;0,0,0;False;17;FLOAT3;38;FLOAT3;35;FLOAT;37;FLOAT3;1922;FLOAT;33;FLOAT;34;FLOAT;46;FLOAT;814;FLOAT;1660;FLOAT3;656;FLOAT3;657;FLOAT3;655;FLOAT3;1235;FLOAT3;2760;SAMPLERSTATE;1819;SAMPLERSTATE;1824;SAMPLERSTATE;1818
Node;AmplifyShaderEditor.FunctionNode;422;768,-720;Inherit;False;DESF Module Emission;175;;58567;f6260db0b43d4504b8a093f7f73e5a28;15,634,0,341,1,362,0,575,0,616,0,614,0,608,1,611,1,586,0,197,1,376,0,258,0,543,0,596,0,597,0;3;83;FLOAT3;0,0,0;False;192;FLOAT3;0,0,1;False;613;SAMPLERSTATE;;False;2;FLOAT3;96;FLOAT3;0
Node;AmplifyShaderEditor.FunctionNode;399;1056,-800;Inherit;False;DESF Module Dissolve;162;;58605;c18c6a51f7ef1204bbd962806cd4208d;4,262,0,266,0,265,0,303,1;2;267;FLOAT3;0,0,0;False;174;FLOAT;1;False;2;FLOAT3;0;FLOAT;21
Node;AmplifyShaderEditor.RangedFloatNode;353;1168,-432;Inherit;False;Property;_MaskClipValue;Mask Clip Value;1;0;Create;False;1;;0;0;False;0;False;0.57;0.57;0;0;0;1;FLOAT;0
