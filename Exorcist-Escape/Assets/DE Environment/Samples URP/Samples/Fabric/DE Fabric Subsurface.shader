...
Shader "DE Environment/Fabric/Subsurface"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				float2 vertexToFrag607_g57576 = ( ( ( ( ( v.texcoord.xy * _BaseAffectUVchannel0 ) + ( v.texcoord1.xy * _BaseAffectUVchannel1 ) ) + ( ( v.texcoord2.xy * _BaseAffectUVchannel2 ) + ( v.ase_texcoord3.xy * _BaseAffectUVchannel3 ) ) ) * (_BaseMainUV).xy ) + (_BaseMainUV).zw );
				o.ase_texcoord8.xy = vertexToFrag607_g57576;
				float2 temp_output_383_0_g57576 = ( ( ( v.texcoord.xy * _ThreadMaskUVAffectchannel0 ) + ( v.texcoord1.xy * _ThreadMaskUVAffectchannel1 ) ) + ( ( v.texcoord2.xy * _ThreadMaskUVAffectchannel2 ) + ( v.ase_texcoord3.xy * _ThreadMaskUVAffectchannel3 ) ) );
				float2 vertexToFrag615_g57576 = ( ( temp_output_383_0_g57576 * (_FuzzMaskUV).xy ) + (_FuzzMaskUV).zw );
				o.ase_texcoord8.zw = vertexToFrag615_g57576;
				
				float2 vertexToFrag610_g57576 = ( ( temp_output_383_0_g57576 * (_ThreadMaskUV).xy ) + (_ThreadMaskUV).zw );
				o.ase_texcoord9.xy = vertexToFrag610_g57576;
						...
						, bool ase_vface : SV_IsFrontFace ) : SV_Target
			{
				...
				float localStochasticTiling159_g57577 = ( 0.0 );
				float2 vertexToFrag607_g57576 = IN.ase_texcoord8.xy;
				float2 UVBase593_g57576 = vertexToFrag607_g57576;
				float2 UV159_g57577 = UVBase593_g57576;
				float4 TexelSize159_g57577 = _MainTex_TexelSize;
				float4 Offsets159_g57577 = float4( 0,0,0,0 );
				float2 Weights159_g57577 = float2( 0,0 );
				{
				UV159_g57577 = UV159_g57577 * TexelSize159_g57577.zw - 0.5;
				float2 f = frac( UV159_g57577 );
				UV159_g57577 -= f;
				...
				float4 c = float4( UV159_g57577.x - 0.5, UV159_g57577.x + 1.5, UV159_g57577.y - 0.5, UV159_g57577.y + 1.5 );
				float4 s = float4( xc.x + xc.y, xc.z + xc.w, yc.x + yc.y, yc.z + yc.w );
				float w0 = s.x / ( s.x + s.y );
				float w1 = s.z / ( s.z + s.w );
				Offsets159_g57577 = ( c + float4( xc.y, xc.w, yc.y, yc.w ) / s ) * TexelSize159_g57577.xyxy;
				Weights159_g57577 = float2( w0, w1 );
				}
				float4 Input_FetchOffsets70_g57578 = Offsets159_g57577;
				float2 Input_FetchWeights143_g57578 = Weights159_g57577;
				float2 break46_g57578 = Input_FetchWeights143_g57578;
				float4 lerpResult20_g57578 = lerp( SAMPLE_TEXTURE2D( _MainTex, sampler_MainTex, (Input_FetchOffsets70_g57578).yw ) , SAMPLE_TEXTURE2D( _MainTex, sampler_MainTex, (Input_FetchOffsets70_g57578).xw ) , break46_g57578.x);
				float4 lerpResult40_g57578 = lerp( SAMPLE_TEXTURE2D( _MainTex, sampler_MainTex, (Input_FetchOffsets70_g57578).yz ) , SAMPLE_TEXTURE2D( _MainTex, sampler_MainTex, (Input_FetchOffsets70_g57578).xz ) , break46_g57578.x);
				float4 lerpResult22_g57578 = lerp( lerpResult20_g57578 , lerpResult40_g57578 , break46_g57578.y);
				float4 Output_Fetch2D44_g57578 = lerpResult22_g57578;
				float3 temp_output_352_0_g57576 = (Output_Fetch2D44_g57578).rgb;
				float dotResult8_g57733 = dot( WorldNormal , WorldViewDirection );
				float TwoSidedSign642_g57576 = (1.0 + (sign( dotResult8_g57733 ) - -1.0) * (0.0 - 1.0) / (1.0 - -1.0));
				float3 lerpResult638_g57576 = lerp( ( (_BaseColor).rgb * temp_output_352_0_g57576 * _BaseBrightnessFrontFace ) , ( (_BaseColorBackFace).rgb * temp_output_352_0_g57576 * _BaseBrightnessBackFace ) , TwoSidedSign642_g57576);
				float3 temp_cast_0 = (0.0).xxx;
				float localStochasticTiling159_g57719 = ( 0.0 );
				float2 vertexToFrag615_g57576 = IN.ase_texcoord8.zw;
				float2 UVFuzz598_g57576 = vertexToFrag615_g57576;
				float2 UV159_g57719 = UVFuzz598_g57576;
				...
				float3 lerpResult57_g57576 = lerp( temp_cast_0 , ( (_FuzzMaskColor).rgb * break50_g57718.r ) , _FuzzMaskStrength);
				float3 lerpResult144_g57576 = lerp( lerpResult638_g57576 , saturate( ( lerpResult638_g57576 + lerpResult57_g57576 ) ) , ( _FuzzMaskEnable + ( ( _CATEGORY_FUZZMASK + _SPACE_FUZZMASK ) * 0.0 ) ));
				float3 BaseColor473_g57576 = lerpResult144_g57576;
				float3 temp_output_117_0_g57725 = BaseColor473_g57576;
				float3 temp_output_162_0_g57725 = ( (SAMPLE_TEXTURE2D( _SubsurfaceMask, sampler_MainTex, UVBase593_g57576 )).rgb / max( _SubsurfaceFeather , 1E-05 ) );
				float3 lerpResult288_g57725 = lerp( temp_output_162_0_g57725 , ( 1.0 - temp_output_162_0_g57725 ) , _SubsurfaceMaskInverted);
				float localStochasticTiling159_g57730 = ( 0.0 );
				float2 UV159_g57730 = UVBase593_g57576;
				...
				float4 Input_FetchOffsets70_g57580 = Offsets159_g57730;
				float2 Input_FetchWeights143_g57580 = Weights159_g57730;
				float2 break46_g57580 = Input_FetchWeights143_g57580;
				float4 lerpResult20_g57580 = lerp( SAMPLE_TEXTURE2D( _BumpMap, sampler_BumpMap, (Input_FetchOffsets70_g57580).yw ) , SAMPLE_TEXTURE2D( _BumpMap, sampler_BumpMap, (Input_FetchOffsets70_g57580).xw ) , break46_g57580.x);
				float4 lerpResult40_g57580 = lerp( SAMPLE_TEXTURE2D( _BumpMap, sampler_BumpMap, (Input_FetchOffsets70_g57580).yz ) , SAMPLE_TEXTURE2D( _BumpMap, sampler_BumpMap, (Input_FetchOffsets70_g57580).xz ) , break46_g57580.x);
				float4 lerpResult22_g57580 = lerp( lerpResult20_g57580 , lerpResult40_g57580 , break46_g57580.y);
				float4 Output_Fetch2D44_g57580 = lerpResult22_g57580;
				float3 unpack78_g57576 = UnpackNormalScale( Output_Fetch2D44_g57580, _NormalStrength );
				unpack78_g57576.z = lerp( 1, unpack78_g57576.z, saturate(_NormalStrength) );
				float3 NormalBase320_g57576 = unpack78_g57576;
				float3 tanToWorld0 = float3( WorldTangent.x, WorldBiTangent.x, WorldNormal.x );
				float3 tanToWorld1 = float3( WorldTangent.y, WorldBiTangent.y, WorldNormal.y );
				float3 tanToWorld2 = float3( WorldTangent.z, WorldBiTangent.z, WorldNormal.z );
				float3 tanNormal466_g57576 = NormalBase320_g57576;
				float3 worldNormal466_g57576 = float3(dot(tanToWorld0,tanNormal466_g57576), dot(tanToWorld1,tanNormal466_g57576), dot(tanToWorld2,tanNormal466_g57576));
				float3 temp_output_120_0_g57725 = worldNormal466_g57576;
				float3 temp_output_30_0_g57725 = ( temp_output_120_0_g57725 * _SubsurfaceDistortion );
				float3 normalizeResult263_g57725 = normalize( ( -( _MainLightPosition.xyz + temp_output_30_0_g57725 ) * ( -_MainLightPosition.xyz + temp_output_30_0_g57725 ) ) );
				float dotResult70_g57725 = dot( WorldViewDirection , normalizeResult263_g57725 );
				float3 temp_output_163_0_g57725 = saturate( ( lerpResult288_g57725 + saturate( ( pow( saturate( max( dotResult70_g57725 , 0.0 ) ) , _SubsurfaceAngle ) * _SubsurfaceScattering ) ) ) );
				float ase_lightIntensity = max( max( _MainLightColor.r, _MainLightColor.g ), _MainLightColor.b );
				float4 ase_lightColor = float4( _MainLightColor.rgb / ase_lightIntensity, ase_lightIntensity );
				float3 lerpResult268_g57725 = lerp( temp_output_117_0_g57725 , ( (_SubsurfaceColor).rgb * temp_output_117_0_g57725 * temp_output_163_0_g57725 * _SubsurfaceIntensity ) , max( ase_lightColor.a , 0.0 ));
				half3 TranslucencyMap11_g57725 = temp_output_163_0_g57725;
				float3 lerpResult51_g57725 = lerp( temp_output_117_0_g57725 , lerpResult268_g57725 , TranslucencyMap11_g57725);
				float3 lerpResult141_g57725 = lerp( temp_output_117_0_g57725 , lerpResult51_g57725 , ( _SubsurfaceEnable + ( ( _SPACE_SUBSURFACESCATTERING + _CATEGORY_SUBSURFACESCATTERING ) * 0.0 ) ));
				float3 Subsurface465_g57576 = lerpResult141_g57725;
				
				float localStochasticTiling159_g57583 = ( 0.0 );
				float2 vertexToFrag610_g57576 = IN.ase_texcoord9.xy;
				float2 UVThread602_g57576 = vertexToFrag610_g57576;
				float2 UV159_g57583 = UVThread602_g57576;
				float4 TexelSize159_g57583 = _ThreadNormalMap_TexelSize;
				float4 Offsets159_g57583 = float4( 0,0,0,0 );
				float2 Weights159_g57583 = float2( 0,0 );
				{
				UV159_g57583 = UV159_g57583 * TexelSize159_g57583.zw - 0.5;
				float2 f = frac( UV159_g57583 );
				UV159_g57583 -= f;
				float4 xn = float4( 1.0, 2.0, 3.0, 4.0 ) - f.xxxx;
				float4 yn = float4( 1.0, 2.0, 3.0, 4.0 ) - f.yyyy;
				float4 xs = xn * xn * xn;
				...
				float4 xc = float4( xv.xyz, 6.0 - xv.x - xv.y - xv.z );
				float4 yc = float4( yv.xyz, 6.0 - yv.x - yv.y - yv.z );
				float4 c = float4( UV159_g57583.x - 0.5, UV159_g57583.x + 1.5, UV159_g57583.y - 0.5, UV159_g57583.y + 1.5 );
				float4 s = float4( xc.x + xc.y, xc.z + xc.w, yc.x + yc.y, yc.z + yc.w );
				float w0 = s.x / ( s.x + s.y );
				float w1 = s.z / ( s.z + s.w );
				Offsets159_g57583 = ( c + float4( xc.y, xc.w, yc.y, yc.w ) / s ) * TexelSize159_g57583.xyxy;
				Weights159_g57583 = float2( w0, w1 );
				}
				float4 Input_FetchOffsets70_g57582 = Offsets159_g57583;
				float2 Input_FetchWeights143_g57582 = Weights159_g57583;
				float2 break46_g57582 = Input_FetchWeights143_g57582;
				float4 lerpResult20_g57582 = lerp( SAMPLE_TEXTURE2D( _ThreadNormalMap, sampler_BumpMap, (Input_FetchOffsets70_g57582).yw ) , SAMPLE_TEXTURE2D( _ThreadNormalMap, sampler_BumpMap, (Input_FetchOffsets70_g57582).xw ) , break46_g57582.x);
				float4 lerpResult40_g57582 = lerp( SAMPLE_TEXTURE2D( _ThreadNormalMap, sampler_BumpMap, (Input_FetchOffsets70_g57582).yz ) , SAMPLE_TEXTURE2D( _ThreadNormalMap, sampler_BumpMap, (Input_FetchOffsets70_g57582).xz ) , break46_g57582.x);
				float4 lerpResult22_g57582 = lerp( lerpResult20_g57582 , lerpResult40_g57582 , break46_g57582.y);
				float4 Output_Fetch2D44_g57582 = lerpResult22_g57582;
				float3 unpack253_g57576 = UnpackNormalScale( Output_Fetch2D44_g57582, _ThreadNormalStrength );
				unpack253_g57576.z = lerp( 1, unpack253_g57576.z, saturate(_ThreadNormalStrength) );
				float layeredBlendVar719_g57576 = 0.5;
				float3 layeredBlend719_g57576 = ( lerp( unpack78_g57576,unpack253_g57576 , layeredBlendVar719_g57576 ) );
				float3 break701_g57576 = layeredBlend719_g57576;
				float3 appendResult703_g57576 = (float3(break701_g57576.x , break701_g57576.y , ( break701_g57576.z + 0.001 )));
				float3 lerpResult91_g57576 = lerp( unpack78_g57576 , appendResult703_g57576 , ( _ThreadMaskEnable + ( ( _CATEGORY_THREADMASK + _SPACE_THREADMASK ) * 0.0 ) ));
				float3 temp_output_24_0_g57581 = lerpResult91_g57576;
				float temp_output_50_0_g57581 = _DoubleSidedNormalMode;
				float m_switch64_g57581 = temp_output_50_0_g57581;
				float3 m_Flip64_g57581 = float3(-1,-1,-1);
				float3 m_Mirror64_g57581 = float3(1,1,-1);
				float3 m_None64_g57581 = float3(1,1,1);
				float3 local_NormalModefloat3switch64_g57581 = _NormalModefloat3switch( m_switch64_g57581 , m_Flip64_g57581 , m_Mirror64_g57581 , m_None64_g57581 );
				float3 switchResult58_g57581 = (((ase_vface>0)?(temp_output_24_0_g57581):(( temp_output_24_0_g57581 * local_NormalModefloat3switch64_g57581 ))));
				
				float m_switch112_g57754 = _SpecularMode;
				float3 temp_output_143_0_g57755 = _MainLightPosition.xyz;
				float3 tanNormal153_g57754 = unpack78_g57576;
				...
				float localStochasticTiling159_g57588 = ( 0.0 );
				float2 UV159_g57588 = UVBase593_g57576;
				float4 TexelSize159_g57588 = _MaskMap_TexelSize;
				float4 Offsets159_g57588 = float4( 0,0,0,0 );
				float2 Weights159_g57588 = float2( 0,0 );
				{
				UV159_g57588 = UV159_g57588 * TexelSize159_g57588.zw - 0.5;
				float2 f = frac( UV159_g57588 );
				UV159_g57588 -= f;
				float4 xn = float4( 1.0, 2.0, 3.0, 4.0 ) - f.xxxx;
				float4 yn = float4( 1.0, 2.0, 3.0, 4.0 ) - f.yyyy;
				float4 xs = xn * xn * xn;
				...
				float4 xc = float4( xv.xyz, 6.0 - xv.x - xv.y - xv.z );
				float4 yc = float4( yv.xyz, 6.0 - yv.x - yv.y - yv.z );
				float4 c = float4( UV159_g57588.x - 0.5, UV159_g57588.x + 1.5, UV159_g57588.y - 0.5, UV159_g57588.y + 1.5 );
				float4 s = float4( xc.x + xc.y, xc.z + xc.w, yc.x + yc.y, yc.z + yc.w );
				float w0 = s.x / ( s.x + s.y );
				float w1 = s.z / ( s.z + s.w );
				Offsets159_g57588 = ( c + float4( xc.y, xc.w, yc.y, yc.w ) / s ) * TexelSize159_g57588.xyxy;
				Weights159_g57588 = float2( w0, w1 );
				}
				float4 Input_FetchOffsets70_g57587 = Offsets159_g57588;
				float2 Input_FetchWeights143_g57587 = Weights159_g57588;
				float2 break46_g57587 = Input_FetchWeights143_g57587;
				float4 lerpResult20_g57587 = lerp( SAMPLE_TEXTURE2D( _MaskMap, sampler_MaskMap, (Input_FetchOffsets70_g57587).yw ) , SAMPLE_TEXTURE2D( _MaskMap, sampler_MaskMap, (Input_FetchOffsets70_g57587).xw ) , break46_g57587.x);
				float4 lerpResult40_g57587 = lerp( SAMPLE_TEXTURE2D( _MaskMap, sampler_MaskMap, (Input_FetchOffsets70_g57587).yz ) , SAMPLE_TEXTURE2D( _MaskMap, sampler_MaskMap, (Input_FetchOffsets70_g57587).xz ) , break46_g57587.x);
				float4 lerpResult22_g57587 = lerp( lerpResult20_g57587 , lerpResult40_g57587 , break46_g57587.y);
				float4 Output_Fetch2D44_g57587 = lerpResult22_g57587;
				float4 break50_g57587 = Output_Fetch2D44_g57587;
				float MASK_R118_g57576 = break50_g57587.r;
				float lerpResult666_g57576 = lerp( ( 1.0 - ( _OcclusionStrengthAORemapMin + ( _OcclusionStrengthAO.x * 0.0 ) ) ) , ( 1.0 - _OcclusionStrengthAORemapMax ) , MASK_R118_g57576);
				float localStochasticTiling159_g57586 = ( 0.0 );
				float2 UV159_g57586 = UVBase593_g57576;
				float4 TexelSize159_g57586 = _ThreadMaskMap_TexelSize;
				float4 Offsets159_g57586 = float4( 0,0,0,0 );
				float2 Weights159_g57586 = float2( 0,0 );
				{
				UV159_g57586 = UV159_g57586 * TexelSize159_g57586.zw - 0.5;
				float2 f = frac( UV159_g57586 );
				UV159_g57586 -= f;
				float4 xn = float4( 1.0, 2.0, 3.0, 4.0 ) - f.xxxx;
				float4 yn = float4( 1.0, 2.0, 3.0, 4.0 ) - f.yyyy;
				float4 xs = xn * xn * xn;
				...
				float4 xc = float4( xv.xyz, 6.0 - xv.x - xv.y - xv.z );
				float4 yc = float4( yv.xyz, 6.0 - yv.x - yv.y - yv.z );
				float4 c = float4( UV159_g57586.x - 0.5, UV159_g57586.x + 1.5, UV159_g57586.y - 0.5, UV159_g57586.y + 1.5 );
				float4 s = float4( xc.x + xc.y, xc.z + xc.w, yc.x + yc.y, yc.z + yc.w );
				float w0 = s.x / ( s.x + s.y );
				float w1 = s.z / ( s.z + s.w );
				Offsets159_g57586 = ( c + float4( xc.y, xc.w, yc.y, yc.w ) / s ) * TexelSize159_g57586.xyxy;
				Weights159_g57586 = float2( w0, w1 );
				}
				float4 Input_FetchOffsets70_g57585 = Offsets159_g57586;
				float2 Input_FetchWeights143_g57585 = Weights159_g57586;
				float2 break46_g57585 = Input_FetchWeights143_g57585;
				float4 lerpResult20_g57585 = lerp( SAMPLE_TEXTURE2D( _ThreadMaskMap, sampler_MaskMap, (Input_FetchOffsets70_g57585).yw ) , SAMPLE_TEXTURE2D( _ThreadMaskMap, sampler_MaskMap, (Input_FetchOffsets70_g57585).xw ) , break46_g57585.x);
				float4 lerpResult40_g57585 = lerp( SAMPLE_TEXTURE2D( _ThreadMaskMap, sampler_MaskMap, (Input_FetchOffsets70_g57585).yz ) , SAMPLE_TEXTURE2D( _ThreadMaskMap, sampler_MaskMap, (Input_FetchOffsets70_g57585).xz ) , break46_g57585.x);
				float4 lerpResult22_g57585 = lerp( lerpResult20_g57585 , lerpResult40_g57585 , break46_g57585.y);
				float4 Output_Fetch2D44_g57585 = lerpResult22_g57585;
				float4 break50_g57585 = Output_Fetch2D44_g57585;
				float MASK_R_Thread264_g57576 = break50_g57585.r;
				float lerpResult521_g57576 = lerp( lerpResult666_g57576 , ( 1.0 - _ThreadMaskOcclusionStrengthAO ) , MASK_R_Thread264_g57576);
				float lerpResult113_g57576 = lerp( lerpResult666_g57576 , lerpResult521_g57576 , _ThreadMaskEnable);
				float temp_output_114_0_g57576 = saturate( lerpResult113_g57576 );
				float Occlusion745_g57576 = temp_output_114_0_g57576;
				
				float MASK_G60_g57576 = break50_g57587.g;
				float lerpResult657_g57576 = lerp( MASK_G60_g57576 , ( 1.0 - MASK_G60_g57576 ) , _SmoothnessSource);
				float lerpResult653_g57576 = lerp( ( _SmoothnessStrengthRemapMin + ( _SmoothnessStrength.x * 0.0 ) ) , _SmoothnessStrengthRemapMax , lerpResult657_g57576);
				float MASK_G_Thread52_g57576 = break50_g57585.g;
				float lerpResult514_g57576 = lerp( lerpResult653_g57576 , _ThreadMaskSmoothnessStrength , MASK_G_Thread52_g57576);
				float lerpResult89_g57576 = lerp( lerpResult653_g57576 , lerpResult514_g57576 , _ThreadMaskEnable);
				
				float4 break50_g57578 = Output_Fetch2D44_g57578;
				float temp_output_22_0_g57740 = break50_g57578.a;
				...
				float3 BaseColor = Subsurface465_g57576;
				float3 Normal = switchResult58_g57581;
				float3 Emission = 0;
				float3 Specular = ( BaseColor473_g57576 * lerpResult80_g57754 * Occlusion745_g57576 );
				float Metallic = 0;
				float Smoothness = saturate( lerpResult89_g57576 );
				float Occlusion = temp_output_114_0_g57576;
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v )
			{
				...
				float2 vertexToFrag607_g57576 = ( ( ( ( ( v.ase_texcoord.xy * _BaseAffectUVchannel0 ) + ( v.ase_texcoord1.xy * _BaseAffectUVchannel1 ) ) + ( ( v.ase_texcoord2.xy * _BaseAffectUVchannel2 ) + ( v.ase_texcoord3.xy * _BaseAffectUVchannel3 ) ) ) * (_BaseMainUV).xy ) + (_BaseMainUV).zw );
				o.ase_texcoord3.xy = vertexToFrag607_g57576;
						 ...
						 ) : SV_TARGET
			{
				...
				float localStochasticTiling159_g57577 = ( 0.0 );
				float2 vertexToFrag607_g57576 = IN.ase_texcoord3.xy;
				float2 UVBase593_g57576 = vertexToFrag607_g57576;
				float2 UV159_g57577 = UVBase593_g57576;
				float4 TexelSize159_g57577 = _MainTex_TexelSize;
				float4 Offsets159_g57577 = float4( 0,0,0,0 );
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				float2 vertexToFrag607_g57576 = ( ( ( ( ( v.texcoord0.xy * _BaseAffectUVchannel0 ) + ( v.texcoord1.xy * _BaseAffectUVchannel1 ) ) + ( ( v.texcoord2.xy * _BaseAffectUVchannel2 ) + ( v.ase_texcoord3.xy * _BaseAffectUVchannel3 ) ) ) * (_BaseMainUV).xy ) + (_BaseMainUV).zw );
				o.ase_texcoord4.xy = vertexToFrag607_g57576;
				o.ase_texcoord5.xyz = ase_worldNormal;
				float2 temp_output_383_0_g57576 = ( ( ( v.texcoord0.xy * _ThreadMaskUVAffectchannel0 ) + ( v.texcoord1.xy * _ThreadMaskUVAffectchannel1 ) ) + ( ( v.texcoord2.xy * _ThreadMaskUVAffectchannel2 ) + ( v.ase_texcoord3.xy * _ThreadMaskUVAffectchannel3 ) ) );
				float2 vertexToFrag615_g57576 = ( ( temp_output_383_0_g57576 * (_FuzzMaskUV).xy ) + (_FuzzMaskUV).zw );
				o.ase_texcoord4.zw = vertexToFrag615_g57576;
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float localStochasticTiling159_g57577 = ( 0.0 );
				float2 vertexToFrag607_g57576 = IN.ase_texcoord4.xy;
				float2 UVBase593_g57576 = vertexToFrag607_g57576;
				float2 UV159_g57577 = UVBase593_g57576;
				float4 TexelSize159_g57577 = _MainTex_TexelSize;
				float4 Offsets159_g57577 = float4( 0,0,0,0 );
				...
				float3 temp_cast_0 = (0.0).xxx;
				float localStochasticTiling159_g57719 = ( 0.0 );
				float2 vertexToFrag615_g57576 = IN.ase_texcoord4.zw;
				float2 UVFuzz598_g57576 = vertexToFrag615_g57576;
				float2 UV159_g57719 = UVFuzz598_g57576;
				float4 TexelSize159_g57719 = _FuzzMaskMap_TexelSize;
				float4 Offsets159_g57719 = float4( 0,0,0,0 );
				...
				float3 temp_output_30_0_g57725 = ( temp_output_120_0_g57725 * _SubsurfaceDistortion );
				float3 normalizeResult263_g57725 = normalize( ( -( _MainLightPosition.xyz + temp_output_30_0_g57725 ) * ( -_MainLightPosition.xyz + temp_output_30_0_g57725 ) ) );
				float dotResult70_g57725 = dot( ase_worldViewDir , normalizeResult263_g57725 );
				float3 temp_output_163_0_g57725 = saturate( ( lerpResult288_g57725 + saturate( ( pow( saturate( max( dotResult70_g57725 , 0.0 ) ) , _SubsurfaceAngle ) * _SubsurfaceScattering ) ) ) );
				float ase_lightIntensity = max( max( _MainLightColor.r, _MainLightColor.g ), _MainLightColor.b );
				float4 ase_lightColor = float4( _MainLightColor.rgb / ase_lightIntensity, ase_lightIntensity );
				float3 lerpResult268_g57725 = lerp( temp_output_117_0_g57725 , ( (_SubsurfaceColor).rgb * temp_output_117_0_g57725 * temp_output_163_0_g57725 * _SubsurfaceIntensity ) , max( ase_lightColor.a , 0.0 ));
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				float2 vertexToFrag607_g57576 = ( ( ( ( ( v.ase_texcoord.xy * _BaseAffectUVchannel0 ) + ( v.ase_texcoord1.xy * _BaseAffectUVchannel1 ) ) + ( ( v.ase_texcoord2.xy * _BaseAffectUVchannel2 ) + ( v.ase_texcoord3.xy * _BaseAffectUVchannel3 ) ) ) * (_BaseMainUV).xy ) + (_BaseMainUV).zw );
				o.ase_texcoord2.xy = vertexToFrag607_g57576;
				o.ase_texcoord3.xyz = ase_worldNormal;
				float2 temp_output_383_0_g57576 = ( ( ( v.ase_texcoord.xy * _ThreadMaskUVAffectchannel0 ) + ( v.ase_texcoord1.xy * _ThreadMaskUVAffectchannel1 ) ) + ( ( v.ase_texcoord2.xy * _ThreadMaskUVAffectchannel2 ) + ( v.ase_texcoord3.xy * _ThreadMaskUVAffectchannel3 ) ) );
				float2 vertexToFrag615_g57576 = ( ( temp_output_383_0_g57576 * (_FuzzMaskUV).xy ) + (_FuzzMaskUV).zw );
				o.ase_texcoord2.zw = vertexToFrag615_g57576;
				float3 ase_worldTangent = TransformObjectToWorldDir(v.ase_tangent.xyz);
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float localStochasticTiling159_g57577 = ( 0.0 );
				float2 vertexToFrag607_g57576 = IN.ase_texcoord2.xy;
				float2 UVBase593_g57576 = vertexToFrag607_g57576;
				float2 UV159_g57577 = UVBase593_g57576;
				float4 TexelSize159_g57577 = _MainTex_TexelSize;
				float4 Offsets159_g57577 = float4( 0,0,0,0 );
				...
				float3 temp_cast_0 = (0.0).xxx;
				float localStochasticTiling159_g57719 = ( 0.0 );
				float2 vertexToFrag615_g57576 = IN.ase_texcoord2.zw;
				float2 UVFuzz598_g57576 = vertexToFrag615_g57576;
				float2 UV159_g57719 = UVFuzz598_g57576;
				float4 TexelSize159_g57719 = _FuzzMaskMap_TexelSize;
				float4 Offsets159_g57719 = float4( 0,0,0,0 );
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				float2 vertexToFrag607_g57576 = ( ( ( ( ( v.ase_texcoord.xy * _BaseAffectUVchannel0 ) + ( v.ase_texcoord1.xy * _BaseAffectUVchannel1 ) ) + ( ( v.ase_texcoord2.xy * _BaseAffectUVchannel2 ) + ( v.ase_texcoord3.xy * _BaseAffectUVchannel3 ) ) ) * (_BaseMainUV).xy ) + (_BaseMainUV).zw );
				o.ase_texcoord5.xy = vertexToFrag607_g57576;
				float2 temp_output_383_0_g57576 = ( ( ( v.ase_texcoord.xy * _ThreadMaskUVAffectchannel0 ) + ( v.ase_texcoord1.xy * _ThreadMaskUVAffectchannel1 ) ) + ( ( v.ase_texcoord2.xy * _ThreadMaskUVAffectchannel2 ) + ( v.ase_texcoord3.xy * _ThreadMaskUVAffectchannel3 ) ) );
				float2 vertexToFrag610_g57576 = ( ( temp_output_383_0_g57576 * (_ThreadMaskUV).xy ) + (_ThreadMaskUV).zw );
				o.ase_texcoord5.zw = vertexToFrag610_g57576;
						...
						, bool ase_vface : SV_IsFrontFace )
			{
				...
				float localStochasticTiling159_g57730 = ( 0.0 );
				float2 vertexToFrag607_g57576 = IN.ase_texcoord5.xy;
				float2 UVBase593_g57576 = vertexToFrag607_g57576;
				float2 UV159_g57730 = UVBase593_g57576;
				float4 TexelSize159_g57730 = _BumpMap_TexelSize;
				float4 Offsets159_g57730 = float4( 0,0,0,0 );
				...
				unpack78_g57576.z = lerp( 1, unpack78_g57576.z, saturate(_NormalStrength) );
				float localStochasticTiling159_g57583 = ( 0.0 );
				float2 vertexToFrag610_g57576 = IN.ase_texcoord5.zw;
				float2 UVThread602_g57576 = vertexToFrag610_g57576;
				float2 UV159_g57583 = UVThread602_g57576;
				float4 TexelSize159_g57583 = _ThreadNormalMap_TexelSize;
				float4 Offsets159_g57583 = float4( 0,0,0,0 );
		...
		Pass
		{
			...
			VertexOutput VertexFunction(VertexInput v  )
			{
				...
				float2 vertexToFrag607_g57576 = ( ( ( ( ( v.ase_texcoord.xy * _BaseAffectUVchannel0 ) + ( v.ase_texcoord1.xy * _BaseAffectUVchannel1 ) ) + ( ( v.ase_texcoord2.xy * _BaseAffectUVchannel2 ) + ( v.ase_texcoord3.xy * _BaseAffectUVchannel3 ) ) ) * (_BaseMainUV).xy ) + (_BaseMainUV).zw );
				o.ase_texcoord.xy = vertexToFrag607_g57576;
			...
			half4 frag(VertexOutput IN ) : SV_TARGET
			{
				...
				float localStochasticTiling159_g57577 = ( 0.0 );
				float2 vertexToFrag607_g57576 = IN.ase_texcoord.xy;
				float2 UVBase593_g57576 = vertexToFrag607_g57576;
				float2 UV159_g57577 = UVBase593_g57576;
				float4 TexelSize159_g57577 = _MainTex_TexelSize;
				float4 Offsets159_g57577 = float4( 0,0,0,0 );
...
/*ASEBEGIN
Version=19303
Node;AmplifyShaderEditor.FunctionNode;2931;-4352,-3584;Inherit;False;DESF Core Fabric;1;;57576;033f93dd140fa644f8cd65abcbe86c5d;7,454,2,579,1,571,1,575,1,582,1,586,1,471,1;0;13;FLOAT3;0;FLOAT3;120;FLOAT3;127;FLOAT;121;FLOAT;122;FLOAT;123;FLOAT;504;FLOAT;506;FLOAT3;464;FLOAT3;463;FLOAT3;459;SAMPLERSTATE;623;SAMPLERSTATE;622
Node;AmplifyShaderEditor.FunctionNode;2897;-4352,-3216;Inherit;False;DESF Weather Wind Fabric;122;;57758;8377dc31f489b0a4b82781c845d5d4e7;2,3138,1,3139,0;0;1;FLOAT3;2190
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;2935;-3968,-3584;Float;False;True;-1;2;DE_ShaderGUI;0;12;DE Environment/Fabric/Subsurface;94348b07e5e8bab40bd6c8a1e3df54cd;True;Forward;0;1;Forward;21;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;True;True;0;True;_Cull;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;5;True;12;all;0;False;True;1;1;False;;0;False;;1;1;False;;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;1;LightMode=UniversalForward;False;False;0;Hidden/DE/Utility/Fallback;0;0;Standard;39;Workflow;0;638176365294498947;Surface;0;0;  Refraction Model;0;0;  Blend;0;0;Two Sided;1;0;Fragment Normal Space,InvertActionOnDeselection;0;0;Forward Only;0;0;Transmission;0;0;  Transmission Shadow;0.5,True,_ASETransmissionShadow;0;Translucency;0;0;  Translucency Strength;1,True,_ASETranslucencyStrength;0;  Normal Distortion;0.5,True,_ASETranslucencyNormalDistortion;0;  Scattering;2,True,_ASETranslucencyScattering;0;  Direct;0.9,True,_ASETranslucencyScattering;0;  Ambient;0.1,True,_ASETranslucencyAmbient;0;  Shadow;0.5,True,_ASETranslucencyShadow;0;Cast Shadows;1;0;  Use Shadow Threshold;1;638176365314700194;GPU Instancing;1;0;LOD CrossFade;1;0;Built-in Fog;1;0;_FinalColorxAlpha;0;0;Meta Pass;1;0;Override Baked GI;0;0;Extra Pre Pass;0;0;Tessellation;0;0;  Phong;0;0;  Strength;0.5,True,_TessellationPhong;0;  Type;0;0;  Tess;16,True,_TessellationStrength;0;  Min;10,True,_TessellationDistanceMin;0;  Max;25,True,_TessellationDistanceMax;0;  Edge Length;16,False,;0;  Max Displacement;25,False,;0;Write Depth;0;0;  Early Z;0;0;Vertex Position,InvertActionOnDeselection;1;0;Debug Display;0;0;Clear Coat;0;0;0;10;False;True;True;True;True;True;True;True;True;True;False;;True;0
...
WireConnection;2935;16;2931;506
WireConnection;2935;8;2897;2190
ASEEND*/
//CHKSM=216FC8F4B715DB325B9456088E0CF098C645BFE8