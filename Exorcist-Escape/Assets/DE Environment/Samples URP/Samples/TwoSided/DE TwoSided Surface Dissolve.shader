...
Shader "DE Environment/TwoSided/Surface Dissolve"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				o.ase_texcoord9.yz = v.texcoord.xy;
						...
						, bool ase_vface : SV_IsFrontFace ) : SV_Target
			{
				...
				float2 temp_output_2159_0_g57726 = vertexToFrag70_g57780;
				float4 tex2DNode2144_g57726 = SAMPLE_TEXTURE2D( _MainTex, sampler_MainTex, temp_output_2159_0_g57726 );
				float3 SIDE01_ALBEDO_RGBA1688_g57726 = (tex2DNode2144_g57726).rgb;
				float2 vertexToFrag70_g57783 = IN.ase_texcoord8.zw;
				float2 temp_output_2160_0_g57726 = vertexToFrag70_g57783;
				float4 tex2DNode2147_g57726 = SAMPLE_TEXTURE2D( _02MainTex, sampler_MainTex, temp_output_2160_0_g57726 );
				float3 SIDE02_ALBEDO_RGBA1779_g57726 = (tex2DNode2147_g57726).rgb;
				float dotResult8_g57729 = dot( WorldNormal , WorldViewDirection );
				float temp_output_1850_0_g57726 = (1.0 + (sign( dotResult8_g57729 ) - -1.0) * (0.0 - 1.0) / (1.0 - -1.0));
				float3 lerpResult1357_g57726 = lerp( ( (_00Color).rgb * SIDE01_ALBEDO_RGBA1688_g57726 * _00Brightness ) , ( (_02Color).rgb * SIDE02_ALBEDO_RGBA1779_g57726 * _02Brightness ) , temp_output_1850_0_g57726);
				
				float4 SIDE01_NORMAL_RGB1710_g57726 = SAMPLE_TEXTURE2D( _00BumpMap, sampler_00BumpMap, temp_output_2159_0_g57726 );
				float3 unpack2040_g57726 = UnpackNormalScale( SIDE01_NORMAL_RGB1710_g57726, _00NormalStrength );
				unpack2040_g57726.z = lerp( 1, unpack2040_g57726.z, saturate(_00NormalStrength) );
				float3 temp_output_24_0_g57766 = unpack2040_g57726;
				...
				float4 SIDE02_NORMAL_RGBA1780_g57726 = SAMPLE_TEXTURE2D( _02BumpMap, sampler_00BumpMap, temp_output_2160_0_g57726 );
				float3 unpack2042_g57726 = UnpackNormalScale( SIDE02_NORMAL_RGBA1780_g57726, _02NormalStrength );
				unpack2042_g57726.z = lerp( 1, unpack2042_g57726.z, saturate(_02NormalStrength) );
				float3 temp_output_24_0_g58202 = unpack2042_g57726;
				...
				float3 lerpResult1545_g57726 = lerp( switchResult58_g57766 , switchResult58_g58202 , temp_output_1850_0_g57726);
				
				half4 color201_g58203 = IsGammaSpace() ? half4(0,0,0,0) : half4(0,0,0,0);
				float3 temp_output_348_0_g58203 = (color201_g58203).rgb;
				float temp_output_142_0_g58203 = ( _DissolveStrenght * 15.0 );
				float eyeDepth = IN.ase_texcoord9.x;
				float temp_output_155_0_g58203 = ( _DissolveFadeStart + _ProjectionParams.y );
				float temp_output_156_0_g58203 = ( ( eyeDepth + -temp_output_155_0_g58203 ) / ( _DissolveFadeEnd - temp_output_155_0_g58203 ) );
				float4 ase_screenPosNorm = ScreenPos / ScreenPos.w;
				ase_screenPosNorm.z = ( UNITY_NEAR_CLIP_VALUE >= 0 ) ? ase_screenPosNorm.z : ase_screenPosNorm.z * 0.5 + 0.5;
				float dither165_g58203 = DitherNoiseTex(ase_screenPosNorm, _DissolveDitherMap, sampler_DissolveDitherMap, _DissolveDitherMap_TexelSize);
				float lerpResult305_g58203 = lerp( temp_output_156_0_g58203 , ( temp_output_156_0_g58203 - dither165_g58203 ) , _DissolveDitherEnable);
				float3 appendResult102_g58203 = (float3(WorldPosition.x , WorldPosition.y , WorldPosition.z));
				float smoothstepResult118_g58203 = smoothstep( 0.0 , 1.0 , ( 1.0 - ( ( distance( _WorldSpaceCameraPos , appendResult102_g58203 ) - _DissolveFadeStart ) / ( _DissolveFadeEnd - _DissolveFadeStart ) ) ));
				float temp_output_327_0_g58203 = ( _DissolveEnable + ( ( _CATEGORY_DISSOLVE + _SPACE_DISSOLVE ) * 0.0 ) );
				float lerpResult300_g58203 = lerp( lerpResult305_g58203 , saturate( smoothstepResult118_g58203 ) , temp_output_327_0_g58203);
				float FADE_MODE189_g58203 = _DissolveFadeEnable;
				float lerpResult295_g58203 = lerp( 1.0 , lerpResult300_g58203 , FADE_MODE189_g58203);
				float FADE124_g58203 = lerpResult295_g58203;
				float lerpResult131_g58203 = lerp( 0.0 , temp_output_142_0_g58203 , FADE124_g58203);
				float lerpResult294_g58203 = lerp( temp_output_142_0_g58203 , lerpResult131_g58203 , _DissolveFadeEnable);
				float2 Offset235_g58204 = (_DissolveUVs).zw;
				float2 temp_output_41_0_g58204 = ( ( IN.ase_texcoord9.yz * (_DissolveUVs).xy ) + Offset235_g58204 );
				float temp_output_42_0_g58203 = ( (-0.6 + (( 1.0 - lerpResult294_g58203 ) - 0.0) * (0.6 - -0.6) / (1.0 - 0.0)) + SAMPLE_TEXTURE2D( _DissolveNoise, sampler_DissolveNoise, temp_output_41_0_g58204 ).r );
				float clampResult45_g58203 = clamp( (-4.0 + (temp_output_42_0_g58203 - 0.0) * (4.0 - -4.0) / (1.0 - 0.0)) , 0.0 , 1.0 );
				float temp_output_46_0_g58203 = ( 1.0 - clampResult45_g58203 );
				float2 appendResult47_g58203 = (float2(temp_output_46_0_g58203 , 0.0));
				float3 lerpResult298_g58203 = lerp( temp_output_348_0_g58203 , ( ( temp_output_46_0_g58203 + temp_output_348_0_g58203 ) * (SAMPLE_TEXTURE2D( _DissolveRamp, sampler_DissolveNoise, appendResult47_g58203 )).rgb ) , temp_output_327_0_g58203);
				
				float4 tex2DNode2146_g57726 = SAMPLE_TEXTURE2D( _00MaskMap, sampler_00MaskMap, temp_output_2159_0_g57726 );
				float SIDE01_MASK_B1720_g57726 = tex2DNode2146_g57726.b;
				float4 tex2DNode2149_g57726 = SAMPLE_TEXTURE2D( _02MaskMap, sampler_00MaskMap, temp_output_2160_0_g57726 );
				float SIDE02_MASK_B1781_g57726 = tex2DNode2149_g57726.b;
				float lerpResult1361_g57726 = lerp( ( _00MetallicStrength * SIDE01_MASK_B1720_g57726 ) , ( _02MetallicStrength * SIDE02_MASK_B1781_g57726 ) , temp_output_1850_0_g57726);
				
				float SIDE01_MASK_G1683_g57726 = tex2DNode2146_g57726.g;
				float lerpResult2244_g57726 = lerp( SIDE01_MASK_G1683_g57726 , ( 1.0 - SIDE01_MASK_G1683_g57726 ) , _00SmoothnessSource);
				float temp_output_2243_0_g57726 = ( lerpResult2244_g57726 * _00SmoothnessStrength );
				float2 appendResult2252_g57726 = (float2(WorldViewDirection.xy));
				float3 appendResult2251_g57726 = (float3(appendResult2252_g57726 , ( WorldViewDirection.z / 1.06 )));
				float fresnelNdotV2249_g57726 = dot( normalize( unpack2040_g57726 ), appendResult2251_g57726 );
				float fresnelNode2249_g57726 = ( 0.0 + ( 1.0 - _00SmoothnessFresnelScale ) * pow( max( 1.0 - fresnelNdotV2249_g57726 , 0.0001 ), _00SmoothnessFresnelPower ) );
				float lerpResult2248_g57726 = lerp( temp_output_2243_0_g57726 , ( temp_output_2243_0_g57726 - fresnelNode2249_g57726 ) , _00SmoothnessFresnelEnable);
				float SIDE02_MASK_G1782_g57726 = tex2DNode2149_g57726.g;
				float lerpResult2267_g57726 = lerp( SIDE02_MASK_G1782_g57726 , ( 1.0 - SIDE02_MASK_G1782_g57726 ) , _02SmoothnessSource);
				float temp_output_2266_0_g57726 = ( lerpResult2267_g57726 * _02SmoothnessStrength );
				float2 appendResult2275_g57726 = (float2(WorldViewDirection.xy));
				float3 appendResult2274_g57726 = (float3(appendResult2275_g57726 , ( WorldViewDirection.z / 1.06 )));
				float fresnelNdotV2272_g57726 = dot( normalize( unpack2042_g57726 ), appendResult2274_g57726 );
				float fresnelNode2272_g57726 = ( 0.0 + ( 1.0 - _02SmoothnessFresnelScale ) * pow( max( 1.0 - fresnelNdotV2272_g57726 , 0.0001 ), _02SmoothnessFresnelPower ) );
				float lerpResult2271_g57726 = lerp( temp_output_2266_0_g57726 , ( temp_output_2266_0_g57726 - fresnelNode2272_g57726 ) , _02SmoothnessFresnelEnable);
				float lerpResult1360_g57726 = lerp( saturate( lerpResult2248_g57726 ) , saturate( lerpResult2271_g57726 ) , temp_output_1850_0_g57726);
				
				float SIDE01_MASK_R1691_g57726 = tex2DNode2146_g57726.r;
				float lerpResult2317_g57726 = lerp( 1.0 , SIDE01_MASK_R1691_g57726 , _00OcclusionStrengthAO);
				float lerpResult2316_g57726 = lerp( 1.0 , IN.ase_color.a , _00OcclusionStrengthAO);
				float lerpResult2296_g57726 = lerp( lerpResult2317_g57726 , lerpResult2316_g57726 , _00OcclusionSourceBaked);
				float SIDE02_MASK_R1783_g57726 = tex2DNode2149_g57726.r;
				float lerpResult2319_g57726 = lerp( 1.0 , SIDE02_MASK_R1783_g57726 , _02OcclusionStrengthAO);
				float lerpResult2318_g57726 = lerp( 1.0 , IN.ase_color.a , _02OcclusionStrengthAO);
				float lerpResult2307_g57726 = lerp( lerpResult2319_g57726 , lerpResult2318_g57726 , _02OcclusionSourceBaked);
				float lerpResult1362_g57726 = lerp( saturate( lerpResult2296_g57726 ) , saturate( lerpResult2307_g57726 ) , temp_output_1850_0_g57726);
				
				float lerpResult299_g58203 = lerp( FADE124_g58203 , temp_output_42_0_g58203 , temp_output_327_0_g58203);
				

				float3 BaseColor = lerpResult1357_g57726;
				float3 Normal = lerpResult1545_g57726;
				float3 Emission = lerpResult298_g58203;
				float3 Specular = 0.5;
				float Metallic = lerpResult1361_g57726;
				float Smoothness = lerpResult1360_g57726;
				float Occlusion = lerpResult1362_g57726;
				float Alpha = lerpResult299_g58203;
		...
		Pass
		{
						 ...
						 ) : SV_TARGET
			{
				...
				float lerpResult294_g58203 = lerp( temp_output_142_0_g58203 , lerpResult131_g58203 , _DissolveFadeEnable);
				float2 Offset235_g58204 = (_DissolveUVs).zw;
				float2 temp_output_41_0_g58204 = ( ( IN.ase_texcoord3.yz * (_DissolveUVs).xy ) + Offset235_g58204 );
				float temp_output_42_0_g58203 = ( (-0.6 + (( 1.0 - lerpResult294_g58203 ) - 0.0) * (0.6 - -0.6) / (1.0 - 0.0)) + SAMPLE_TEXTURE2D( _DissolveNoise, sampler_DissolveNoise, temp_output_41_0_g58204 ).r );
				float lerpResult299_g58203 = lerp( FADE124_g58203 , temp_output_42_0_g58203 , temp_output_327_0_g58203);
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float dotResult8_g57729 = dot( ase_worldNormal , ase_worldViewDir );
				float temp_output_1850_0_g57726 = (1.0 + (sign( dotResult8_g57729 ) - -1.0) * (0.0 - 1.0) / (1.0 - -1.0));
				float3 lerpResult1357_g57726 = lerp( ( (_00Color).rgb * SIDE01_ALBEDO_RGBA1688_g57726 * _00Brightness ) , ( (_02Color).rgb * SIDE02_ALBEDO_RGBA1779_g57726 * _02Brightness ) , temp_output_1850_0_g57726);
				...
				float lerpResult294_g58203 = lerp( temp_output_142_0_g58203 , lerpResult131_g58203 , _DissolveFadeEnable);
				float2 Offset235_g58204 = (_DissolveUVs).zw;
				float2 temp_output_41_0_g58204 = ( ( IN.ase_texcoord7.xy * (_DissolveUVs).xy ) + Offset235_g58204 );
				float temp_output_42_0_g58203 = ( (-0.6 + (( 1.0 - lerpResult294_g58203 ) - 0.0) * (0.6 - -0.6) / (1.0 - 0.0)) + SAMPLE_TEXTURE2D( _DissolveNoise, sampler_DissolveNoise, temp_output_41_0_g58204 ).r );
				float clampResult45_g58203 = clamp( (-4.0 + (temp_output_42_0_g58203 - 0.0) * (4.0 - -4.0) / (1.0 - 0.0)) , 0.0 , 1.0 );
				float temp_output_46_0_g58203 = ( 1.0 - clampResult45_g58203 );
				float2 appendResult47_g58203 = (float2(temp_output_46_0_g58203 , 0.0));
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float lerpResult294_g58203 = lerp( temp_output_142_0_g58203 , lerpResult131_g58203 , _DissolveFadeEnable);
				float2 Offset235_g58204 = (_DissolveUVs).zw;
				float2 temp_output_41_0_g58204 = ( ( IN.ase_texcoord5.xy * (_DissolveUVs).xy ) + Offset235_g58204 );
				float temp_output_42_0_g58203 = ( (-0.6 + (( 1.0 - lerpResult294_g58203 ) - 0.0) * (0.6 - -0.6) / (1.0 - 0.0)) + SAMPLE_TEXTURE2D( _DissolveNoise, sampler_DissolveNoise, temp_output_41_0_g58204 ).r );
				float lerpResult299_g58203 = lerp( FADE124_g58203 , temp_output_42_0_g58203 , temp_output_327_0_g58203);
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				o.ase_texcoord6.yz = v.ase_texcoord.xy;
						...
						, bool ase_vface : SV_IsFrontFace )
			{
				...
				float3 ase_worldViewDir = ( _WorldSpaceCameraPos.xyz - WorldPosition );
				ase_worldViewDir = SafeNormalize( ase_worldViewDir );
				float dotResult8_g57729 = dot( WorldNormal , ase_worldViewDir );
				float temp_output_1850_0_g57726 = (1.0 + (sign( dotResult8_g57729 ) - -1.0) * (0.0 - 1.0) / (1.0 - -1.0));
				float3 lerpResult1545_g57726 = lerp( switchResult58_g57766 , switchResult58_g58202 , temp_output_1850_0_g57726);
				...
				float lerpResult294_g58203 = lerp( temp_output_142_0_g58203 , lerpResult131_g58203 , _DissolveFadeEnable);
				float2 Offset235_g58204 = (_DissolveUVs).zw;
				float2 temp_output_41_0_g58204 = ( ( IN.ase_texcoord6.yz * (_DissolveUVs).xy ) + Offset235_g58204 );
				float temp_output_42_0_g58203 = ( (-0.6 + (( 1.0 - lerpResult294_g58203 ) - 0.0) * (0.6 - -0.6) / (1.0 - 0.0)) + SAMPLE_TEXTURE2D( _DissolveNoise, sampler_DissolveNoise, temp_output_41_0_g58204 ).r );
				float lerpResult299_g58203 = lerp( FADE124_g58203 , temp_output_42_0_g58203 , temp_output_327_0_g58203);
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN ) : SV_TARGET
			{
				...
				float3 appendResult102_g58203 = (float3(ase_worldPos.x , ase_worldPos.y , ase_worldPos.z));
				float smoothstepResult118_g58203 = smoothstep( 0.0 , 1.0 , ( 1.0 - ( ( distance( _WorldSpaceCameraPos , appendResult102_g58203 ) - _DissolveFadeStart ) / ( _DissolveFadeEnd - _DissolveFadeStart ) ) ));
				float temp_output_327_0_g58203 = ( _DissolveEnable + ( ( _CATEGORY_DISSOLVE + _SPACE_DISSOLVE ) * 0.0 ) );
				float lerpResult300_g58203 = lerp( lerpResult305_g58203 , saturate( smoothstepResult118_g58203 ) , temp_output_327_0_g58203);
				float FADE_MODE189_g58203 = _DissolveFadeEnable;
				...
				float lerpResult294_g58203 = lerp( temp_output_142_0_g58203 , lerpResult131_g58203 , _DissolveFadeEnable);
				float2 Offset235_g58204 = (_DissolveUVs).zw;
				float2 temp_output_41_0_g58204 = ( ( IN.ase_texcoord2.xy * (_DissolveUVs).xy ) + Offset235_g58204 );
				float temp_output_42_0_g58203 = ( (-0.6 + (( 1.0 - lerpResult294_g58203 ) - 0.0) * (0.6 - -0.6) / (1.0 - 0.0)) + SAMPLE_TEXTURE2D( _DissolveNoise, sampler_DissolveNoise, temp_output_41_0_g58204 ).r );
				float lerpResult299_g58203 = lerp( FADE124_g58203 , temp_output_42_0_g58203 , temp_output_327_0_g58203);
				

				surfaceDescription.Alpha = lerpResult299_g58203;
...
Node;AmplifyShaderEditor.FunctionNode;394;1056,-752;Inherit;False;DESF Module Dissolve;96;;58203;c18c6a51f7ef1204bbd962806cd4208d;4,262,0,266,0,265,0,303,0;2;267;FLOAT3;0,0,0;False;174;FLOAT;1;False;2;FLOAT3;0;FLOAT;21
