...
Shader "DE Environment/Vegetation Snow/Billboard Sprite"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				float dotResult982_g57535 = dot( normalizedWorldNormal , ase_worldViewDir );
				float3 lerpResult989_g57535 = lerp( v.normalOS , -v.normalOS , step( dotResult982_g57535 , -1.0 ));
				
				float4 appendResult986_g57535 = (float4(cross( v.normalOS , float3(0,0,1) ) , -1.0));
				...
				float3 vertexValue = lerpResult1846_g57764;
					...
					v.positionOS.xyz += vertexValue;
				#endif
				v.normalOS = lerpResult989_g57535;
				v.tangentOS = appendResult986_g57535;
						...
						, bool ase_vface : SV_IsFrontFace ) : SV_Target
			{
				...
				float4 tex2DNode3_g57535 = SAMPLE_TEXTURE2D( _MainTex, sampler_MainTex, vertexToFrag30_g57757 );
				float3 temp_output_28_0_g57535 = ( (_BaseColor).rgb * (tex2DNode3_g57535).rgb * _Brightness );
				float3 temp_output_72_0_g57764 = temp_output_28_0_g57535;
				...
				float3 unpack748_g57535 = UnpackNormalScale( SAMPLE_TEXTURE2D( _BumpMap, sampler_BumpMap, vertexToFrag30_g57757 ), _NormalStrength );
				unpack748_g57535.z = lerp( 1, unpack748_g57535.z, saturate(_NormalStrength) );
				float3 temp_output_24_0_g57759 = unpack748_g57535;
				...
				float2 appendResult899_g57535 = (float2(WorldViewDirection.xy));
				float3 appendResult898_g57535 = (float3(appendResult899_g57535 , ( WorldViewDirection.z / 1.06 )));
				float3 break928_g57535 = unpack748_g57535;
				float3 normalizeResult934_g57535 = normalize( ( ( WorldTangent * break928_g57535.x ) + ( WorldBiTangent * break928_g57535.y ) + ( WorldNormal * break928_g57535.z ) ) );
				float3 Normal_Per_Pixel937_g57535 = normalizeResult934_g57535;
				float fresnelNdotV896_g57535 = dot( normalize( Normal_Per_Pixel937_g57535 ), appendResult898_g57535 );
				float fresnelNode896_g57535 = ( 0.0 + ( 1.0 - _SmoothnessFresnelScale ) * pow( max( 1.0 - fresnelNdotV896_g57535 , 0.0001 ), _SmoothnessFresnelPower ) );
				float lerpResult895_g57535 = lerp( _SmoothnessStrength , ( _SmoothnessStrength - fresnelNode896_g57535 ) , _SmoothnessFresnelEnable);
				float4 temp_cast_15 = (saturate( lerpResult895_g57535 )).xxxx;
				...
				float temp_output_22_0_g57735 = tex2DNode3_g57535.a;
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;495;-256,256;Float;False;True;-1;2;DE_ShaderGUI;0;12;DE Environment/Vegetation Snow/Billboard Sprite;94348b07e5e8bab40bd6c8a1e3df54cd;True;Forward;0;1;Forward;21;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;True;True;0;True;_Cull;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;5;True;12;all;0;False;True;1;1;False;;0;False;;1;1;False;;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;1;LightMode=UniversalForward;False;False;0;Hidden/DE/Utility/Fallback;0;0;Standard;39;Workflow;1;0;Surface;0;0;  Refraction Model;0;0;  Blend;0;0;Two Sided;1;0;Fragment Normal Space,InvertActionOnDeselection;0;0;Forward Only;0;0;Transmission;0;0;  Transmission Shadow;0.5,True,_ASETransmissionShadow;0;Translucency;0;0;  Translucency Strength;1,True,_ASETranslucencyStrength;0;  Normal Distortion;0.5,True,_ASETranslucencyNormalDistortion;0;  Scattering;2,True,_ASETranslucencyScattering;0;  Direct;0.9,True,_ASETranslucencyScattering;0;  Ambient;0.1,True,_ASETranslucencyAmbient;0;  Shadow;0.5,True,_ASETranslucencyShadow;0;Cast Shadows;1;0;  Use Shadow Threshold;1;638177049211111962;GPU Instancing;1;0;LOD CrossFade;1;0;Built-in Fog;1;0;_FinalColorxAlpha;0;0;Meta Pass;1;0;Override Baked GI;0;0;Extra Pre Pass;0;0;Tessellation;0;0;  Phong;0;0;  Strength;0.5,True,_TessellationPhong;0;  Type;0;0;  Tess;16,True,_TessellationStrength;0;  Min;10,True,_TessellationDistanceMin;0;  Max;25,True,_TessellationDistanceMax;0;  Edge Length;16,False,;0;  Max Displacement;25,False,;0;Write Depth;0;0;  Early Z;0;0;Vertex Position,InvertActionOnDeselection;1;0;Debug Display;0;0;Clear Coat;0;0;0;10;False;True;True;True;True;True;True;True;True;True;False;;True;0
...
ASEEND*/
//CHKSM=240C5A86E071567343C32FEDC1C129CE34CE54FB