...
Shader "DE Environment/Toon/Toon Translucency"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
				...
				, bool ase_vface : SV_IsFrontFace ) : SV_Target
			{
				...
				float3 temp_output_249_0_g59008 = (_TransmissionColor).rgb;
				float4 color71_g59008 = IsGammaSpace() ? float4(0,0,0,0) : float4(0,0,0,0);
				float3 temp_output_247_0_g59008 = (color71_g59008).rgb;
				float2 temp_output_101_0_g59008 = vertexToFrag258_g58588;
				float3 temp_output_162_0_g59008 = saturate( ( (SAMPLE_TEXTURE2D( _TransmissionMaskMap, sampler_MainTex, temp_output_101_0_g59008 )).rgb / max( _TransmissionMaskFeather , 1E-05 ) ) );
				float3 lerpResult172_g59008 = lerp( temp_output_247_0_g59008 , temp_output_162_0_g59008 , _TransmissionMaskStrength);
				float temp_output_165_0_g59008 = ( 0.0 - 1.0 );
				float temp_output_168_0_g59008 = ( temp_output_162_0_g59008.x - 1.0 );
				float lerpResult173_g59008 = lerp( ( temp_output_165_0_g59008 / temp_output_168_0_g59008 ) , ( temp_output_168_0_g59008 / temp_output_165_0_g59008 ) , ( 0.7 + _TransmissionMaskStrength ));
				float3 lerpResult148_g59008 = lerp( ( temp_output_249_0_g59008 * _TransmissionStrength * lerpResult172_g59008 ) , ( temp_output_249_0_g59008 * _TransmissionStrength * saturate( lerpResult173_g59008 ) ) , _TransmissionMaskInverted);
				float3 lerpResult147_g59008 = lerp( ( temp_output_249_0_g59008 * _TransmissionStrength ) , lerpResult148_g59008 , _TransmissionSource);
				float3 lerpResult122_g59008 = lerp( float3( 0,0,0 ) , lerpResult147_g59008 , ( _TransmissionEnable + ( ( _CATEGORY_TRANSLUCENCY + _SPACE_TRANSMISSION ) * 0.0 ) ));
				float3 Translucency1367_g58588 = lerpResult122_g59008;
				float3 temp_output_248_0_g59008 = (_TranslucencyColor).rgb;
				float3 temp_output_113_0_g59008 = saturate( ( (SAMPLE_TEXTURE2D( _ThicknessMap, sampler_MainTex, temp_output_101_0_g59008 )).rgb / max( _ThicknessFeather , 1E-05 ) ) );
				float3 lerpResult34_g59008 = lerp( temp_output_247_0_g59008 , temp_output_113_0_g59008 , _ThicknessStrength);
				float temp_output_69_0_g59008 = ( 0.0 - 1.0 );
				float temp_output_22_0_g59008 = ( temp_output_113_0_g59008.x - 1.0 );
				float lerpResult66_g59008 = lerp( ( temp_output_69_0_g59008 / temp_output_22_0_g59008 ) , ( temp_output_22_0_g59008 / temp_output_69_0_g59008 ) , ( 0.7 + _ThicknessStrength ));
				float3 lerpResult153_g59008 = lerp( ( temp_output_248_0_g59008 * lerpResult34_g59008 * _TranslucencyStrength ) , ( temp_output_248_0_g59008 * saturate( lerpResult66_g59008 ) * _TranslucencyStrength ) , _ThicknessMapInverted);
				float3 lerpResult150_g59008 = lerp( ( temp_output_248_0_g59008 * _TranslucencyStrength ) , lerpResult153_g59008 , _TranslucencySource);
				float ase_lightAtten = 0;
				Light ase_mainLight = GetMainLight( ShadowCoords );
				ase_lightAtten = ase_mainLight.distanceAttenuation * ase_mainLight.shadowAttenuation;
				float3 temp_output_88_0_g59008 = ( ( ase_lightAtten * ase_lightColor.rgb ) * max( ase_lightColor.a , 0.0 ) );
				float3 lerpResult123_g59008 = lerp( float3( 0,0,0 ) , ( lerpResult150_g59008 * saturate( temp_output_88_0_g59008 ) ) , ( _TranslucencyEnable + ( ( _SPACE_TRANSLUCENCY + _CATEGORY_TRANSMISSION ) * 0.0 ) ));
				float3 Transmission1368_g58588 = lerpResult123_g59008;
				float3 temp_output_49_0_g58995 = ( ( lerpResult1233_g59011 + Translucency1367_g58588 ) + Transmission1368_g58588 );
...
Node;AmplifyShaderEditor.FunctionNode;645;1024,-640;Inherit;False;DESF Core Unlit;1;;58588;3944efaa362116b4f940e5ea065ac456;27,671,0,682,0,688,0,684,0,681,0,669,0,1642,0,1353,0,1513,0,868,1,1613,0,125,1,1162,1,146,1,355,1,334,1,1487,1,1606,1,284,1,1500,0,1584,0,780,1,1658,1,753,1,1375,1,1374,1,332,1;0;4;FLOAT3;370;FLOAT;186;FLOAT;185;FLOAT;187
...
ASEEND*/
//CHKSM=1F9459AD7EFE2BB23CEAC2B6D7AB25EEF8C53A6E