...
Shader "DE Environment/Cutout/Height Tessellation"
{
	Properties
	{
		...
		[DE_DrawerToggleNoKeyword]_DisplacementNormalReconstructed("Normal Reconstructed", Float) = 0
	...
	SubShader
	{
		...
		Pass
		{
			...
			half _DisplacementNormalReconstructed;
			...
			void CalculateUVsSmooth149_g58318( float2 UV, float4 TexelSize, out float2 UV0, out float2 UV1, out float2 UV2, out float2 UV3, out float2 UV4, out float2 UV5, out float2 UV6, out float2 UV7, out float2 UV8 )
			{
				{
			...
			float3 CombineSamplesSmooth150_g58318( float Strength, float S0, float S1, float S2, float S3, float S4, float S5, float S6, float S7, float S8 )
			{
				{
				    float3 normal;
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				float3 temp_output_1234_0_g45996 = _Vector8;
				...
				float2 temp_output_1955_0_g45996 = (_MainUVs).xy;
				float2 temp_output_1953_0_g45996 = (_MainUVs).zw;
				float2 Offset235_g58525 = temp_output_1953_0_g45996;
				float2 temp_output_41_0_g58525 = ( ( localfloat2switchUVMode80_g58525 * temp_output_1955_0_g45996 ) + Offset235_g58525 );
				float2 vertexToFrag70_g58525 = temp_output_41_0_g58525;
				float2 UV213_g45996 = vertexToFrag70_g58525;
				float3 Displacment2502_g45996 = (SAMPLE_TEXTURE2D_LOD( _ParallaxMap, sampler_ParallaxMap, UV213_g45996, 0.0 )).rgb;
				float3 lerpResult2554_g45996 = lerp( Displacment2502_g45996 , ( 1.0 - Displacment2502_g45996 ) , _DisplacementBlendInversion);
				float3 lerpResult2551_g45996 = lerp( _Vector8 , ( v.normalOS * ( lerpResult2554_g45996 * _DisplacementStrength ) ) , ( _DisplacementEnable + ( ( _CATEGORY_DISPLACEMENT + _SPACE_DISPLACEMENT ) * 0.0 ) ));
				...
				float3 vertexValue = ( temp_output_1234_0_g45996 + lerpResult2551_g45996 );
						...
						, bool ase_vface : SV_IsFrontFace ) : SV_Target
			{
				...
				float3 temp_output_1923_0_g45996 = (_BaseColor).rgb;
				float2 vertexToFrag70_g58525 = IN.ase_texcoord8.xy;
				float2 UV213_g45996 = vertexToFrag70_g58525;
				float4 tex2DNode2048_g45996 = SAMPLE_TEXTURE2D( _MainTex, sampler_MainTex, UV213_g45996 );
				float3 ALBEDO_RGBA1381_g45996 = (tex2DNode2048_g45996).rgb;
				float3 temp_output_3_0_g45996 = ( temp_output_1923_0_g45996 * ALBEDO_RGBA1381_g45996 * _Brightness );
				float3 temp_output_134_0_g58123 = temp_output_3_0_g45996;
				...
				float4 NORMAL_RGBA1382_g45996 = SAMPLE_TEXTURE2D( _BumpMap, sampler_BumpMap, UV213_g45996 );
				float3 unpack1891_g45996 = UnpackNormalScale( NORMAL_RGBA1382_g45996, _NormalStrength );
				unpack1891_g45996.z = lerp( 1, unpack1891_g45996.z, saturate(_NormalStrength) );
				float Strength139_g58318 = ( _NormalStrength * 2.0 );
				float Strength150_g58318 = Strength139_g58318;
				float localCalculateUVsSmooth149_g58318 = ( 0.0 );
				float2 UV119_g58318 = UV213_g45996;
				float2 UV149_g58318 = UV119_g58318;
				float4 TexelSize149_g58318 = _ParallaxMap_TexelSize;
				float2 UV0149_g58318 = float2( 0,0 );
				float2 UV1149_g58318 = float2( 0,0 );
				float2 UV2149_g58318 = float2( 0,0 );
				float2 UV3149_g58318 = float2( 0,0 );
				float2 UV4149_g58318 = float2( 0,0 );
				float2 UV5149_g58318 = float2( 0,0 );
				float2 UV6149_g58318 = float2( 0,0 );
				float2 UV7149_g58318 = float2( 0,0 );
				float2 UV8149_g58318 = float2( 0,0 );
				CalculateUVsSmooth149_g58318( UV149_g58318 , TexelSize149_g58318 , UV0149_g58318 , UV1149_g58318 , UV2149_g58318 , UV3149_g58318 , UV4149_g58318 , UV5149_g58318 , UV6149_g58318 , UV7149_g58318 , UV8149_g58318 );
				float4 tex2DNode55_g58318 = SAMPLE_TEXTURE2D( _ParallaxMap, sampler_ParallaxMap, UV0149_g58318 );
				float S0150_g58318 = tex2DNode55_g58318.r;
				float4 tex2DNode57_g58318 = SAMPLE_TEXTURE2D( _ParallaxMap, sampler_ParallaxMap, UV1149_g58318 );
				float S1150_g58318 = tex2DNode57_g58318.r;
				float4 tex2DNode6_g58318 = SAMPLE_TEXTURE2D( _ParallaxMap, sampler_ParallaxMap, UV2149_g58318 );
				float S2150_g58318 = tex2DNode6_g58318.r;
				float4 tex2DNode69_g58318 = SAMPLE_TEXTURE2D( _ParallaxMap, sampler_ParallaxMap, UV3149_g58318 );
				float S3150_g58318 = tex2DNode69_g58318.r;
				float4 tex2DNode77_g58318 = SAMPLE_TEXTURE2D( _ParallaxMap, sampler_ParallaxMap, UV4149_g58318 );
				float S4150_g58318 = tex2DNode77_g58318.r;
				float4 tex2DNode86_g58318 = SAMPLE_TEXTURE2D( _ParallaxMap, sampler_ParallaxMap, UV5149_g58318 );
				float S5150_g58318 = tex2DNode86_g58318.r;
				float4 tex2DNode73_g58318 = SAMPLE_TEXTURE2D( _ParallaxMap, sampler_ParallaxMap, UV6149_g58318 );
				float S6150_g58318 = tex2DNode73_g58318.r;
				float4 tex2DNode89_g58318 = SAMPLE_TEXTURE2D( _ParallaxMap, sampler_ParallaxMap, UV7149_g58318 );
				float S7150_g58318 = tex2DNode89_g58318.r;
				float4 tex2DNode56_g58318 = SAMPLE_TEXTURE2D( _ParallaxMap, sampler_ParallaxMap, UV8149_g58318 );
				float S8150_g58318 = tex2DNode56_g58318.r;
				float3 localCombineSamplesSmooth150_g58318 = CombineSamplesSmooth150_g58318( Strength150_g58318 , S0150_g58318 , S1150_g58318 , S2150_g58318 , S3150_g58318 , S4150_g58318 , S5150_g58318 , S6150_g58318 , S7150_g58318 , S8150_g58318 );
				float3 lerpResult2520_g45996 = lerp( unpack1891_g45996 , localCombineSamplesSmooth150_g58318 , _DisplacementNormalReconstructed);
				float DisplacementEnable2553_g45996 = _DisplacementEnable;
				float3 lerpResult2522_g45996 = lerp( unpack1891_g45996 , lerpResult2520_g45996 , DisplacementEnable2553_g45996);
				float3 temp_output_24_0_g58217 = lerpResult2522_g45996;
				...
				float4 tex2DNode2050_g45996 = SAMPLE_TEXTURE2D( _MaskMap, sampler_MaskMap, UV213_g45996 );
				float MASK_B1377_g45996 = tex2DNode2050_g45996.b;
				
				float MASK_G158_g45996 = tex2DNode2050_g45996.g;
				float temp_output_2651_0_g45996 = ( 1.0 - MASK_G158_g45996 );
				float lerpResult2650_g45996 = lerp( MASK_G158_g45996 , temp_output_2651_0_g45996 , _SmoothnessSource);
				float temp_output_2693_0_g45996 = ( lerpResult2650_g45996 * _SmoothnessStrength );
				float2 appendResult2645_g45996 = (float2(WorldViewDirection.xy));
				float3 appendResult2644_g45996 = (float3(appendResult2645_g45996 , ( WorldViewDirection.z / 1.06 )));
				float3 break2680_g45996 = lerpResult2522_g45996;
				float3 normalizeResult2641_g45996 = normalize( ( ( WorldTangent * break2680_g45996.x ) + ( WorldBiTangent * break2680_g45996.y ) + ( WorldNormal * break2680_g45996.z ) ) );
				float3 Normal_Per_Pixel2690_g45996 = normalizeResult2641_g45996;
				float fresnelNdotV2685_g45996 = dot( normalize( Normal_Per_Pixel2690_g45996 ), appendResult2644_g45996 );
				float fresnelNode2685_g45996 = ( 0.0 + ( 1.0 - _SmoothnessFresnelScale ) * pow( max( 1.0 - fresnelNdotV2685_g45996 , 0.0001 ), _SmoothnessFresnelPower ) );
				float lerpResult2636_g45996 = lerp( temp_output_2693_0_g45996 , ( temp_output_2693_0_g45996 - fresnelNode2685_g45996 ) , _SmoothnessFresnelEnable);
				
				float MASK_R1378_g45996 = tex2DNode2050_g45996.r;
				float lerpResult3415_g45996 = lerp( 1.0 , MASK_R1378_g45996 , _OcclusionStrengthAO);
				float lerpResult3414_g45996 = lerp( 1.0 , IN.ase_color.a , _OcclusionStrengthAO);
				float lerpResult2709_g45996 = lerp( lerpResult3415_g45996 , lerpResult3414_g45996 , _OcclusionSource);
				float temp_output_2730_0_g45996 = saturate( lerpResult2709_g45996 );
				
				float temp_output_22_0_g58267 = tex2DNode2048_g45996.a;
				...
				float3 Emission = 0;
				float3 Specular = 0.5;
				float Metallic = ( _MetallicStrength * MASK_B1377_g45996 );
				float Smoothness = saturate( lerpResult2636_g45996 );
				float Occlusion = temp_output_2730_0_g45996;
...
/*ASEBEGIN
Version=19303
Node;AmplifyShaderEditor.CommentaryNode;2883;-4416,-4016;Inherit;False;316.1923;375.7019;TESSELLATION;4;2887;2886;2885;2884;;0,0,0,1;0;0
Node;AmplifyShaderEditor.FunctionNode;2877;-4416,-3584;Inherit;False;DESF Core Lit;7;;45996;e0cdd7758f4404849b063afff4596424;39,442,2,1557,0,1749,0,1556,0,2284,0,2283,0,2213,0,2481,0,2411,0,2399,0,2172,0,2282,0,3300,0,3301,0,3299,0,2132,0,3146,0,2311,0,3108,0,3119,0,3076,0,3408,0,3291,0,3290,0,3289,0,3287,0,96,2,2591,0,2559,0,1368,0,2125,0,2131,0,2028,0,1333,0,2126,1,1896,0,1415,1,830,1,2523,1;1;1234;FLOAT3;0,0,0;False;17;FLOAT3;38;FLOAT3;35;FLOAT;37;FLOAT3;1922;FLOAT;33;FLOAT;34;FLOAT;46;FLOAT;814;FLOAT;1660;FLOAT3;656;FLOAT3;657;FLOAT3;655;FLOAT3;1235;FLOAT3;2760;SAMPLERSTATE;1819;SAMPLERSTATE;1824;SAMPLERSTATE;1818
Node;AmplifyShaderEditor.RangedFloatNode;2884;-4384,-3968;Half;False;Property;_TessellationPhong;Tessellation Phong;3;0;Create;False;1;;0;0;True;0;False;0.5;0.5;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;2885;-4384,-3888;Half;False;Property;_TessellationStrength;Tessellation Strength;2;0;Create;False;1;;0;0;True;0;False;6;6;0.001;100;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;2886;-4384,-3808;Half;False;Property;_TessellationDistanceMin;Tessellation Distance Min;4;0;Create;False;1;;0;0;True;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;2887;-4384,-3728;Half;False;Property;_TessellationDistanceMax;Tessellation Distance Max ;5;0;Create;False;1;;0;0;True;0;False;5;5;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;2918;-3968,-4032;Inherit;False;Property;_CATEGORY_TESSELLATION;CATEGORY_TESSELLATION;1;0;Create;True;0;0;0;True;1;DE_DrawerCategory(TESSELLATION,true,_TessellationStrength,0,0);False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;2917;-3968,-3952;Inherit;False;Property;_SPACE_TESSELLATION;SPACE_TESSELLATION;6;0;Create;True;0;0;0;True;1;DE_DrawerSpace(10);False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.IntNode;2904;-3968,-3664;Inherit;False;Property;_Cull;Render Face;0;2;[HideInInspector];[Enum];Create;False;0;0;1;Front,2,Back,1,Both,0;True;0;False;2;2;False;0;1;INT;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;2921;-3960.694,-3584;Float;False;False;-1;2;DE_ShaderGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;ExtraPrePass;0;0;ExtraPrePass;5;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;5;True;12;all;0;False;True;1;1;False;;0;False;;0;1;False;;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;0;False;False;0;Hidden/DE/Utility/Fallback;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;2923;-3960.694,-3630.498;Float;False;False;-1;2;DE_ShaderGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;ShadowCaster;0;2;ShadowCaster;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;5;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;False;False;True;False;False;False;False;0;False;;False;False;False;False;False;False;False;False;False;True;1;False;;True;3;False;;False;True;1;LightMode=ShadowCaster;False;False;0;Hidden/DE/Utility/Fallback;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;2924;-3960.694,-3630.498;Float;False;False;-1;2;DE_ShaderGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;DepthOnly;0;3;DepthOnly;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;5;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;False;False;True;False;False;False;False;0;False;;False;False;False;False;False;False;False;False;False;True;1;False;;False;False;True;1;LightMode=DepthOnly;False;False;0;Hidden/DE/Utility/Fallback;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;2925;-3960.694,-3630.498;Float;False;False;-1;2;DE_ShaderGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;Meta;0;4;Meta;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;5;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;2;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=Meta;False;False;0;Hidden/DE/Utility/Fallback;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;2926;-3960.694,-3630.498;Float;False;False;-1;2;DE_ShaderGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;Universal2D;0;5;Universal2D;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;5;True;12;all;0;False;True;1;1;False;;0;False;;1;1;False;;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;False;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;1;LightMode=Universal2D;False;False;0;Hidden/DE/Utility/Fallback;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;2927;-3960.694,-3630.498;Float;False;False;-1;2;DE_ShaderGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;DepthNormals;0;6;DepthNormals;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;5;True;12;all;0;False;True;1;1;False;;0;False;;0;1;False;;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;False;;True;3;False;;False;True;1;LightMode=DepthNormals;False;False;0;Hidden/DE/Utility/Fallback;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;2928;-3960.694,-3630.498;Float;False;False;-1;2;DE_ShaderGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;GBuffer;0;7;GBuffer;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;5;True;12;all;0;False;True;1;1;False;;0;False;;1;1;False;;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;1;LightMode=UniversalGBuffer;False;False;0;Hidden/DE/Utility/Fallback;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;2929;-3960.694,-3630.498;Float;False;False;-1;2;DE_ShaderGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;SceneSelectionPass;0;8;SceneSelectionPass;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;5;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;2;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=SceneSelectionPass;False;False;0;Hidden/DE/Utility/Fallback;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;2930;-3960.694,-3630.498;Float;False;False;-1;2;DE_ShaderGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;ScenePickingPass;0;9;ScenePickingPass;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;5;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=Picking;False;False;0;Hidden/DE/Utility/Fallback;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;2922;-3968,-3584;Float;False;True;-1;2;DE_ShaderGUI;0;12;DE Environment/Cutout/Height Tessellation;94348b07e5e8bab40bd6c8a1e3df54cd;True;Forward;0;1;Forward;21;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;True;True;0;True;_Cull;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;5;True;12;all;0;False;True;1;1;False;;0;False;;1;1;False;;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;1;LightMode=UniversalForward;False;False;0;Hidden/DE/Utility/Fallback;0;0;Standard;39;Workflow;1;0;Surface;0;0;  Refraction Model;0;0;  Blend;0;0;Two Sided;1;0;Fragment Normal Space,InvertActionOnDeselection;0;0;Forward Only;0;0;Transmission;0;0;  Transmission Shadow;0.5,True,_ASETransmissionShadow;0;Translucency;0;0;  Translucency Strength;1,True,_ASETranslucencyStrength;0;  Normal Distortion;0.5,True,_ASETranslucencyNormalDistortion;0;  Scattering;2,True,_ASETranslucencyScattering;0;  Direct;0.9,True,_ASETranslucencyScattering;0;  Ambient;0.1,True,_ASETranslucencyAmbient;0;  Shadow;0.5,True,_ASETranslucencyShadow;0;Cast Shadows;1;0;  Use Shadow Threshold;1;638176994243031219;GPU Instancing;1;0;LOD CrossFade;1;0;Built-in Fog;1;0;_FinalColorxAlpha;0;0;Meta Pass;1;0;Override Baked GI;0;0;Extra Pre Pass;0;0;Tessellation;1;638176994278788155;  Phong;1;638176994288809483;  Strength;0.5,True,_TessellationPhong;638176994463122944;  Type;1;638176994315122827;  Tess;16,True,_TessellationStrength;638176994547694456;  Min;10,True,_TessellationDistanceMin;638176994579470637;  Max;25,True,_TessellationDistanceMax;638176994621560034;  Edge Length;16,False,;0;  Max Displacement;25,False,;0;Write Depth;0;0;  Early Z;0;0;Vertex Position,InvertActionOnDeselection;1;0;Debug Display;0;0;Clear Coat;0;0;0;10;False;True;True;True;True;True;True;True;True;True;False;;True;0
WireConnection;2922;0;2877;38
WireConnection;2922;1;2877;35
WireConnection;2922;3;2877;37
WireConnection;2922;4;2877;33
WireConnection;2922;5;2877;34
WireConnection;2922;6;2877;46
WireConnection;2922;7;2877;814
WireConnection;2922;16;2877;1660
WireConnection;2922;8;2877;1235
ASEEND*/
//CHKSM=D06DC9FF26D47D6963647A8ED1A0106BB3A0B4D8