...
Shader "DE Environment/DEC/Cutout Translucency Wind"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
						...
						, bool ase_vface : SV_IsFrontFace ) : SV_Target
			{
				...
				float3 MASK_B1377_g58558 = (SAMPLE_TEXTURE2D( _MetallicGlossMap, sampler_MetallicGlossMap, UV213_g58558 )).rgb;
				
				float3 MASK_G158_g58558 = (SAMPLE_TEXTURE2D( _SmoothnessMap, sampler_SmoothnessMap, UV213_g58558 )).rgb;
				float3 temp_output_2651_0_g58558 = ( 1.0 - MASK_G158_g58558 );
				float3 lerpResult2650_g58558 = lerp( MASK_G158_g58558 , temp_output_2651_0_g58558 , _SmoothnessSource);
				float3 temp_output_2693_0_g58558 = ( lerpResult2650_g58558 * _SmoothnessStrength );
				...
				float3 temp_cast_8 = (fresnelNode2685_g58558).xxx;
				float3 lerpResult2636_g58558 = lerp( temp_output_2693_0_g58558 , ( temp_output_2693_0_g58558 - temp_cast_8 ) , _SmoothnessFresnelEnable);
				
				float3 MASK_R1378_g58558 = (SAMPLE_TEXTURE2D( _OcclusionMap, sampler_OcclusionMap, UV213_g58558 )).rgb;
				float3 lerpResult3415_g58558 = lerp( float3( 1,0,0 ) , MASK_R1378_g58558 , _OcclusionStrengthAO);
				float lerpResult3414_g58558 = lerp( 1.0 , IN.ase_color.a , _OcclusionStrengthAO);
				float3 temp_cast_10 = (lerpResult3414_g58558).xxx;
				float3 lerpResult2709_g58558 = lerp( lerpResult3415_g58558 , temp_cast_10 , _OcclusionSource);
				float3 temp_output_2730_0_g58558 = saturate( lerpResult2709_g58558 );
				...
				float3 Emission = 0;
				float3 Specular = 0.5;
				float Metallic = ( _MetallicStrength * MASK_B1377_g58558 ).x;
				float Smoothness = saturate( lerpResult2636_g58558 ).x;
				float Occlusion = temp_output_2730_0_g58558.x;
...
Node;AmplifyShaderEditor.FunctionNode;2871;-4640,-3584;Inherit;False;DESF Weather Wind;168;;58555;b135a554f7e4d0b41bba02c61b34ae74;5,3133,1,2371,1,2432,1,3138,0,3139,0;0;1;FLOAT3;2190
...
ASEEND*/
//CHKSM=1173611D11D430068EB325FE55947D4AAE714873