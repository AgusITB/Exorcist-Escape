...
Shader "DE Environment/Stochastic/Surface Triplanar Moss"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				float3 p1_g58605 = ( float3( (ase_worldPos).xz ,  0.0 ) * _MossHeightNoiseShift );
				float localSimpleNoise3D1_g58605 = SimpleNoise3D( p1_g58605 );
				float temp_output_966_0_g58603 = ( localSimpleNoise3D1_g58605 / _MossHeightNoiseScale );
				float4 appendResult952_g58603 = (float4(temp_output_966_0_g58603 , temp_output_966_0_g58603 , 0.0 , 0.0));
				float3 normalizeResult881_g58603 = normalize( v.normalOS );
				float3 ase_worldNormal = TransformObjectToWorldNormal(v.normalOS);
				float3 normalizedWorldNormal = normalize( ase_worldNormal );
				float smoothstepResult1451_g58603 = smoothstep( -0.75 , 7.99 , saturate( normalizedWorldNormal.y ));
				float4 temp_output_874_0_g58603 = ( ( saturate( ( ( _MossHeightWeight * v.ase_color.r ) + ( _MossHeightStrength * v.ase_color.r * appendResult952_g58603 ) ) ) * float4( normalizeResult881_g58603 , 0.0 ) ) - float4( ( smoothstepResult1451_g58603 * normalizeResult881_g58603 * saturate( v.ase_color.r ) * _MossHeightDepth ) , 0.0 ) );
				float temp_output_16_0_g58626 = _MossBlendStrength;
				float3 objToWorld286_g58619 = mul( GetObjectToWorldMatrix(), float4( float3( v.texcoord.xy ,  0.0 ), 1 ) ).xyz;
				float2 appendResult242_g58619 = (float2(objToWorld286_g58619.x , ( objToWorld286_g58619.z + objToWorld286_g58619.y )));
				float2 temp_output_491_0_g58619 = ( appendResult242_g58619 * 2.0 );
				float MossUVSpace1905_g58603 = _MossUVSpace;
				float2 lerpResult244_g58619 = lerp( v.texcoord.xy , temp_output_491_0_g58619 , ( MossUVSpace1905_g58603 + ( ( _CATEGORY_MOSSBLENDING + _SPACE_MOSSBLENDING ) * 0.0 ) ));
				float2 Offset235_g58619 = (_MossNoiseUV).zw;
				float2 temp_output_41_0_g58619 = ( ( lerpResult244_g58619 * (_MossNoiseUV).xy ) + Offset235_g58619 );
				float2 vertexToFrag70_g58619 = temp_output_41_0_g58619;
				float4 transform1505_g58603 = mul(GetObjectToWorldMatrix(),v.positionOS);
				float temp_output_79_0_g58626 = ( SAMPLE_TEXTURE2D_LOD( _MossNoiseMap, sampler_MossNoiseMap, vertexToFrag70_g58619, 0.0 ).r - ( ( (transform1505_g58603).w - _MossNoiseOffset ) / _MossNoiseLength ) );
				float temp_output_118_0_g58626 = saturate( temp_output_79_0_g58626 );
				float3 temp_cast_5 = (temp_output_118_0_g58626).xxx;
				float3 _NInfluence = float3(1,1,1);
				float localStochasticTiling2_g58666 = ( 0.0 );
				float3 objToWorld286_g58623 = mul( GetObjectToWorldMatrix(), float4( float3( v.texcoord.xy ,  0.0 ), 1 ) ).xyz;
				float2 appendResult242_g58623 = (float2(objToWorld286_g58623.x , ( objToWorld286_g58623.z + objToWorld286_g58623.y )));
				float2 temp_output_491_0_g58623 = ( appendResult242_g58623 * 2.0 );
				float2 lerpResult244_g58623 = lerp( v.texcoord.xy , temp_output_491_0_g58623 , _MossUVSpace);
				float2 Offset235_g58623 = (_MossUVs).zw;
				float2 temp_output_41_0_g58623 = ( ( lerpResult244_g58623 * (_MossUVs).xy ) + Offset235_g58623 );
				float2 vertexToFrag70_g58623 = temp_output_41_0_g58623;
				float2 temp_output_1903_0_g58603 = vertexToFrag70_g58623;
				float2 UV2_g58666 = temp_output_1903_0_g58603;
				float4 TexelSize2_g58666 = _MossNormalMap_TexelSize;
				float4 Offsets2_g58666 = float4( 0,0,0,0 );
				float2 Weights2_g58666 = float2( 0,0 );
				{
				UV2_g58666 = UV2_g58666 * TexelSize2_g58666.zw - 0.5;
				float2 f = frac( UV2_g58666 );
				UV2_g58666 -= f;
				...
				float4 c = float4( UV2_g58666.x - 0.5, UV2_g58666.x + 1.5, UV2_g58666.y - 0.5, UV2_g58666.y + 1.5 );
				float4 s = float4( xc.x + xc.y, xc.z + xc.w, yc.x + yc.y, yc.z + yc.w );
				float w0 = s.x / ( s.x + s.y );
				float w1 = s.z / ( s.z + s.w );
				Offsets2_g58666 = ( c + float4( xc.y, xc.w, yc.y, yc.w ) / s ) * TexelSize2_g58666.xyxy;
				Weights2_g58666 = float2( w0, w1 );
				}
				float4 Input_FetchOffsets197_g58665 = Offsets2_g58666;
				float2 Input_FetchWeights200_g58665 = Weights2_g58666;
				float2 break187_g58665 = Input_FetchWeights200_g58665;
				float4 lerpResult181_g58665 = lerp( SAMPLE_TEXTURE2D_LOD( _MossNormalMap, sampler_MossNormalMap, (Input_FetchOffsets197_g58665).yw, 0.0 ) , SAMPLE_TEXTURE2D_LOD( _MossNormalMap, sampler_MossNormalMap, (Input_FetchOffsets197_g58665).xw, 0.0 ) , break187_g58665.x);
				float4 lerpResult182_g58665 = lerp( SAMPLE_TEXTURE2D_LOD( _MossNormalMap, sampler_MossNormalMap, (Input_FetchOffsets197_g58665).yz, 0.0 ) , SAMPLE_TEXTURE2D_LOD( _MossNormalMap, sampler_MossNormalMap, (Input_FetchOffsets197_g58665).xz, 0.0 ) , break187_g58665.x);
				float4 lerpResult176_g58665 = lerp( lerpResult181_g58665 , lerpResult182_g58665 , break187_g58665.y);
				float4 Output_Fetch2D202_g58665 = lerpResult176_g58665;
				float3 unpack1541_g58603 = UnpackNormalScale( Output_Fetch2D202_g58665, _MossNormalStrength );
				unpack1541_g58603.z = lerp( 1, unpack1541_g58603.z, saturate(_MossNormalStrength) );
				float3 Map_Normal342_g58603 = unpack1541_g58603;
				float3 temp_output_80_0_g58626 = Map_Normal342_g58603;
				float3 lerpResult90_g58626 = lerp( _NInfluence , temp_output_80_0_g58626 , _MossBlendNormalInfluence);
				float dotResult127_g58626 = dot( temp_cast_5 , lerpResult90_g58626 );
				float3 temp_cast_10 = (saturate( ( ( mul( GetObjectToWorldMatrix(), float4( v.positionOS.xyz , 0.0 ) ).xyz.y - ( 1.0 - _MossBlendOffset ) ) + temp_output_79_0_g58626 + temp_output_79_0_g58626 ) )).xxx;
				float dotResult93_g58626 = dot( temp_cast_10 , lerpResult90_g58626 );
				float HeightMask111_g58626 = saturate(pow(max( (((dotResult127_g58626*dotResult93_g58626)*4)+(dotResult93_g58626*2)), 0 ),_MossBlendStrengthHeight));
				float temp_output_95_0_g58626 = ( temp_output_16_0_g58626 * HeightMask111_g58626 );
				float WORLD_NORMAL_Z136_g58626 = ( 1.0 * ase_worldNormal.y );
				float lerpResult110_g58626 = lerp( 0.0 , temp_output_95_0_g58626 , WORLD_NORMAL_Z136_g58626);
				float3 temp_cast_11 = (0.5).xxx;
				float WORLD_NORMAL_X144_g58626 = ( ( abs( ase_worldNormal ) - temp_cast_11 ).x + 1.3 );
				float lerpResult129_g58626 = lerp( 0.0 , temp_output_95_0_g58626 , WORLD_NORMAL_X144_g58626);
				float lerpResult170_g58626 = lerp( lerpResult110_g58626 , ( lerpResult110_g58626 + lerpResult129_g58626 ) , _MossBlendSideStrength);
				float Blend_TopDown220_g58603 = saturate( lerpResult170_g58626 );
				float temp_output_177_0_g58607 = Blend_TopDown220_g58603;
				float3 lerpResult197_g58607 = lerp( temp_output_1165_0_g58603 , temp_output_874_0_g58603.xyz , temp_output_177_0_g58607);
				float3 lerpResult1491_g58603 = lerp( temp_output_1165_0_g58603 , lerpResult197_g58607 , ( _MossHeightEnable + ( ( _CATEGORY_MOSSHEIGHT + _SPACE_MOSSHEIGHT ) * 0.0 ) ));
				float temp_output_1632_0_g58603 = ( _MossEnable + ( ( _CATEGORY_MOSS + _SPACE_MOSS ) * 0.0 ) );
				float3 lerpResult1468_g58603 = lerp( temp_output_1165_0_g58603 , lerpResult1491_g58603 , temp_output_1632_0_g58603);
				
				o.ase_texcoord9.xy = vertexToFrag70_g58623;
				o.ase_texcoord9.zw = vertexToFrag70_g58619;
				...
				float3 vertexValue = lerpResult1468_g58603;
						 ...
						 ) : SV_Target
			{
				...
				float3 temp_output_72_0_g58603 = temp_output_3_0_g58503;
				float localStochasticTiling2_g58617 = ( 0.0 );
				float2 vertexToFrag70_g58623 = IN.ase_texcoord9.xy;
				float2 temp_output_1903_0_g58603 = vertexToFrag70_g58623;
				float2 UV2_g58617 = temp_output_1903_0_g58603;
				float4 TexelSize2_g58617 = _MossColorMap_TexelSize;
				float4 Offsets2_g58617 = float4( 0,0,0,0 );
				float2 Weights2_g58617 = float2( 0,0 );
				{
				UV2_g58617 = UV2_g58617 * TexelSize2_g58617.zw - 0.5;
				float2 f = frac( UV2_g58617 );
				UV2_g58617 -= f;
				float4 xn = float4( 1.0, 2.0, 3.0, 4.0 ) - f.xxxx;
				float4 yn = float4( 1.0, 2.0, 3.0, 4.0 ) - f.yyyy;
				float4 xs = xn * xn * xn;
				...
				float4 xc = float4( xv.xyz, 6.0 - xv.x - xv.y - xv.z );
				float4 yc = float4( yv.xyz, 6.0 - yv.x - yv.y - yv.z );
				float4 c = float4( UV2_g58617.x - 0.5, UV2_g58617.x + 1.5, UV2_g58617.y - 0.5, UV2_g58617.y + 1.5 );
				float4 s = float4( xc.x + xc.y, xc.z + xc.w, yc.x + yc.y, yc.z + yc.w );
				float w0 = s.x / ( s.x + s.y );
				float w1 = s.z / ( s.z + s.w );
				Offsets2_g58617 = ( c + float4( xc.y, xc.w, yc.y, yc.w ) / s ) * TexelSize2_g58617.xyxy;
				Weights2_g58617 = float2( w0, w1 );
				}
				float4 Input_FetchOffsets197_g58618 = Offsets2_g58617;
				float2 Input_FetchWeights200_g58618 = Weights2_g58617;
				float2 break187_g58618 = Input_FetchWeights200_g58618;
				float4 lerpResult181_g58618 = lerp( SAMPLE_TEXTURE2D( _MossColorMap, sampler_MossColorMap, (Input_FetchOffsets197_g58618).yw ) , SAMPLE_TEXTURE2D( _MossColorMap, sampler_MossColorMap, (Input_FetchOffsets197_g58618).xw ) , break187_g58618.x);
				float4 lerpResult182_g58618 = lerp( SAMPLE_TEXTURE2D( _MossColorMap, sampler_MossColorMap, (Input_FetchOffsets197_g58618).yz ) , SAMPLE_TEXTURE2D( _MossColorMap, sampler_MossColorMap, (Input_FetchOffsets197_g58618).xz ) , break187_g58618.x);
				float4 lerpResult176_g58618 = lerp( lerpResult181_g58618 , lerpResult182_g58618 , break187_g58618.y);
				float4 Output_Fetch2D202_g58618 = lerpResult176_g58618;
				float3 temp_output_1914_0_g58603 = (Output_Fetch2D202_g58618).rgb;
				float3 temp_output_12_0_g58667 = temp_output_1914_0_g58603;
				float dotResult28_g58667 = dot( float3(0.2126729,0.7151522,0.072175) , temp_output_12_0_g58667 );
				float3 temp_cast_2 = (dotResult28_g58667).xxx;
				float temp_output_21_0_g58667 = ( 1.0 - _MossSaturation );
				float3 lerpResult31_g58667 = lerp( temp_cast_2 , temp_output_12_0_g58667 , temp_output_21_0_g58667);
				float3 linearToGamma1886_g58603 = FastLinearToSRGB( ( ( (_MossColorTop).rgb * lerpResult31_g58667 ) * lerpResult31_g58667 * _MossBrightnessTop ) );
				float temp_output_16_0_g58626 = _MossBlendStrength;
				float2 vertexToFrag70_g58619 = IN.ase_texcoord9.zw;
				float4 transform1505_g58603 = mul(GetObjectToWorldMatrix(),IN.ase_texcoord8);
				float temp_output_79_0_g58626 = ( SAMPLE_TEXTURE2D( _MossNoiseMap, sampler_MossNoiseMap, vertexToFrag70_g58619 ).r - ( ( (transform1505_g58603).w - _MossNoiseOffset ) / _MossNoiseLength ) );
				float temp_output_118_0_g58626 = saturate( temp_output_79_0_g58626 );
				float3 temp_cast_3 = (temp_output_118_0_g58626).xxx;
				float3 _NInfluence = float3(1,1,1);
				float localStochasticTiling2_g58666 = ( 0.0 );
				float2 UV2_g58666 = temp_output_1903_0_g58603;
				float4 TexelSize2_g58666 = _MossNormalMap_TexelSize;
				...
				float2 Input_FetchWeights200_g58665 = Weights2_g58666;
				float2 break187_g58665 = Input_FetchWeights200_g58665;
				float4 lerpResult181_g58665 = lerp( SAMPLE_TEXTURE2D( _MossNormalMap, sampler_MossNormalMap, (Input_FetchOffsets197_g58665).yw ) , SAMPLE_TEXTURE2D( _MossNormalMap, sampler_MossNormalMap, (Input_FetchOffsets197_g58665).xw ) , break187_g58665.x);
				float4 lerpResult182_g58665 = lerp( SAMPLE_TEXTURE2D( _MossNormalMap, sampler_MossNormalMap, (Input_FetchOffsets197_g58665).yz ) , SAMPLE_TEXTURE2D( _MossNormalMap, sampler_MossNormalMap, (Input_FetchOffsets197_g58665).xz ) , break187_g58665.x);
				float4 lerpResult176_g58665 = lerp( lerpResult181_g58665 , lerpResult182_g58665 , break187_g58665.y);
				float4 Output_Fetch2D202_g58665 = lerpResult176_g58665;
				float3 unpack1541_g58603 = UnpackNormalScale( Output_Fetch2D202_g58665, _MossNormalStrength );
				unpack1541_g58603.z = lerp( 1, unpack1541_g58603.z, saturate(_MossNormalStrength) );
				...
				float3 temp_output_80_0_g58626 = Map_Normal342_g58603;
				float3 lerpResult90_g58626 = lerp( _NInfluence , temp_output_80_0_g58626 , _MossBlendNormalInfluence);
				float dotResult127_g58626 = dot( temp_cast_3 , lerpResult90_g58626 );
				float3 temp_cast_7 = (saturate( ( ( mul( GetObjectToWorldMatrix(), float4( IN.ase_texcoord8.xyz , 0.0 ) ).xyz.y - ( 1.0 - _MossBlendOffset ) ) + temp_output_79_0_g58626 + temp_output_79_0_g58626 ) )).xxx;
				float dotResult93_g58626 = dot( temp_cast_7 , lerpResult90_g58626 );
				float HeightMask111_g58626 = saturate(pow(max( (((dotResult127_g58626*dotResult93_g58626)*4)+(dotResult93_g58626*2)), 0 ),_MossBlendStrengthHeight));
				float temp_output_95_0_g58626 = ( temp_output_16_0_g58626 * HeightMask111_g58626 );
				float WORLD_NORMAL_Z136_g58626 = ( 1.0 * WorldNormal.y );
				float lerpResult110_g58626 = lerp( 0.0 , temp_output_95_0_g58626 , WORLD_NORMAL_Z136_g58626);
				float3 temp_cast_8 = (0.5).xxx;
				float WORLD_NORMAL_X144_g58626 = ( ( abs( WorldNormal ) - temp_cast_8 ).x + 1.3 );
				float lerpResult129_g58626 = lerp( 0.0 , temp_output_95_0_g58626 , WORLD_NORMAL_X144_g58626);
				float lerpResult170_g58626 = lerp( lerpResult110_g58626 , ( lerpResult110_g58626 + lerpResult129_g58626 ) , _MossBlendSideStrength);
				float Blend_TopDown220_g58603 = saturate( lerpResult170_g58626 );
				float temp_output_177_0_g58668 = Blend_TopDown220_g58603;
				float3 lerpResult197_g58668 = lerp( temp_output_72_0_g58603 , linearToGamma1886_g58603 , temp_output_177_0_g58668);
				float temp_output_1632_0_g58603 = ( _MossEnable + ( ( _CATEGORY_MOSS + _SPACE_MOSS ) * 0.0 ) );
				float3 lerpResult1463_g58603 = lerp( temp_output_72_0_g58603 , lerpResult197_g58668 , temp_output_1632_0_g58603);
				...
				float3 temp_output_73_0_g58603 = unpack1891_g58503;
				float temp_output_177_0_g58612 = Blend_TopDown220_g58603;
				float3 lerpResult197_g58612 = lerp( temp_output_73_0_g58603 , Map_Normal342_g58603 , temp_output_177_0_g58612);
				float3 temp_output_1581_0_g58603 = BlendNormal( lerpResult197_g58612 , temp_output_73_0_g58603 );
				float3 lerpResult1464_g58603 = lerp( temp_output_73_0_g58603 , temp_output_1581_0_g58603 , temp_output_1632_0_g58603);
				...
				float temp_output_269_0_g58603 = ( _MetallicStrength * MASK_B1377_g58503 );
				float temp_output_177_0_g58672 = Blend_TopDown220_g58603;
				float lerpResult197_g58672 = lerp( temp_output_269_0_g58603 , _MossMetallicStrength , temp_output_177_0_g58672);
				float clampResult775_g58603 = clamp( lerpResult197_g58672 , 0.0 , 0.99 );
				float temp_output_776_0_g58603 = ( temp_output_269_0_g58603 + clampResult775_g58603 );
				float lerpResult1466_g58603 = lerp( temp_output_269_0_g58603 , temp_output_776_0_g58603 , temp_output_1632_0_g58603);
				...
				float temp_output_258_0_g58603 = saturate( lerpResult2636_g58503 );
				float temp_output_177_0_g58669 = Blend_TopDown220_g58603;
				float lerpResult197_g58669 = lerp( temp_output_258_0_g58603 , _MossSmoothnessStrength , temp_output_177_0_g58669);
				float temp_output_298_0_g58603 = saturate( lerpResult197_g58669 );
				float lerpResult1465_g58603 = lerp( temp_output_258_0_g58603 , temp_output_298_0_g58603 , temp_output_1632_0_g58603);
				...
				float temp_output_801_0_g58603 = temp_output_2730_0_g58503;
				float temp_output_1656_0_g58603 = saturate( ( 1.0 - _MossOcclusionStrengthAO ) );
				float temp_output_177_0_g58675 = Blend_TopDown220_g58603;
				float lerpResult197_g58675 = lerp( temp_output_801_0_g58603 , temp_output_1656_0_g58603 , temp_output_177_0_g58675);
				float lerpResult1467_g58603 = lerp( temp_output_801_0_g58603 , lerpResult197_g58675 , temp_output_1632_0_g58603);
				

				float3 BaseColor = lerpResult1463_g58603;
				float3 Normal = lerpResult1464_g58603;
				float3 Emission = 0;
				float3 Specular = 0.5;
				float Metallic = lerpResult1466_g58603;
				float Smoothness = lerpResult1465_g58603;
				float Occlusion = saturate( lerpResult1467_g58603 );
				float Alpha = 1;
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v )
			{
				...
				float4 temp_output_874_0_g58603 = ( ( saturate( ( ( _MossHeightWeight * v.ase_color.r ) + ( _MossHeightStrength * v.ase_color.r * appendResult952_g58603 ) ) ) * float4( normalizeResult881_g58603 , 0.0 ) ) - float4( ( smoothstepResult1451_g58603 * normalizeResult881_g58603 * saturate( v.ase_color.r ) * _MossHeightDepth ) , 0.0 ) );
				float temp_output_16_0_g58626 = _MossBlendStrength;
				float3 objToWorld286_g58619 = mul( GetObjectToWorldMatrix(), float4( float3( v.ase_texcoord.xy ,  0.0 ), 1 ) ).xyz;
				float2 appendResult242_g58619 = (float2(objToWorld286_g58619.x , ( objToWorld286_g58619.z + objToWorld286_g58619.y )));
				float2 temp_output_491_0_g58619 = ( appendResult242_g58619 * 2.0 );
				float MossUVSpace1905_g58603 = _MossUVSpace;
				float2 lerpResult244_g58619 = lerp( v.ase_texcoord.xy , temp_output_491_0_g58619 , ( MossUVSpace1905_g58603 + ( ( _CATEGORY_MOSSBLENDING + _SPACE_MOSSBLENDING ) * 0.0 ) ));
				float2 Offset235_g58619 = (_MossNoiseUV).zw;
				float2 temp_output_41_0_g58619 = ( ( lerpResult244_g58619 * (_MossNoiseUV).xy ) + Offset235_g58619 );
				float2 vertexToFrag70_g58619 = temp_output_41_0_g58619;
				float4 transform1505_g58603 = mul(GetObjectToWorldMatrix(),v.positionOS);
				...
				float3 _NInfluence = float3(1,1,1);
				float localStochasticTiling2_g58666 = ( 0.0 );
				float3 objToWorld286_g58623 = mul( GetObjectToWorldMatrix(), float4( float3( v.ase_texcoord.xy ,  0.0 ), 1 ) ).xyz;
				float2 appendResult242_g58623 = (float2(objToWorld286_g58623.x , ( objToWorld286_g58623.z + objToWorld286_g58623.y )));
				float2 temp_output_491_0_g58623 = ( appendResult242_g58623 * 2.0 );
				float2 lerpResult244_g58623 = lerp( v.ase_texcoord.xy , temp_output_491_0_g58623 , _MossUVSpace);
				float2 Offset235_g58623 = (_MossUVs).zw;
				float2 temp_output_41_0_g58623 = ( ( lerpResult244_g58623 * (_MossUVs).xy ) + Offset235_g58623 );
				float2 vertexToFrag70_g58623 = temp_output_41_0_g58623;
				float2 temp_output_1903_0_g58603 = vertexToFrag70_g58623;
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				float4 temp_output_874_0_g58603 = ( ( saturate( ( ( _MossHeightWeight * v.ase_color.r ) + ( _MossHeightStrength * v.ase_color.r * appendResult952_g58603 ) ) ) * float4( normalizeResult881_g58603 , 0.0 ) ) - float4( ( smoothstepResult1451_g58603 * normalizeResult881_g58603 * saturate( v.ase_color.r ) * _MossHeightDepth ) , 0.0 ) );
				float temp_output_16_0_g58626 = _MossBlendStrength;
				float3 objToWorld286_g58619 = mul( GetObjectToWorldMatrix(), float4( float3( v.texcoord0.xy ,  0.0 ), 1 ) ).xyz;
				float2 appendResult242_g58619 = (float2(objToWorld286_g58619.x , ( objToWorld286_g58619.z + objToWorld286_g58619.y )));
				float2 temp_output_491_0_g58619 = ( appendResult242_g58619 * 2.0 );
				float MossUVSpace1905_g58603 = _MossUVSpace;
				float2 lerpResult244_g58619 = lerp( v.texcoord0.xy , temp_output_491_0_g58619 , ( MossUVSpace1905_g58603 + ( ( _CATEGORY_MOSSBLENDING + _SPACE_MOSSBLENDING ) * 0.0 ) ));
				float2 Offset235_g58619 = (_MossNoiseUV).zw;
				float2 temp_output_41_0_g58619 = ( ( lerpResult244_g58619 * (_MossNoiseUV).xy ) + Offset235_g58619 );
				float2 vertexToFrag70_g58619 = temp_output_41_0_g58619;
				float4 transform1505_g58603 = mul(GetObjectToWorldMatrix(),v.positionOS);
				...
				float3 _NInfluence = float3(1,1,1);
				float localStochasticTiling2_g58666 = ( 0.0 );
				float3 objToWorld286_g58623 = mul( GetObjectToWorldMatrix(), float4( float3( v.texcoord0.xy ,  0.0 ), 1 ) ).xyz;
				float2 appendResult242_g58623 = (float2(objToWorld286_g58623.x , ( objToWorld286_g58623.z + objToWorld286_g58623.y )));
				float2 temp_output_491_0_g58623 = ( appendResult242_g58623 * 2.0 );
				float2 lerpResult244_g58623 = lerp( v.texcoord0.xy , temp_output_491_0_g58623 , _MossUVSpace);
				float2 Offset235_g58623 = (_MossUVs).zw;
				float2 temp_output_41_0_g58623 = ( ( lerpResult244_g58623 * (_MossUVs).xy ) + Offset235_g58623 );
				float2 vertexToFrag70_g58623 = temp_output_41_0_g58623;
				float2 temp_output_1903_0_g58603 = vertexToFrag70_g58623;
				...
				o.ase_texcoord6.xy = vertexToFrag70_g58623;
				o.ase_texcoord6.zw = vertexToFrag70_g58619;
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float3 temp_output_72_0_g58603 = temp_output_3_0_g58503;
				float localStochasticTiling2_g58617 = ( 0.0 );
				float2 vertexToFrag70_g58623 = IN.ase_texcoord6.xy;
				float2 temp_output_1903_0_g58603 = vertexToFrag70_g58623;
				float2 UV2_g58617 = temp_output_1903_0_g58603;
				float4 TexelSize2_g58617 = _MossColorMap_TexelSize;
				float4 Offsets2_g58617 = float4( 0,0,0,0 );
				...
				float3 linearToGamma1886_g58603 = FastLinearToSRGB( ( ( (_MossColorTop).rgb * lerpResult31_g58667 ) * lerpResult31_g58667 * _MossBrightnessTop ) );
				float temp_output_16_0_g58626 = _MossBlendStrength;
				float2 vertexToFrag70_g58619 = IN.ase_texcoord6.zw;
				float4 transform1505_g58603 = mul(GetObjectToWorldMatrix(),IN.ase_texcoord4);
				float temp_output_79_0_g58626 = ( SAMPLE_TEXTURE2D( _MossNoiseMap, sampler_MossNoiseMap, vertexToFrag70_g58619 ).r - ( ( (transform1505_g58603).w - _MossNoiseOffset ) / _MossNoiseLength ) );
				float temp_output_118_0_g58626 = saturate( temp_output_79_0_g58626 );
				float3 temp_cast_3 = (temp_output_118_0_g58626).xxx;
				float3 _NInfluence = float3(1,1,1);
				...
				float3 lerpResult90_g58626 = lerp( _NInfluence , temp_output_80_0_g58626 , _MossBlendNormalInfluence);
				float dotResult127_g58626 = dot( temp_cast_3 , lerpResult90_g58626 );
				float3 temp_cast_7 = (saturate( ( ( mul( GetObjectToWorldMatrix(), float4( IN.ase_texcoord4.xyz , 0.0 ) ).xyz.y - ( 1.0 - _MossBlendOffset ) ) + temp_output_79_0_g58626 + temp_output_79_0_g58626 ) )).xxx;
				float dotResult93_g58626 = dot( temp_cast_7 , lerpResult90_g58626 );
				float HeightMask111_g58626 = saturate(pow(max( (((dotResult127_g58626*dotResult93_g58626)*4)+(dotResult93_g58626*2)), 0 ),_MossBlendStrengthHeight));
				float temp_output_95_0_g58626 = ( temp_output_16_0_g58626 * HeightMask111_g58626 );
				float WORLD_NORMAL_Z136_g58626 = ( 1.0 * ase_worldNormal.y );
				float lerpResult110_g58626 = lerp( 0.0 , temp_output_95_0_g58626 , WORLD_NORMAL_Z136_g58626);
				float3 temp_cast_8 = (0.5).xxx;
				float WORLD_NORMAL_X144_g58626 = ( ( abs( ase_worldNormal ) - temp_cast_8 ).x + 1.3 );
				float lerpResult129_g58626 = lerp( 0.0 , temp_output_95_0_g58626 , WORLD_NORMAL_X144_g58626);
				float lerpResult170_g58626 = lerp( lerpResult110_g58626 , ( lerpResult110_g58626 + lerpResult129_g58626 ) , _MossBlendSideStrength);
				float Blend_TopDown220_g58603 = saturate( lerpResult170_g58626 );
				float temp_output_177_0_g58668 = Blend_TopDown220_g58603;
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				o.ase_texcoord4.xy = vertexToFrag70_g58623;
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float3 temp_output_72_0_g58603 = temp_output_3_0_g58503;
				float localStochasticTiling2_g58617 = ( 0.0 );
				float2 vertexToFrag70_g58623 = IN.ase_texcoord4.xy;
				float2 temp_output_1903_0_g58603 = vertexToFrag70_g58623;
				float2 UV2_g58617 = temp_output_1903_0_g58603;
				float4 TexelSize2_g58617 = _MossColorMap_TexelSize;
				float4 Offsets2_g58617 = float4( 0,0,0,0 );
				...
				float4 transform1505_g58603 = mul(GetObjectToWorldMatrix(),IN.ase_texcoord2);
				float temp_output_79_0_g58626 = ( SAMPLE_TEXTURE2D( _MossNoiseMap, sampler_MossNoiseMap, vertexToFrag70_g58619 ).r - ( ( (transform1505_g58603).w - _MossNoiseOffset ) / _MossNoiseLength ) );
				float temp_output_118_0_g58626 = saturate( temp_output_79_0_g58626 );
				float3 temp_cast_3 = (temp_output_118_0_g58626).xxx;
				float3 _NInfluence = float3(1,1,1);
				...
				float3 lerpResult90_g58626 = lerp( _NInfluence , temp_output_80_0_g58626 , _MossBlendNormalInfluence);
				float dotResult127_g58626 = dot( temp_cast_3 , lerpResult90_g58626 );
				float3 temp_cast_7 = (saturate( ( ( mul( GetObjectToWorldMatrix(), float4( IN.ase_texcoord2.xyz , 0.0 ) ).xyz.y - ( 1.0 - _MossBlendOffset ) ) + temp_output_79_0_g58626 + temp_output_79_0_g58626 ) )).xxx;
				float dotResult93_g58626 = dot( temp_cast_7 , lerpResult90_g58626 );
				float HeightMask111_g58626 = saturate(pow(max( (((dotResult127_g58626*dotResult93_g58626)*4)+(dotResult93_g58626*2)), 0 ),_MossBlendStrengthHeight));
				float temp_output_95_0_g58626 = ( temp_output_16_0_g58626 * HeightMask111_g58626 );
				float WORLD_NORMAL_Z136_g58626 = ( 1.0 * ase_worldNormal.y );
		...
		Pass
		{
						 ...
						 )
			{
				...
				float temp_output_16_0_g58626 = _MossBlendStrength;
				float2 vertexToFrag70_g58619 = IN.ase_texcoord6.zw;
				float4 transform1505_g58603 = mul(GetObjectToWorldMatrix(),IN.ase_texcoord5);
				float temp_output_79_0_g58626 = ( SAMPLE_TEXTURE2D( _MossNoiseMap, sampler_MossNoiseMap, vertexToFrag70_g58619 ).r - ( ( (transform1505_g58603).w - _MossNoiseOffset ) / _MossNoiseLength ) );
				float temp_output_118_0_g58626 = saturate( temp_output_79_0_g58626 );
				float3 temp_cast_4 = (temp_output_118_0_g58626).xxx;
				float3 _NInfluence = float3(1,1,1);
				float3 temp_output_80_0_g58626 = Map_Normal342_g58603;
				float3 lerpResult90_g58626 = lerp( _NInfluence , temp_output_80_0_g58626 , _MossBlendNormalInfluence);
				float dotResult127_g58626 = dot( temp_cast_4 , lerpResult90_g58626 );
				float3 temp_cast_7 = (saturate( ( ( mul( GetObjectToWorldMatrix(), float4( IN.ase_texcoord5.xyz , 0.0 ) ).xyz.y - ( 1.0 - _MossBlendOffset ) ) + temp_output_79_0_g58626 + temp_output_79_0_g58626 ) )).xxx;
				float dotResult93_g58626 = dot( temp_cast_7 , lerpResult90_g58626 );
				float HeightMask111_g58626 = saturate(pow(max( (((dotResult127_g58626*dotResult93_g58626)*4)+(dotResult93_g58626*2)), 0 ),_MossBlendStrengthHeight));
				float temp_output_95_0_g58626 = ( temp_output_16_0_g58626 * HeightMask111_g58626 );
				float WORLD_NORMAL_Z136_g58626 = ( 1.0 * WorldNormal.y );
...
/*ASEBEGIN
Version=19303
Node;AmplifyShaderEditor.FunctionNode;450;656,-640;Inherit;False;DESF Core Lit;1;;58503;e0cdd7758f4404849b063afff4596424;39,442,2,1557,0,1749,0,1556,0,2284,5,2283,5,2213,5,2481,5,2411,5,2399,5,2172,5,2282,5,3300,5,3301,5,3299,5,2132,5,3146,5,2311,5,3108,0,3119,0,3076,0,3408,0,3291,1,3290,1,3289,1,3287,1,96,0,2591,0,2559,0,1368,0,2125,0,2131,0,2028,0,1333,0,2126,0,1896,0,1415,0,830,0,2523,1;1;1234;FLOAT3;0,0,0;False;17;FLOAT3;38;FLOAT3;35;FLOAT;37;FLOAT3;1922;FLOAT;33;FLOAT;34;FLOAT;46;FLOAT;814;FLOAT;1660;FLOAT3;656;FLOAT3;657;FLOAT3;655;FLOAT3;1235;FLOAT3;2760;SAMPLERSTATE;1819;SAMPLERSTATE;1824;SAMPLERSTATE;1818
Node;AmplifyShaderEditor.FunctionNode;421;1056,-640;Inherit;False;DESF Module Moss;161;;58603;e79f0fabe78a15e44bdbbf0ff893d6a8;20,908,2,1833,1,1851,1,1708,1,1714,1,1715,1,1716,1,1710,1,1709,1,1713,1,1071,0,1074,0,1075,0,1246,0,1072,0,1073,0,1070,0,1449,0,1447,0,1199,1;6;72;FLOAT3;1,1,1;False;73;FLOAT3;1,1,1;False;269;FLOAT;0.1;False;258;FLOAT;0;False;801;FLOAT;0;False;1165;FLOAT3;0,0,0;False;7;FLOAT3;0;FLOAT3;68;FLOAT3;1181;FLOAT;270;FLOAT;259;FLOAT;813;FLOAT3;860
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;440;1374.904,-640;Float;False;False;-1;2;DE_ShaderGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;ExtraPrePass;0;0;ExtraPrePass;5;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;5;True;12;all;0;False;True;1;1;False;;0;False;;0;1;False;;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;0;False;False;0;Hidden/DE/Utility/Fallback;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;442;1374.904,-680.6909;Float;False;False;-1;2;DE_ShaderGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;ShadowCaster;0;2;ShadowCaster;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;5;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;False;False;True;False;False;False;False;0;False;;False;False;False;False;False;False;False;False;False;True;1;False;;True;3;False;;False;True;1;LightMode=ShadowCaster;False;False;0;Hidden/DE/Utility/Fallback;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;443;1374.904,-680.6909;Float;False;False;-1;2;DE_ShaderGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;DepthOnly;0;3;DepthOnly;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;5;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;False;False;True;False;False;False;False;0;False;;False;False;False;False;False;False;False;False;False;True;1;False;;False;False;True;1;LightMode=DepthOnly;False;False;0;Hidden/DE/Utility/Fallback;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;444;1374.904,-680.6909;Float;False;False;-1;2;DE_ShaderGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;Meta;0;4;Meta;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;5;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;2;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=Meta;False;False;0;Hidden/DE/Utility/Fallback;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;445;1374.904,-680.6909;Float;False;False;-1;2;DE_ShaderGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;Universal2D;0;5;Universal2D;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;5;True;12;all;0;False;True;1;1;False;;0;False;;1;1;False;;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;False;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;1;LightMode=Universal2D;False;False;0;Hidden/DE/Utility/Fallback;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;446;1374.904,-680.6909;Float;False;False;-1;2;DE_ShaderGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;DepthNormals;0;6;DepthNormals;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;5;True;12;all;0;False;True;1;1;False;;0;False;;0;1;False;;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;False;;True;3;False;;False;True;1;LightMode=DepthNormals;False;False;0;Hidden/DE/Utility/Fallback;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;447;1374.904,-680.6909;Float;False;False;-1;2;DE_ShaderGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;GBuffer;0;7;GBuffer;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;5;True;12;all;0;False;True;1;1;False;;0;False;;1;1;False;;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;1;LightMode=UniversalGBuffer;False;False;0;Hidden/DE/Utility/Fallback;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;448;1374.904,-680.6909;Float;False;False;-1;2;DE_ShaderGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;SceneSelectionPass;0;8;SceneSelectionPass;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;5;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;2;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=SceneSelectionPass;False;False;0;Hidden/DE/Utility/Fallback;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;449;1374.904,-680.6909;Float;False;False;-1;2;DE_ShaderGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;ScenePickingPass;0;9;ScenePickingPass;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;5;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=Picking;False;False;0;Hidden/DE/Utility/Fallback;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;441;1408,-640;Float;False;True;-1;2;DE_ShaderGUI;0;12;DE Environment/Stochastic/Surface Triplanar Moss;94348b07e5e8bab40bd6c8a1e3df54cd;True;Forward;0;1;Forward;21;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;True;True;0;True;_Cull;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;5;True;12;all;0;False;True;1;1;False;;0;False;;1;1;False;;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;1;LightMode=UniversalForward;False;False;0;Hidden/DE/Utility/Fallback;0;0;Standard;39;Workflow;1;0;Surface;0;0;  Refraction Model;0;0;  Blend;0;0;Two Sided;1;0;Fragment Normal Space,InvertActionOnDeselection;0;0;Forward Only;0;0;Transmission;0;0;  Transmission Shadow;0.5,True,_ASETransmissionShadow;0;Translucency;0;0;  Translucency Strength;1,True,_ASETranslucencyStrength;0;  Normal Distortion;0.5,True,_ASETranslucencyNormalDistortion;0;  Scattering;2,True,_ASETranslucencyScattering;0;  Direct;0.9,True,_ASETranslucencyScattering;0;  Ambient;0.1,True,_ASETranslucencyAmbient;0;  Shadow;0.5,True,_ASETranslucencyShadow;0;Cast Shadows;1;0;  Use Shadow Threshold;0;0;GPU Instancing;1;0;LOD CrossFade;1;0;Built-in Fog;1;0;_FinalColorxAlpha;0;0;Meta Pass;1;0;Override Baked GI;0;0;Extra Pre Pass;0;0;Tessellation;0;0;  Phong;0;0;  Strength;0.5,True,_TessellationPhong;0;  Type;0;0;  Tess;16,True,_TessellationStrength;0;  Min;10,True,_TessellationDistanceMin;0;  Max;25,True,_TessellationDistanceMax;0;  Edge Length;16,False,;0;  Max Displacement;25,False,;0;Write Depth;0;0;  Early Z;0;0;Vertex Position,InvertActionOnDeselection;1;0;Debug Display;0;0;Clear Coat;0;0;0;10;False;True;True;True;True;True;True;True;True;True;False;;True;0
WireConnection;421;72;450;38
WireConnection;421;73;450;35
WireConnection;421;269;450;37
WireConnection;421;258;450;33
WireConnection;421;801;450;34
WireConnection;441;0;421;0
WireConnection;441;1;421;68
WireConnection;441;3;421;270
WireConnection;441;4;421;259
WireConnection;441;5;421;813
WireConnection;441;8;421;860
ASEEND*/
//CHKSM=87EEF46ECB9B48FA5A3592D375C1E335B47FB37C