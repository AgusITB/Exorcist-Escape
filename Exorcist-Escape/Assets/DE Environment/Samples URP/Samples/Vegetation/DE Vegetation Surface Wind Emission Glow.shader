...
Shader "DE Environment/Vegetation/Surface Wind Emission Glow"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				float2 temp_output_1955_0_g57935 = (_MainUVs).xy;
				float2 temp_output_1953_0_g57935 = (_MainUVs).zw;
				float2 Offset235_g58525 = temp_output_1953_0_g57935;
				float2 temp_output_41_0_g58525 = ( ( localfloat2switchUVMode80_g58525 * temp_output_1955_0_g57935 ) + Offset235_g58525 );
						 ...
						 ) : SV_Target
			{
				...
				float3 temp_output_1923_0_g57935 = (_BaseColor).rgb;
				float2 vertexToFrag70_g58525 = IN.ase_texcoord8.xy;
				float2 UV213_g57935 = vertexToFrag70_g58525;
				float4 tex2DNode2048_g57935 = SAMPLE_TEXTURE2D( _MainTex, sampler_MainTex, UV213_g57935 );
				float3 ALBEDO_RGBA1381_g57935 = (tex2DNode2048_g57935).rgb;
				float3 temp_output_3_0_g57935 = ( temp_output_1923_0_g57935 * ALBEDO_RGBA1381_g57935 * _Brightness );
				float3 temp_output_83_0_g57894 = temp_output_3_0_g57935;
				...
				float4 NORMAL_RGBA1382_g57935 = SAMPLE_TEXTURE2D( _BumpMap, sampler_BumpMap, UV213_g57935 );
				float3 unpack1891_g57935 = UnpackNormalScale( NORMAL_RGBA1382_g57935, _NormalStrength );
				unpack1891_g57935.z = lerp( 1, unpack1891_g57935.z, saturate(_NormalStrength) );
				float3 temp_output_448_35 = unpack1891_g57935;
				float3 tanToWorld0 = float3( WorldTangent.x, WorldBiTangent.x, WorldNormal.x );
				float3 tanToWorld1 = float3( WorldTangent.y, WorldBiTangent.y, WorldNormal.y );
				float3 tanToWorld2 = float3( WorldTangent.z, WorldBiTangent.z, WorldNormal.z );
				float3 tanNormal190_g57894 = temp_output_448_35;
				...
				float4 tex2DNode2050_g57935 = SAMPLE_TEXTURE2D( _MaskMap, sampler_MaskMap, UV213_g57935 );
				float MASK_B1377_g57935 = tex2DNode2050_g57935.b;
				
				float MASK_G158_g57935 = tex2DNode2050_g57935.g;
				float temp_output_2651_0_g57935 = ( 1.0 - MASK_G158_g57935 );
				float lerpResult2650_g57935 = lerp( MASK_G158_g57935 , temp_output_2651_0_g57935 , _SmoothnessSource);
				float temp_output_2693_0_g57935 = ( lerpResult2650_g57935 * _SmoothnessStrength );
				float2 appendResult2645_g57935 = (float2(WorldViewDirection.xy));
				float3 appendResult2644_g57935 = (float3(appendResult2645_g57935 , ( WorldViewDirection.z / 1.06 )));
				float3 break2680_g57935 = unpack1891_g57935;
				float3 normalizeResult2641_g57935 = normalize( ( ( WorldTangent * break2680_g57935.x ) + ( WorldBiTangent * break2680_g57935.y ) + ( WorldNormal * break2680_g57935.z ) ) );
				float3 Normal_Per_Pixel2690_g57935 = normalizeResult2641_g57935;
				float fresnelNdotV2685_g57935 = dot( normalize( Normal_Per_Pixel2690_g57935 ), appendResult2644_g57935 );
				float fresnelNode2685_g57935 = ( 0.0 + ( 1.0 - _SmoothnessFresnelScale ) * pow( max( 1.0 - fresnelNdotV2685_g57935 , 0.0001 ), _SmoothnessFresnelPower ) );
				float lerpResult2636_g57935 = lerp( temp_output_2693_0_g57935 , ( temp_output_2693_0_g57935 - fresnelNode2685_g57935 ) , _SmoothnessFresnelEnable);
				
				float MASK_R1378_g57935 = tex2DNode2050_g57935.r;
				float lerpResult3415_g57935 = lerp( 1.0 , MASK_R1378_g57935 , _OcclusionStrengthAO);
				float lerpResult3414_g57935 = lerp( 1.0 , IN.ase_color.a , _OcclusionStrengthAO);
				float lerpResult2709_g57935 = lerp( lerpResult3415_g57935 , lerpResult3414_g57935 , _OcclusionSource);
				float temp_output_2730_0_g57935 = saturate( lerpResult2709_g57935 );
				

				float3 BaseColor = lerpResult384_g57894;
				float3 Normal = temp_output_448_35;
				float3 Emission = lerpResult65_g57894;
				float3 Specular = 0.5;
				float Metallic = ( _MetallicStrength * MASK_B1377_g57935 );
				float Smoothness = saturate( lerpResult2636_g57935 );
				float Occlusion = temp_output_2730_0_g57935;
				float Alpha = 1;
...
/*ASEBEGIN
Version=19303
Node;AmplifyShaderEditor.FunctionNode;418;1104,-704;Inherit;False;DESF Module Emission;161;;57894;f6260db0b43d4504b8a093f7f73e5a28;15,634,0,341,1,362,1,575,0,616,0,614,1,608,1,611,1,586,0,197,1,376,0,258,1,543,0,596,0,597,0;3;83;FLOAT3;0,0,0;False;192;FLOAT3;0,0,1;False;613;SAMPLERSTATE;;False;2;FLOAT3;96;FLOAT3;0
Node;AmplifyShaderEditor.FunctionNode;399;448,-640;Inherit;False;DESF Weather Wind;230;;57932;b135a554f7e4d0b41bba02c61b34ae74;5,3133,0,2371,0,2432,0,3138,0,3139,0;0;1;FLOAT3;2190
