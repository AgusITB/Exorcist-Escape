...
Shader "DE Environment/Vegetation/Billboard Cross Wind"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
			...
			float2 float2switchUVMode80_g57769( float m_switch, float2 m_UV0, float2 m_UV1, float2 m_UV2, float2 m_UV3 )
			{
				if(m_switch ==0)
					return m_UV0;
				else if(m_switch ==1)
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				float m_switch80_g57769 = _UVMode;
				float2 m_UV080_g57769 = v.texcoord.xy;
				float2 m_UV180_g57769 = v.texcoord1.xy;
				float2 m_UV280_g57769 = v.texcoord2.xy;
				float2 m_UV380_g57769 = v.ase_texcoord3.xy;
				float2 localfloat2switchUVMode80_g57769 = float2switchUVMode80_g57769( m_switch80_g57769 , m_UV080_g57769 , m_UV180_g57769 , m_UV280_g57769 , m_UV380_g57769 );
				float2 Offset235_g57769 = (_MainUVs).zw;
				float2 temp_output_41_0_g57769 = ( ( localfloat2switchUVMode80_g57769 * (_MainUVs).xy ) + Offset235_g57769 );
				float2 vertexToFrag70_g57769 = temp_output_41_0_g57769;
				o.ase_texcoord8.xy = vertexToFrag70_g57769;
				...
				float3 vertexValue = localVetexOffsetSRP26_g57777;
						...
						, bool ase_vface : SV_IsFrontFace ) : SV_Target
			{
				...
				float2 vertexToFrag70_g57769 = IN.ase_texcoord8.xy;
				float4 tex2DNode3_g57759 = SAMPLE_TEXTURE2D( _MainTex, sampler_MainTex, vertexToFrag70_g57769 );
				float3 temp_output_28_0_g57759 = ( (_BaseColor).rgb * (tex2DNode3_g57759).rgb * _Brightness );
				
				float3 unpack748_g57759 = UnpackNormalScale( SAMPLE_TEXTURE2D( _BumpMap, sampler_BumpMap, vertexToFrag70_g57769 ), _NormalStrength );
				...
				float3 BaseColor = temp_output_28_0_g57759;
				float3 Normal = switchResult58_g57773;
				float3 Emission = 0;
				float3 Specular = 0.5;
				float Metallic = _MetallicStrength;
				float Smoothness = saturate( lerpResult895_g57759 );
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v )
			{
				...
				float m_switch80_g57769 = _UVMode;
				float2 m_UV080_g57769 = v.ase_texcoord.xy;
				float2 m_UV180_g57769 = v.ase_texcoord1.xy;
				float2 m_UV280_g57769 = v.ase_texcoord2.xy;
				float2 m_UV380_g57769 = v.ase_texcoord3.xy;
				float2 localfloat2switchUVMode80_g57769 = float2switchUVMode80_g57769( m_switch80_g57769 , m_UV080_g57769 , m_UV180_g57769 , m_UV280_g57769 , m_UV380_g57769 );
				float2 Offset235_g57769 = (_MainUVs).zw;
				float2 temp_output_41_0_g57769 = ( ( localfloat2switchUVMode80_g57769 * (_MainUVs).xy ) + Offset235_g57769 );
				float2 vertexToFrag70_g57769 = temp_output_41_0_g57769;
				o.ase_texcoord3.xy = vertexToFrag70_g57769;
						 ...
						 ) : SV_TARGET
			{
				...
				float2 vertexToFrag70_g57769 = IN.ase_texcoord3.xy;
				float4 tex2DNode3_g57759 = SAMPLE_TEXTURE2D( _MainTex, sampler_MainTex, vertexToFrag70_g57769 );
				float temp_output_22_0_g57760 = tex2DNode3_g57759.a;
				float temp_output_22_0_g57762 = temp_output_22_0_g57760;
				float3 temp_output_95_0_g57764 = cross( ddy( WorldPosition ) , ddx( WorldPosition ) );
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				float m_switch80_g57769 = _UVMode;
				float2 m_UV080_g57769 = v.texcoord0.xy;
				float2 m_UV180_g57769 = v.texcoord1.xy;
				float2 m_UV280_g57769 = v.texcoord2.xy;
				float2 m_UV380_g57769 = v.ase_texcoord3.xy;
				float2 localfloat2switchUVMode80_g57769 = float2switchUVMode80_g57769( m_switch80_g57769 , m_UV080_g57769 , m_UV180_g57769 , m_UV280_g57769 , m_UV380_g57769 );
				...
				float2 temp_output_41_0_g57769 = ( ( localfloat2switchUVMode80_g57769 * (_MainUVs).xy ) + Offset235_g57769 );
				float2 vertexToFrag70_g57769 = temp_output_41_0_g57769;
				o.ase_texcoord4.xy = vertexToFrag70_g57769;
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float2 vertexToFrag70_g57769 = IN.ase_texcoord4.xy;
				float4 tex2DNode3_g57759 = SAMPLE_TEXTURE2D( _MainTex, sampler_MainTex, vertexToFrag70_g57769 );
				float3 temp_output_28_0_g57759 = ( (_BaseColor).rgb * (tex2DNode3_g57759).rgb * _Brightness );
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				float2 temp_output_41_0_g57769 = ( ( localfloat2switchUVMode80_g57769 * (_MainUVs).xy ) + Offset235_g57769 );
				float2 vertexToFrag70_g57769 = temp_output_41_0_g57769;
				o.ase_texcoord2.xy = vertexToFrag70_g57769;
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float2 vertexToFrag70_g57769 = IN.ase_texcoord2.xy;
				float4 tex2DNode3_g57759 = SAMPLE_TEXTURE2D( _MainTex, sampler_MainTex, vertexToFrag70_g57769 );
				float3 temp_output_28_0_g57759 = ( (_BaseColor).rgb * (tex2DNode3_g57759).rgb * _Brightness );
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				float2 temp_output_41_0_g57769 = ( ( localfloat2switchUVMode80_g57769 * (_MainUVs).xy ) + Offset235_g57769 );
				float2 vertexToFrag70_g57769 = temp_output_41_0_g57769;
				o.ase_texcoord5.xy = vertexToFrag70_g57769;
						...
						, bool ase_vface : SV_IsFrontFace )
			{
				...
				float2 vertexToFrag70_g57769 = IN.ase_texcoord5.xy;
				float3 unpack748_g57759 = UnpackNormalScale( SAMPLE_TEXTURE2D( _BumpMap, sampler_BumpMap, vertexToFrag70_g57769 ), _NormalStrength );
				unpack748_g57759.z = lerp( 1, unpack748_g57759.z, saturate(_NormalStrength) );
				float3 temp_output_24_0_g57773 = unpack748_g57759;
				float temp_output_50_0_g57773 = _DoubleSidedNormalMode;
		...
		Pass
		{
			...
			VertexOutput VertexFunction(VertexInput v  )
			{
				...
				float2 temp_output_41_0_g57769 = ( ( localfloat2switchUVMode80_g57769 * (_MainUVs).xy ) + Offset235_g57769 );
				float2 vertexToFrag70_g57769 = temp_output_41_0_g57769;
				o.ase_texcoord.xy = vertexToFrag70_g57769;
			...
			half4 frag(VertexOutput IN ) : SV_TARGET
			{
				...
				float2 vertexToFrag70_g57769 = IN.ase_texcoord.xy;
				float4 tex2DNode3_g57759 = SAMPLE_TEXTURE2D( _MainTex, sampler_MainTex, vertexToFrag70_g57769 );
				float temp_output_22_0_g57760 = tex2DNode3_g57759.a;
				float temp_output_22_0_g57762 = temp_output_22_0_g57760;
...
/*ASEBEGIN
Version=19303
Node;AmplifyShaderEditor.FunctionNode;451;-576,384;Inherit;False;DESF Weather Wind;68;;57756;b135a554f7e4d0b41bba02c61b34ae74;5,3133,2,2371,2,2432,2,3138,0,3139,0;0;1;FLOAT3;2190
Node;AmplifyShaderEditor.FunctionNode;465;-320,384;Inherit;False;DESF Core Billboard;1;;57759;e3fce2294f3bde941a48e407ffdf732f;12,139,2,1010,0,999,0,998,0,1012,1,1002,1,1003,1,1007,1,865,0,69,0,885,1,969,0;1;457;FLOAT3;0,0,0;False;15;FLOAT3;0;FLOAT3;556;FLOAT;56;FLOAT3;770;FLOAT;50;FLOAT;57;FLOAT;49;FLOAT;351;FLOAT;649;FLOAT;996;FLOAT3;458;FLOAT3;967;FLOAT4;968;SAMPLERSTATE;703;SAMPLERSTATE;708
Node;AmplifyShaderEditor.IntNode;474;128,304;Inherit;False;Property;_Cull;Render Face;0;2;[HideInInspector];[Enum];Create;False;0;0;1;Front,2,Back,1,Both,0;True;0;False;2;2;False;0;1;INT;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;488;131.95,384;Float;False;False;-1;2;DE_ShaderGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;ExtraPrePass;0;0;ExtraPrePass;5;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;5;True;12;all;0;False;True;1;1;False;;0;False;;0;1;False;;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;0;False;False;0;Hidden/DE/Utility/Fallback;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;490;131.95,341.8214;Float;False;False;-1;2;DE_ShaderGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;ShadowCaster;0;2;ShadowCaster;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;5;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;False;False;True;False;False;False;False;0;False;;False;False;False;False;False;False;False;False;False;True;1;False;;True;3;False;;False;True;1;LightMode=ShadowCaster;False;False;0;Hidden/DE/Utility/Fallback;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;491;131.95,341.8214;Float;False;False;-1;2;DE_ShaderGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;DepthOnly;0;3;DepthOnly;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;5;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;False;False;True;False;False;False;False;0;False;;False;False;False;False;False;False;False;False;False;True;1;False;;False;False;True;1;LightMode=DepthOnly;False;False;0;Hidden/DE/Utility/Fallback;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;492;131.95,341.8214;Float;False;False;-1;2;DE_ShaderGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;Meta;0;4;Meta;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;5;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;2;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=Meta;False;False;0;Hidden/DE/Utility/Fallback;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;493;131.95,341.8214;Float;False;False;-1;2;DE_ShaderGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;Universal2D;0;5;Universal2D;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;5;True;12;all;0;False;True;1;1;False;;0;False;;1;1;False;;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;False;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;1;LightMode=Universal2D;False;False;0;Hidden/DE/Utility/Fallback;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;494;131.95,341.8214;Float;False;False;-1;2;DE_ShaderGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;DepthNormals;0;6;DepthNormals;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;5;True;12;all;0;False;True;1;1;False;;0;False;;0;1;False;;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;False;;True;3;False;;False;True;1;LightMode=DepthNormals;False;False;0;Hidden/DE/Utility/Fallback;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;495;131.95,341.8214;Float;False;False;-1;2;DE_ShaderGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;GBuffer;0;7;GBuffer;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;5;True;12;all;0;False;True;1;1;False;;0;False;;1;1;False;;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;1;LightMode=UniversalGBuffer;False;False;0;Hidden/DE/Utility/Fallback;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;496;131.95,341.8214;Float;False;False;-1;2;DE_ShaderGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;SceneSelectionPass;0;8;SceneSelectionPass;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;5;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;2;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=SceneSelectionPass;False;False;0;Hidden/DE/Utility/Fallback;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;497;131.95,341.8214;Float;False;False;-1;2;DE_ShaderGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;ScenePickingPass;0;9;ScenePickingPass;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;5;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=Picking;False;False;0;Hidden/DE/Utility/Fallback;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;489;128,384;Float;False;True;-1;2;DE_ShaderGUI;0;12;DE Environment/Vegetation/Billboard Cross Wind;94348b07e5e8bab40bd6c8a1e3df54cd;True;Forward;0;1;Forward;21;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;True;True;0;True;_Cull;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;5;True;12;all;0;False;True;1;1;False;;0;False;;1;1;False;;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;1;LightMode=UniversalForward;False;False;0;Hidden/DE/Utility/Fallback;0;0;Standard;39;Workflow;1;0;Surface;0;0;  Refraction Model;0;0;  Blend;0;0;Two Sided;1;0;Fragment Normal Space,InvertActionOnDeselection;0;0;Forward Only;0;0;Transmission;0;0;  Transmission Shadow;0.5,True,_ASETransmissionShadow;0;Translucency;0;0;  Translucency Strength;1,True,_ASETranslucencyStrength;0;  Normal Distortion;0.5,True,_ASETranslucencyNormalDistortion;0;  Scattering;2,True,_ASETranslucencyScattering;0;  Direct;0.9,True,_ASETranslucencyScattering;0;  Ambient;0.1,True,_ASETranslucencyAmbient;0;  Shadow;0.5,True,_ASETranslucencyShadow;0;Cast Shadows;1;0;  Use Shadow Threshold;1;638177032356971684;GPU Instancing;1;0;LOD CrossFade;1;0;Built-in Fog;1;0;_FinalColorxAlpha;0;0;Meta Pass;1;0;Override Baked GI;0;0;Extra Pre Pass;0;0;Tessellation;0;0;  Phong;0;0;  Strength;0.5,True,_TessellationPhong;0;  Type;0;0;  Tess;16,True,_TessellationStrength;0;  Min;10,True,_TessellationDistanceMin;0;  Max;25,True,_TessellationDistanceMax;0;  Edge Length;16,False,;0;  Max Displacement;25,False,;0;Write Depth;0;0;  Early Z;0;0;Vertex Position,InvertActionOnDeselection;1;0;Debug Display;0;0;Clear Coat;0;0;0;10;False;True;True;True;True;True;True;True;True;True;False;;True;0
WireConnection;465;457;451;2190
WireConnection;489;0;465;0
WireConnection;489;1;465;556
WireConnection;489;3;465;56
WireConnection;489;4;465;50
WireConnection;489;5;465;57
WireConnection;489;6;465;49
WireConnection;489;7;465;351
WireConnection;489;16;465;649
WireConnection;489;8;465;458
WireConnection;489;10;465;967
WireConnection;489;30;465;968
ASEEND*/
//CHKSM=C465280959D0E893539A6A5924085706692C3EF6