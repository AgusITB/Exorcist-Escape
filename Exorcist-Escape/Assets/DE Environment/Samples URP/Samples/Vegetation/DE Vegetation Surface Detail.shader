...
Shader "DE Environment/Vegetation/Surface Detail"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
			...
			float2 float2switchUVMode80_g57833( float m_switch, float2 m_UV0, float2 m_UV1, float2 m_UV2, float2 m_UV3 )
			{
				if(m_switch ==0)
					return m_UV0;
				else if(m_switch ==1)
			...
			float2 float2switchUVMode80_g57836( float m_switch, float2 m_UV0, float2 m_UV1, float2 m_UV2, float2 m_UV3 )
			{
				if(m_switch ==0)
					return m_UV0;
				else if(m_switch ==1)
			...
			float MaskVCSwitch44_g57849( float m_switch, float m_Off, float m_R, float m_G, float m_B, float m_A )
			{
				if(m_switch ==0)
					return m_Off;
				else if(m_switch ==1)
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				float2 temp_output_1955_0_g57888 = (_MainUVs).xy;
				float2 temp_output_1953_0_g57888 = (_MainUVs).zw;
				float2 Offset235_g58525 = temp_output_1953_0_g57888;
				float2 temp_output_41_0_g58525 = ( ( localfloat2switchUVMode80_g58525 * temp_output_1955_0_g57888 ) + Offset235_g58525 );
				float2 vertexToFrag70_g58525 = temp_output_41_0_g58525;
				o.ase_texcoord8.xy = vertexToFrag70_g58525;
				float temp_output_6_0_g57833 = _DetailUVRotation;
				float temp_output_200_0_g57833 = radians( temp_output_6_0_g57833 );
				float temp_output_13_0_g57833 = cos( temp_output_200_0_g57833 );
				float m_switch80_g57833 = _DetailUVMode;
				float2 m_UV080_g57833 = v.texcoord.xy;
				float2 m_UV180_g57833 = v.texcoord1.xy;
				float2 m_UV280_g57833 = v.texcoord2.xy;
				float2 m_UV380_g57833 = v.ase_texcoord3.xy;
				float2 localfloat2switchUVMode80_g57833 = float2switchUVMode80_g57833( m_switch80_g57833 , m_UV080_g57833 , m_UV180_g57833 , m_UV280_g57833 , m_UV380_g57833 );
				float2 temp_output_9_0_g57833 = float2( 0.5,0.5 );
				float2 break39_g57833 = ( localfloat2switchUVMode80_g57833 - temp_output_9_0_g57833 );
				float temp_output_14_0_g57833 = sin( temp_output_200_0_g57833 );
				float2 appendResult36_g57833 = (float2(( ( temp_output_13_0_g57833 * break39_g57833.x ) + ( temp_output_14_0_g57833 * break39_g57833.y ) ) , ( ( temp_output_13_0_g57833 * break39_g57833.y ) - ( temp_output_14_0_g57833 * break39_g57833.x ) )));
				float2 Offset235_g57833 = (_DetailUVs).zw;
				float2 temp_output_41_0_g57833 = ( ( ( appendResult36_g57833 * ( (_DetailUVs).xy / 1.0 ) ) + temp_output_9_0_g57833 ) + Offset235_g57833 );
				float2 _ConstantAnchor = float2(0.5,0.5);
				float2 vertexToFrag70_g57833 = ( temp_output_41_0_g57833 - ( ( ( (_DetailUVs).xy / 1.0 ) * _ConstantAnchor ) - _ConstantAnchor ) );
				o.ase_texcoord8.zw = vertexToFrag70_g57833;
				float temp_output_6_0_g57836 = _DetailMaskUVRotation;
				float temp_output_200_0_g57836 = radians( temp_output_6_0_g57836 );
				float temp_output_13_0_g57836 = cos( temp_output_200_0_g57836 );
				float DetailUVMode1060_g57819 = _DetailUVMode;
				float m_switch80_g57836 = DetailUVMode1060_g57819;
				float2 m_UV080_g57836 = v.texcoord.xy;
				float2 m_UV180_g57836 = v.texcoord1.xy;
				float2 m_UV280_g57836 = v.texcoord2.xy;
				float2 m_UV380_g57836 = v.ase_texcoord3.xy;
				float2 localfloat2switchUVMode80_g57836 = float2switchUVMode80_g57836( m_switch80_g57836 , m_UV080_g57836 , m_UV180_g57836 , m_UV280_g57836 , m_UV380_g57836 );
				float2 temp_output_9_0_g57836 = float2( 0.5,0.5 );
				float2 break39_g57836 = ( localfloat2switchUVMode80_g57836 - temp_output_9_0_g57836 );
				float temp_output_14_0_g57836 = sin( temp_output_200_0_g57836 );
				float2 appendResult36_g57836 = (float2(( ( temp_output_13_0_g57836 * break39_g57836.x ) + ( temp_output_14_0_g57836 * break39_g57836.y ) ) , ( ( temp_output_13_0_g57836 * break39_g57836.y ) - ( temp_output_14_0_g57836 * break39_g57836.x ) )));
				float2 Offset235_g57836 = (_DetailMaskUVs).zw;
				float2 temp_output_41_0_g57836 = ( ( ( appendResult36_g57836 * ( (_DetailMaskUVs).xy / 1.0 ) ) + temp_output_9_0_g57836 ) + Offset235_g57836 );
				float2 vertexToFrag70_g57836 = ( temp_output_41_0_g57836 - ( ( ( (_DetailMaskUVs).xy / 1.0 ) * _ConstantAnchor ) - _ConstantAnchor ) );
				o.ase_texcoord9.xy = vertexToFrag70_g57836;
						 ...
						 ) : SV_Target
			{
				...
				float3 temp_output_1923_0_g57888 = (_BaseColor).rgb;
				float2 vertexToFrag70_g58525 = IN.ase_texcoord8.xy;
				float2 UV213_g57888 = vertexToFrag70_g58525;
				float4 tex2DNode2048_g57888 = SAMPLE_TEXTURE2D( _MainTex, sampler_MainTex, UV213_g57888 );
				float3 ALBEDO_RGBA1381_g57888 = (tex2DNode2048_g57888).rgb;
				float3 temp_output_3_0_g57888 = ( temp_output_1923_0_g57888 * ALBEDO_RGBA1381_g57888 * _Brightness );
				float3 temp_output_39_0_g57819 = temp_output_3_0_g57888;
				float localStochasticTiling159_g57824 = ( 0.0 );
				float2 vertexToFrag70_g57833 = IN.ase_texcoord8.zw;
				float2 temp_output_1334_0_g57819 = vertexToFrag70_g57833;
				...
				float2 vertexToFrag70_g57836 = IN.ase_texcoord9.xy;
				float2 temp_output_1339_0_g57819 = vertexToFrag70_g57836;
				...
				float temp_output_15_0_g57847 = ( 1.0 - lerpResult997_g57819 );
				float temp_output_26_0_g57847 = _DetailMaskBlendStrength;
				float temp_output_24_0_g57847 = _DetailMaskBlendHardness;
				float saferPower2_g57847 = abs( max( saturate( (0.0 + (temp_output_15_0_g57847 - ( 1.0 - temp_output_26_0_g57847 )) * (temp_output_24_0_g57847 - 0.0) / (1.0 - ( 1.0 - temp_output_26_0_g57847 ))) ) , 0.0 ) );
				float temp_output_22_0_g57847 = _DetailMaskBlendFalloff;
				float Blend_DetailMask986_g57819 = saturate( pow( saferPower2_g57847 , ( 1.0 - temp_output_22_0_g57847 ) ) );
				...
				float m_switch44_g57849 = (float)_DetailBlendVertexColor;
				float m_Off44_g57849 = 1.0;
				float dotResult58_g57849 = dot( IN.ase_color.g , IN.ase_color.g );
				float dotResult61_g57849 = dot( IN.ase_color.b , IN.ase_color.b );
				float m_R44_g57849 = ( dotResult58_g57849 + dotResult61_g57849 );
				float dotResult57_g57849 = dot( IN.ase_color.r , IN.ase_color.r );
				float m_G44_g57849 = ( dotResult57_g57849 + dotResult58_g57849 );
				float m_B44_g57849 = ( dotResult57_g57849 + dotResult61_g57849 );
				float m_A44_g57849 = IN.ase_color.a;
				float localMaskVCSwitch44_g57849 = MaskVCSwitch44_g57849( m_switch44_g57849 , m_Off44_g57849 , m_R44_g57849 , m_G44_g57849 , m_B44_g57849 , m_A44_g57849 );
				float clampResult54_g57849 = clamp( ( ( localMaskVCSwitch44_g57849 * _DetailBlendHeight ) / _DetailBlendSmooth ) , 0.0 , 1.0 );
				float Blend647_g57819 = saturate( ( ( ( ( lerpResult1105_g57819 - 0.5 ) * ( ( 1.0 - _DetailBlendStrength ) - 0.9 ) ) / ( 1.0 - _DetailBlendSmooth ) ) + ( 1.0 - clampResult54_g57849 ) ) );
				...
				float3 temp_output_1173_0_g57819 = ( ( BaseColor_Detail255_g57819 * Blend647_g57819 ) + appendResult1174_g57819 );
				float temp_output_20_0_g57850 = _DetailBlendHeightMin;
				float temp_output_21_0_g57850 = _DetailBlendHeightMax;
				float3 worldToObj1466_g57819 = mul( GetWorldToObjectMatrix(), float4( WorldPosition, 1 ) ).xyz;
				float3 WorldPosition1436_g57819 = worldToObj1466_g57819;
				float smoothstepResult25_g57850 = smoothstep( temp_output_20_0_g57850 , temp_output_21_0_g57850 , WorldPosition1436_g57819.y);
				float DetailBlendHeight1440_g57819 = smoothstepResult25_g57850;
				float3 lerpResult1438_g57819 = lerp( temp_output_1173_0_g57819 , temp_output_39_0_g57819 , DetailBlendHeight1440_g57819);
				float3 lerpResult1457_g57819 = lerp( temp_output_1173_0_g57819 , lerpResult1438_g57819 , _DetailBlendEnableAltitudeMask);
				float3 temp_output_1180_0_g57819 = ( temp_output_39_0_g57819 * lerpResult1457_g57819 );
				...
				float4 NORMAL_RGBA1382_g57888 = SAMPLE_TEXTURE2D( _BumpMap, sampler_BumpMap, UV213_g57888 );
				float3 unpack1891_g57888 = UnpackNormalScale( NORMAL_RGBA1382_g57888, _NormalStrength );
				unpack1891_g57888.z = lerp( 1, unpack1891_g57888.z, saturate(_NormalStrength) );
				float3 temp_output_38_0_g57819 = unpack1891_g57888;
				...
				float4 tex2DNode2050_g57888 = SAMPLE_TEXTURE2D( _MaskMap, sampler_MaskMap, UV213_g57888 );
				float MASK_B1377_g57888 = tex2DNode2050_g57888.b;
				
				float MASK_G158_g57888 = tex2DNode2050_g57888.g;
				float temp_output_2651_0_g57888 = ( 1.0 - MASK_G158_g57888 );
				float lerpResult2650_g57888 = lerp( MASK_G158_g57888 , temp_output_2651_0_g57888 , _SmoothnessSource);
				float temp_output_2693_0_g57888 = ( lerpResult2650_g57888 * _SmoothnessStrength );
				float2 appendResult2645_g57888 = (float2(WorldViewDirection.xy));
				float3 appendResult2644_g57888 = (float3(appendResult2645_g57888 , ( WorldViewDirection.z / 1.06 )));
				float3 break2680_g57888 = unpack1891_g57888;
				float3 normalizeResult2641_g57888 = normalize( ( ( WorldTangent * break2680_g57888.x ) + ( WorldBiTangent * break2680_g57888.y ) + ( WorldNormal * break2680_g57888.z ) ) );
				float3 Normal_Per_Pixel2690_g57888 = normalizeResult2641_g57888;
				float fresnelNdotV2685_g57888 = dot( normalize( Normal_Per_Pixel2690_g57888 ), appendResult2644_g57888 );
				float fresnelNode2685_g57888 = ( 0.0 + ( 1.0 - _SmoothnessFresnelScale ) * pow( max( 1.0 - fresnelNdotV2685_g57888 , 0.0001 ), _SmoothnessFresnelPower ) );
				float lerpResult2636_g57888 = lerp( temp_output_2693_0_g57888 , ( temp_output_2693_0_g57888 - fresnelNode2685_g57888 ) , _SmoothnessFresnelEnable);
				
				float MASK_R1378_g57888 = tex2DNode2050_g57888.r;
				float lerpResult3415_g57888 = lerp( 1.0 , MASK_R1378_g57888 , _OcclusionStrengthAO);
				float lerpResult3414_g57888 = lerp( 1.0 , IN.ase_color.a , _OcclusionStrengthAO);
				float lerpResult2709_g57888 = lerp( lerpResult3415_g57888 , lerpResult3414_g57888 , _OcclusionSource);
				float temp_output_2730_0_g57888 = saturate( lerpResult2709_g57888 );
				...
				float3 Emission = 0;
				float3 Specular = 0.5;
				float Metallic = ( _MetallicStrength * MASK_B1377_g57888 );
				float Smoothness = saturate( lerpResult2636_g57888 );
				float Occlusion = temp_output_2730_0_g57888;
				float Alpha = 1;
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				float temp_output_13_0_g57833 = cos( temp_output_200_0_g57833 );
				float m_switch80_g57833 = _DetailUVMode;
				float2 m_UV080_g57833 = v.texcoord0.xy;
				float2 m_UV180_g57833 = v.texcoord1.xy;
				float2 m_UV280_g57833 = v.texcoord2.xy;
				float2 m_UV380_g57833 = v.ase_texcoord3.xy;
				float2 localfloat2switchUVMode80_g57833 = float2switchUVMode80_g57833( m_switch80_g57833 , m_UV080_g57833 , m_UV180_g57833 , m_UV280_g57833 , m_UV380_g57833 );
				...
				float2 _ConstantAnchor = float2(0.5,0.5);
				float2 vertexToFrag70_g57833 = ( temp_output_41_0_g57833 - ( ( ( (_DetailUVs).xy / 1.0 ) * _ConstantAnchor ) - _ConstantAnchor ) );
				o.ase_texcoord4.zw = vertexToFrag70_g57833;
				float temp_output_6_0_g57836 = _DetailMaskUVRotation;
				float temp_output_200_0_g57836 = radians( temp_output_6_0_g57836 );
				float temp_output_13_0_g57836 = cos( temp_output_200_0_g57836 );
				float DetailUVMode1060_g57819 = _DetailUVMode;
				float m_switch80_g57836 = DetailUVMode1060_g57819;
				float2 m_UV080_g57836 = v.texcoord0.xy;
				float2 m_UV180_g57836 = v.texcoord1.xy;
				float2 m_UV280_g57836 = v.texcoord2.xy;
				float2 m_UV380_g57836 = v.ase_texcoord3.xy;
				float2 localfloat2switchUVMode80_g57836 = float2switchUVMode80_g57836( m_switch80_g57836 , m_UV080_g57836 , m_UV180_g57836 , m_UV280_g57836 , m_UV380_g57836 );
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float3 temp_output_39_0_g57819 = temp_output_3_0_g57888;
				float localStochasticTiling159_g57824 = ( 0.0 );
				float2 vertexToFrag70_g57833 = IN.ase_texcoord4.zw;
				float2 temp_output_1334_0_g57819 = vertexToFrag70_g57833;
				float2 UV159_g57824 = temp_output_1334_0_g57819;
				float4 TexelSize159_g57824 = _DetailColorMap_TexelSize;
				float4 Offsets159_g57824 = float4( 0,0,0,0 );
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				float temp_output_13_0_g57833 = cos( temp_output_200_0_g57833 );
				float m_switch80_g57833 = _DetailUVMode;
				float2 m_UV080_g57833 = v.ase_texcoord.xy;
				float2 m_UV180_g57833 = v.ase_texcoord1.xy;
				float2 m_UV280_g57833 = v.ase_texcoord2.xy;
				float2 m_UV380_g57833 = v.ase_texcoord3.xy;
				float2 localfloat2switchUVMode80_g57833 = float2switchUVMode80_g57833( m_switch80_g57833 , m_UV080_g57833 , m_UV180_g57833 , m_UV280_g57833 , m_UV380_g57833 );
				float2 temp_output_9_0_g57833 = float2( 0.5,0.5 );
				float2 break39_g57833 = ( localfloat2switchUVMode80_g57833 - temp_output_9_0_g57833 );
				...
				float2 _ConstantAnchor = float2(0.5,0.5);
				float2 vertexToFrag70_g57833 = ( temp_output_41_0_g57833 - ( ( ( (_DetailUVs).xy / 1.0 ) * _ConstantAnchor ) - _ConstantAnchor ) );
				o.ase_texcoord2.zw = vertexToFrag70_g57833;
				float temp_output_6_0_g57836 = _DetailMaskUVRotation;
				float temp_output_200_0_g57836 = radians( temp_output_6_0_g57836 );
				float temp_output_13_0_g57836 = cos( temp_output_200_0_g57836 );
				float DetailUVMode1060_g57819 = _DetailUVMode;
				float m_switch80_g57836 = DetailUVMode1060_g57819;
				float2 m_UV080_g57836 = v.ase_texcoord.xy;
				float2 m_UV180_g57836 = v.ase_texcoord1.xy;
				float2 m_UV280_g57836 = v.ase_texcoord2.xy;
				float2 m_UV380_g57836 = v.ase_texcoord3.xy;
				float2 localfloat2switchUVMode80_g57836 = float2switchUVMode80_g57836( m_switch80_g57836 , m_UV080_g57836 , m_UV180_g57836 , m_UV280_g57836 , m_UV380_g57836 );
				float2 temp_output_9_0_g57836 = float2( 0.5,0.5 );
				float2 break39_g57836 = ( localfloat2switchUVMode80_g57836 - temp_output_9_0_g57836 );
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float3 temp_output_39_0_g57819 = temp_output_3_0_g57888;
				float localStochasticTiling159_g57824 = ( 0.0 );
				float2 vertexToFrag70_g57833 = IN.ase_texcoord2.zw;
				float2 temp_output_1334_0_g57819 = vertexToFrag70_g57833;
				float2 UV159_g57824 = temp_output_1334_0_g57819;
				float4 TexelSize159_g57824 = _DetailColorMap_TexelSize;
				float4 Offsets159_g57824 = float4( 0,0,0,0 );
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				float2 _ConstantAnchor = float2(0.5,0.5);
				float2 vertexToFrag70_g57833 = ( temp_output_41_0_g57833 - ( ( ( (_DetailUVs).xy / 1.0 ) * _ConstantAnchor ) - _ConstantAnchor ) );
				o.ase_texcoord5.zw = vertexToFrag70_g57833;
				float temp_output_6_0_g57836 = _DetailMaskUVRotation;
				float temp_output_200_0_g57836 = radians( temp_output_6_0_g57836 );
				float temp_output_13_0_g57836 = cos( temp_output_200_0_g57836 );
				float DetailUVMode1060_g57819 = _DetailUVMode;
				...
				float2 temp_output_41_0_g57836 = ( ( ( appendResult36_g57836 * ( (_DetailMaskUVs).xy / 1.0 ) ) + temp_output_9_0_g57836 ) + Offset235_g57836 );
				float2 vertexToFrag70_g57836 = ( temp_output_41_0_g57836 - ( ( ( (_DetailMaskUVs).xy / 1.0 ) * _ConstantAnchor ) - _ConstantAnchor ) );
				o.ase_texcoord6.xy = vertexToFrag70_g57836;
						 ...
						 )
			{
				...
				float BaseColor_R1273_g57819 = temp_output_39_0_g57819.x;
				float localStochasticTiling159_g57824 = ( 0.0 );
				float2 vertexToFrag70_g57833 = IN.ase_texcoord5.zw;
				float2 temp_output_1334_0_g57819 = vertexToFrag70_g57833;
				float2 UV159_g57824 = temp_output_1334_0_g57819;
				float4 TexelSize159_g57824 = _DetailColorMap_TexelSize;
				float4 Offsets159_g57824 = float4( 0,0,0,0 );
				...
				float3 Normal_In880_g57819 = temp_output_38_0_g57819;
				float localStochasticTiling159_g57831 = ( 0.0 );
				float2 vertexToFrag70_g57836 = IN.ase_texcoord6.xy;
				float2 temp_output_1339_0_g57819 = vertexToFrag70_g57836;
				float2 UV159_g57831 = temp_output_1339_0_g57819;
				float4 TexelSize159_g57831 = _DetailMaskMap_TexelSize;
				float4 Offsets159_g57831 = float4( 0,0,0,0 );
...
/*ASEBEGIN
Version=19303
Node;AmplifyShaderEditor.FunctionNode;415;1120,-704;Inherit;False;DESF Module Detail;161;;57819;49c077198be2bdb409ab6ad879c0ca28;17,666,1,1023,1,1260,1,665,1,663,1,662,1,1006,1,1012,1,650,1,1067,0,727,0,726,0,874,0,602,0,945,1,1075,0,1316,0;4;39;FLOAT3;0,0,0;False;38;FLOAT3;0,0,1;False;456;SAMPLERSTATE;0;False;464;SAMPLERSTATE;0;False;2;FLOAT3;73;FLOAT3;72
Node;AmplifyShaderEditor.IntNode;421;1408,-720;Inherit;False;Property;_Cull;Render Face;0;2;[HideInInspector];[Enum];Create;False;0;0;1;Front,2,Back,1,Both,0;True;0;False;2;2;False;0;1;INT;0
Node;AmplifyShaderEditor.FunctionNode;445;704,-640;Inherit;False;DESF Core Lit;1;;57888;e0cdd7758f4404849b063afff4596424;39,442,2,1557,0,1749,0,1556,0,2284,0,2283,0,2213,0,2481,0,2411,0,2399,0,2172,0,2282,0,3300,0,3301,0,3299,0,2132,0,3146,0,2311,0,3108,0,3119,0,3076,0,3408,0,3291,0,3290,0,3289,0,3287,0,96,0,2591,0,2559,0,1368,0,2125,0,2131,0,2028,0,1333,0,2126,0,1896,0,1415,0,830,0,2523,1;1;1234;FLOAT3;0,0,0;False;17;FLOAT3;38;FLOAT3;35;FLOAT;37;FLOAT3;1922;FLOAT;33;FLOAT;34;FLOAT;46;FLOAT;814;FLOAT;1660;FLOAT3;656;FLOAT3;657;FLOAT3;655;FLOAT3;1235;FLOAT3;2760;SAMPLERSTATE;1819;SAMPLERSTATE;1824;SAMPLERSTATE;1818
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;435;1374.904,-640;Float;False;False;-1;2;DE_ShaderGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;ExtraPrePass;0;0;ExtraPrePass;5;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;5;True;12;all;0;False;True;1;1;False;;0;False;;0;1;False;;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;0;False;False;0;Hidden/DE/Utility/Fallback;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;437;1374.904,-680.6909;Float;False;False;-1;2;DE_ShaderGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;ShadowCaster;0;2;ShadowCaster;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;5;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;False;False;True;False;False;False;False;0;False;;False;False;False;False;False;False;False;False;False;True;1;False;;True;3;False;;False;True;1;LightMode=ShadowCaster;False;False;0;Hidden/DE/Utility/Fallback;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;438;1374.904,-680.6909;Float;False;False;-1;2;DE_ShaderGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;DepthOnly;0;3;DepthOnly;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;5;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;False;False;True;False;False;False;False;0;False;;False;False;False;False;False;False;False;False;False;True;1;False;;False;False;True;1;LightMode=DepthOnly;False;False;0;Hidden/DE/Utility/Fallback;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;439;1374.904,-680.6909;Float;False;False;-1;2;DE_ShaderGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;Meta;0;4;Meta;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;5;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;2;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=Meta;False;False;0;Hidden/DE/Utility/Fallback;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;440;1374.904,-680.6909;Float;False;False;-1;2;DE_ShaderGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;Universal2D;0;5;Universal2D;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;5;True;12;all;0;False;True;1;1;False;;0;False;;1;1;False;;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;False;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;1;LightMode=Universal2D;False;False;0;Hidden/DE/Utility/Fallback;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;441;1374.904,-680.6909;Float;False;False;-1;2;DE_ShaderGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;DepthNormals;0;6;DepthNormals;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;5;True;12;all;0;False;True;1;1;False;;0;False;;0;1;False;;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;False;;True;3;False;;False;True;1;LightMode=DepthNormals;False;False;0;Hidden/DE/Utility/Fallback;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;442;1374.904,-680.6909;Float;False;False;-1;2;DE_ShaderGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;GBuffer;0;7;GBuffer;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;5;True;12;all;0;False;True;1;1;False;;0;False;;1;1;False;;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;1;LightMode=UniversalGBuffer;False;False;0;Hidden/DE/Utility/Fallback;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;443;1374.904,-680.6909;Float;False;False;-1;2;DE_ShaderGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;SceneSelectionPass;0;8;SceneSelectionPass;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;5;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;2;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=SceneSelectionPass;False;False;0;Hidden/DE/Utility/Fallback;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;444;1374.904,-680.6909;Float;False;False;-1;2;DE_ShaderGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;ScenePickingPass;0;9;ScenePickingPass;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;5;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=Picking;False;False;0;Hidden/DE/Utility/Fallback;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;436;1408,-640;Float;False;True;-1;2;DE_ShaderGUI;0;12;DE Environment/Vegetation/Surface Detail;94348b07e5e8bab40bd6c8a1e3df54cd;True;Forward;0;1;Forward;21;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;True;True;0;True;_Cull;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;5;True;12;all;0;False;True;1;1;False;;0;False;;1;1;False;;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;1;LightMode=UniversalForward;False;False;0;Hidden/DE/Utility/Fallback;0;0;Standard;39;Workflow;1;0;Surface;0;0;  Refraction Model;0;0;  Blend;0;0;Two Sided;1;0;Fragment Normal Space,InvertActionOnDeselection;0;0;Forward Only;0;0;Transmission;0;0;  Transmission Shadow;0.5,True,_ASETransmissionShadow;0;Translucency;0;0;  Translucency Strength;1,True,_ASETranslucencyStrength;0;  Normal Distortion;0.5,True,_ASETranslucencyNormalDistortion;0;  Scattering;2,True,_ASETranslucencyScattering;0;  Direct;0.9,True,_ASETranslucencyScattering;0;  Ambient;0.1,True,_ASETranslucencyAmbient;0;  Shadow;0.5,True,_ASETranslucencyShadow;0;Cast Shadows;1;0;  Use Shadow Threshold;0;0;GPU Instancing;1;0;LOD CrossFade;1;0;Built-in Fog;1;0;_FinalColorxAlpha;0;0;Meta Pass;1;0;Override Baked GI;0;0;Extra Pre Pass;0;0;Tessellation;0;0;  Phong;0;0;  Strength;0.5,True,_TessellationPhong;0;  Type;0;0;  Tess;16,True,_TessellationStrength;0;  Min;10,True,_TessellationDistanceMin;0;  Max;25,True,_TessellationDistanceMax;0;  Edge Length;16,False,;0;  Max Displacement;25,False,;0;Write Depth;0;0;  Early Z;0;0;Vertex Position,InvertActionOnDeselection;1;0;Debug Display;0;0;Clear Coat;0;0;0;10;False;True;True;True;True;True;True;True;True;True;False;;True;0
WireConnection;415;39;445;38
WireConnection;415;38;445;35
WireConnection;415;456;445;1819
WireConnection;415;464;445;1824
WireConnection;436;0;415;73
WireConnection;436;1;415;72
WireConnection;436;3;445;37
WireConnection;436;4;445;33
WireConnection;436;5;445;34
ASEEND*/
//CHKSM=DAB21F3335865D377F5DF331EAB5686E16F496D0