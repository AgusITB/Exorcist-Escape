...
Shader "DE Environment/Vegetation/Cutout Translucency Voronoi"
{
	Properties
	{
		...
		[DE_DrawerCategory(CELL DETAIL,true,_CellDetailEnable,0,0)]_CATEGORY_CELLDETAIL("CATEGORY_CELL DETAIL", Float) = 1
		[DE_DrawerToggleLeft]_CellDetailEnable("ENABLE CELL DETAIL", Float) = 0
		_CellDetailScale("Cell Detail Scale", Range( 0.1 , 100)) = 0.1
		_CellDetailNormal("Cell Detail Normal", Range( 0.001 , 1)) = 0.001
		_VoronoiDetailSmoothness("Cell Detail Smoothness", Range( 0.001 , 1)) = 0.001
		[DE_DrawerSpace(10)]_SPACE_CELLDETAIL("SPACE_CELL DETAIL", Float) = 0
	...
	SubShader
	{
		...
		Pass
		{
			...
			float _CATEGORY_CELLDETAIL;
			half _VoronoiDetailSmoothness;
			...
			float3 RGBToHSV(float3 c)
			{
				...
				return float3( abs(q.z + (q.w - q.y) / (6.0 * d + e)), d / (q.x + e), q.x);
					...
					float2 voronoihash2584_g57784( float2 p )
					{
						p = p - 25 * floor( p / 25 );
					...
					float voronoi2584_g57784( float2 v, float time, inout float2 id, inout float2 mr, float smoothness, inout float2 smoothId )
					{
						float2 n = floor( v );
						float2 f = frac( v );
						float F1 = 8.0;
						...
						for ( int j = -2; j <= 2; j++ )
						{
							for ( int i = -2; i <= 2; i++ )
						 	{
						 		float2 g = float2( i, j );
						 		float2 o = voronoihash2584_g57784( n + g );
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				float2 temp_output_1955_0_g57784 = (_MainUVs).xy;
				float2 temp_output_1953_0_g57784 = (_MainUVs).zw;
				float2 Offset235_g58525 = temp_output_1953_0_g57784;
				float2 temp_output_41_0_g58525 = ( ( localfloat2switchUVMode80_g58525 * temp_output_1955_0_g57784 ) + Offset235_g58525 );
				...
				float2 appendResult2625_g57784 = (float2(_Vector0.x , _Vector0.y));
				float2 appendResult2626_g57784 = (float2(_Vector0.z , _Vector0.w));
				float2 vertexToFrag2617_g57784 = ( ( v.texcoord.xy * appendResult2625_g57784 ) + appendResult2626_g57784 );
				o.ase_texcoord10.xy = vertexToFrag2617_g57784;
						 ...
						 ) : SV_Target
			{
				...
				float3 temp_output_1923_0_g57784 = (_BaseColor).rgb;
				float2 vertexToFrag70_g58525 = IN.ase_texcoord8.xy;
				float2 UV213_g57784 = vertexToFrag70_g58525;
				float4 tex2DNode2048_g57784 = SAMPLE_TEXTURE2D( _MainTex, sampler_MainTex, UV213_g57784 );
				float3 ALBEDO_RGBA1381_g57784 = (tex2DNode2048_g57784).rgb;
				float3 temp_output_3_0_g57784 = ( temp_output_1923_0_g57784 * ALBEDO_RGBA1381_g57784 * _Brightness );
				float3 temp_output_134_0_g58123 = temp_output_3_0_g57784;
				...
				float time2584_g57784 = 0.0;
				float2 voronoiSmoothId2584_g57784 = 0;
				float voronoiSmooth2584_g57784 = _VoronoiDetailSmoothness;
				float2 vertexToFrag2617_g57784 = IN.ase_texcoord10.xy;
				float2 coords2584_g57784 = vertexToFrag2617_g57784 * ( ( 1.0 - _CellDetailScale ) * 50 );
				float2 id2584_g57784 = 0;
				float2 uv2584_g57784 = 0;
				float voroi2584_g57784 = voronoi2584_g57784( coords2584_g57784, time2584_g57784, id2584_g57784, uv2584_g57784, voronoiSmooth2584_g57784, voronoiSmoothId2584_g57784 );
				float temp_output_2581_0_g57784 = ( ( 1.0 - voroi2584_g57784 ) - 0.3 );
				float CellDetail2580_g57784 = temp_output_2581_0_g57784;
				float3 temp_cast_4 = (CellDetail2580_g57784).xxx;
				float3 blendOpSrc2562_g57784 = temp_cast_4;
				float3 blendOpDest2562_g57784 = lerpResult393_g58123;
				float3 lerpResult2563_g57784 = lerp( lerpResult393_g58123 , ( saturate( (( blendOpDest2562_g57784 > 0.5 ) ? ( 1.0 - 2.0 * ( 1.0 - blendOpDest2562_g57784 ) * ( 1.0 - blendOpSrc2562_g57784 ) ) : ( 2.0 * blendOpDest2562_g57784 * blendOpSrc2562_g57784 ) ) )) , ( _CellDetailEnable + ( ( _CATEGORY_CELLDETAIL + _SPACE_CELLDETAIL ) * 0.0 ) ));
				
				float4 NORMAL_RGBA1382_g57784 = SAMPLE_TEXTURE2D( _BumpMap, sampler_BumpMap, UV213_g57784 );
				float3 unpack1891_g57784 = UnpackNormalScale( NORMAL_RGBA1382_g57784, _NormalStrength );
				unpack1891_g57784.z = lerp( 1, unpack1891_g57784.z, saturate(_NormalStrength) );
				float3 temp_output_4_0_g58216 = WorldNormal;
				float3 temp_output_14_0_g58216 = cross( ddy( WorldPosition ) , temp_output_4_0_g58216 );
				float3 temp_output_9_0_g58216 = ddx( WorldPosition );
				float dotResult21_g58216 = dot( temp_output_14_0_g58216 , temp_output_9_0_g58216 );
				float temp_output_1_0_g58205 = saturate( temp_output_2581_0_g57784 );
				float temp_output_2_0_g58205 = ddx( temp_output_1_0_g58205 );
				float temp_output_2_0_g58216 = temp_output_1_0_g58205;
				float temp_output_7_0_g58205 = ddy( temp_output_1_0_g58205 );
				float ifLocalVar17_g58216 = 0;
				if( dotResult21_g58216 > 0.0 )
				ifLocalVar17_g58216 = 1.0;
				else if( dotResult21_g58216 == 0.0 )
				ifLocalVar17_g58216 = 0.0;
				else if( dotResult21_g58216 < 0.0 )
				ifLocalVar17_g58216 = _Float2;
				float3 temp_output_22_0_g58216 = ( ( abs( dotResult21_g58216 ) * temp_output_4_0_g58216 ) - ( ( ( ( ( temp_output_1_0_g58205 + temp_output_2_0_g58205 ) - temp_output_2_0_g58216 ) * temp_output_14_0_g58216 ) + ( ( ( temp_output_1_0_g58205 + temp_output_7_0_g58205 ) - temp_output_2_0_g58216 ) * cross( temp_output_4_0_g58216 , temp_output_9_0_g58216 ) ) ) * ifLocalVar17_g58216 ) );
				float3 normalizeResult23_g58216 = normalize( temp_output_22_0_g58216 );
				float3 lerpResult2574_g57784 = lerp( float3(0.5,0.5,1) , normalizeResult23_g58216 , _CellDetailNormal);
				float Cell_Detail_Enable2560_g57784 = _CellDetailEnable;
				float3 lerpResult2572_g57784 = lerp( unpack1891_g57784 , BlendNormal( unpack1891_g57784 , lerpResult2574_g57784 ) , Cell_Detail_Enable2560_g57784);
				
				float4 tex2DNode2050_g57784 = SAMPLE_TEXTURE2D( _MaskMap, sampler_MaskMap, UV213_g57784 );
				float MASK_B1377_g57784 = tex2DNode2050_g57784.b;
				
				float MASK_G158_g57784 = tex2DNode2050_g57784.g;
				float temp_output_2651_0_g57784 = ( 1.0 - MASK_G158_g57784 );
				float lerpResult2650_g57784 = lerp( MASK_G158_g57784 , temp_output_2651_0_g57784 , _SmoothnessSource);
				float temp_output_2693_0_g57784 = ( lerpResult2650_g57784 * _SmoothnessStrength );
				float2 appendResult2645_g57784 = (float2(WorldViewDirection.xy));
				float3 appendResult2644_g57784 = (float3(appendResult2645_g57784 , ( WorldViewDirection.z / 1.06 )));
				float3 break2680_g57784 = lerpResult2572_g57784;
				float3 normalizeResult2641_g57784 = normalize( ( ( WorldTangent * break2680_g57784.x ) + ( WorldBiTangent * break2680_g57784.y ) + ( WorldNormal * break2680_g57784.z ) ) );
				float3 Normal_Per_Pixel2690_g57784 = normalizeResult2641_g57784;
				float fresnelNdotV2685_g57784 = dot( normalize( Normal_Per_Pixel2690_g57784 ), appendResult2644_g57784 );
				float fresnelNode2685_g57784 = ( 0.0 + ( 1.0 - _SmoothnessFresnelScale ) * pow( max( 1.0 - fresnelNdotV2685_g57784 , 0.0001 ), _SmoothnessFresnelPower ) );
				float lerpResult2636_g57784 = lerp( temp_output_2693_0_g57784 , ( temp_output_2693_0_g57784 - fresnelNode2685_g57784 ) , _SmoothnessFresnelEnable);
				
				float MASK_R1378_g57784 = tex2DNode2050_g57784.r;
				float lerpResult3415_g57784 = lerp( 1.0 , MASK_R1378_g57784 , _OcclusionStrengthAO);
				float lerpResult3414_g57784 = lerp( 1.0 , IN.ase_color.a , _OcclusionStrengthAO);
				float lerpResult2709_g57784 = lerp( lerpResult3415_g57784 , lerpResult3414_g57784 , _OcclusionSource);
				float temp_output_2730_0_g57784 = saturate( lerpResult2709_g57784 );
				
				float temp_output_22_0_g58267 = tex2DNode2048_g57784.a;
				...
				float2 temp_output_101_0_g57809 = UV213_g57784;
				...
				float3 BaseColor = lerpResult2563_g57784;
				float3 Normal = lerpResult2572_g57784;
				float3 Emission = 0;
				float3 Specular = 0.5;
				float Metallic = ( _MetallicStrength * MASK_B1377_g57784 );
				float Smoothness = saturate( lerpResult2636_g57784 );
				float Occlusion = temp_output_2730_0_g57784;
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				float2 appendResult2625_g57784 = (float2(_Vector0.x , _Vector0.y));
				float2 appendResult2626_g57784 = (float2(_Vector0.z , _Vector0.w));
				float2 vertexToFrag2617_g57784 = ( ( v.texcoord0.xy * appendResult2625_g57784 ) + appendResult2626_g57784 );
				o.ase_texcoord6.xy = vertexToFrag2617_g57784;
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float2 voronoiSmoothId2584_g57784 = 0;
				float voronoiSmooth2584_g57784 = _VoronoiDetailSmoothness;
				float2 vertexToFrag2617_g57784 = IN.ase_texcoord6.xy;
				float2 coords2584_g57784 = vertexToFrag2617_g57784 * ( ( 1.0 - _CellDetailScale ) * 50 );
				float2 id2584_g57784 = 0;
				float2 uv2584_g57784 = 0;
				float voroi2584_g57784 = voronoi2584_g57784( coords2584_g57784, time2584_g57784, id2584_g57784, uv2584_g57784, voronoiSmooth2584_g57784, voronoiSmoothId2584_g57784 );
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				float2 appendResult2625_g57784 = (float2(_Vector0.x , _Vector0.y));
				float2 appendResult2626_g57784 = (float2(_Vector0.z , _Vector0.w));
				float2 vertexToFrag2617_g57784 = ( ( v.ase_texcoord.xy * appendResult2625_g57784 ) + appendResult2626_g57784 );
				o.ase_texcoord4.xy = vertexToFrag2617_g57784;
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float2 voronoiSmoothId2584_g57784 = 0;
				float voronoiSmooth2584_g57784 = _VoronoiDetailSmoothness;
				float2 vertexToFrag2617_g57784 = IN.ase_texcoord4.xy;
				float2 coords2584_g57784 = vertexToFrag2617_g57784 * ( ( 1.0 - _CellDetailScale ) * 50 );
				float2 id2584_g57784 = 0;
				float2 uv2584_g57784 = 0;
				float voroi2584_g57784 = voronoi2584_g57784( coords2584_g57784, time2584_g57784, id2584_g57784, uv2584_g57784, voronoiSmooth2584_g57784, voronoiSmoothId2584_g57784 );
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				float2 appendResult2626_g57784 = (float2(_Vector0.z , _Vector0.w));
				float2 vertexToFrag2617_g57784 = ( ( v.ase_texcoord.xy * appendResult2625_g57784 ) + appendResult2626_g57784 );
				o.ase_texcoord5.zw = vertexToFrag2617_g57784;
						 ...
						 )
			{
				...
				float2 voronoiSmoothId2584_g57784 = 0;
				float voronoiSmooth2584_g57784 = _VoronoiDetailSmoothness;
				float2 vertexToFrag2617_g57784 = IN.ase_texcoord5.zw;
				float2 coords2584_g57784 = vertexToFrag2617_g57784 * ( ( 1.0 - _CellDetailScale ) * 50 );
				float2 id2584_g57784 = 0;
				float2 uv2584_g57784 = 0;
				float voroi2584_g57784 = voronoi2584_g57784( coords2584_g57784, time2584_g57784, id2584_g57784, uv2584_g57784, voronoiSmooth2584_g57784, voronoiSmoothId2584_g57784 );
...
/*ASEBEGIN
Version=19303
Node;AmplifyShaderEditor.CommentaryNode;2928;-4404.77,-4281.021;Inherit;False;337.7199;626.5906;TRANSLUCENCY ASE;7;2930;2931;2932;2933;2934;2935;2936;;0,0,0,1;0;0
Node;AmplifyShaderEditor.StickyNoteNode;2929;-4763.942,-4276.038;Inherit;False;336.7329;364.2286;;;0,0,0,1;_ASETransmissionShadow$$_ASETranslucencyStrength$_ASETranslucencyNormalDistortion$_ASETranslucencyScattering$_ASETranslucencyDirect$_ASETranslucencyAmbient$_ASETranslucencyShadow;0;0
Node;AmplifyShaderEditor.RangedFloatNode;2936;-4368,-3744;Inherit;False;Property;_ASETranslucencyShadow;ASE Translucency Shadow ;168;0;Create;False;1;;0;0;True;0;False;0.5;0.5;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;2935;-4368,-3824;Inherit;False;Property;_ASETranslucencyAmbient;ASE Translucency Ambient;167;0;Create;False;1;;0;0;True;0;False;0.8339342;0.8339342;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;2934;-4368,-3904;Inherit;False;Property;_ASETranslucencyDirect;ASE Translucency Direct ;166;0;Create;False;1;;0;0;True;0;False;0.9;0.9;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;2933;-4368,-3984;Inherit;False;Property;_ASETranslucencyScattering;ASE Translucency Scattering ;165;0;Create;False;1;;0;0;True;0;False;2;2;1;50;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;2932;-4368,-4064;Inherit;False;Property;_ASETranslucencyNormalDistortion;ASE Translucency Normal Distortion ;164;0;Create;False;1;;0;0;True;0;False;0.2735869;0.2735869;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;2931;-4368,-4144;Inherit;False;Property;_ASETranslucencyStrength;ASE Translucency Strength;163;0;Create;False;1;;0;0;True;0;False;1;1;1;50;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;2930;-4368,-4224;Inherit;False;Property;_ASETransmissionShadow;ASE Transmission Shadow;162;0;Create;False;1;;0;1;UnityEngine.Rendering.CompareFunction;True;0;False;0.5;0.5;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;2937;-4736,-4096;Inherit;False;Property;_CATEGORY_TRANSLUCENCYASE;CATEGORY_TRANSLUCENCY ASE;161;0;Create;True;0;0;0;True;1;DE_DrawerCategory(TRANSLUCENCY ASE,true,_ASETranslucencyStrength,0,0);False;0;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;2938;-4736,-4016;Inherit;False;Property;_SPACE_TRANSLUCENCYASE;SPACE_TRANSLUCENCYASE;169;0;Create;True;0;0;0;True;1;DE_DrawerSpace(10);False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.IntNode;2914;-3968,-3664;Inherit;False;Property;_Cull;Render Face;0;2;[HideInInspector];[Enum];Create;False;0;0;1;Front,2,Back,1,Both,0;True;0;False;2;2;False;0;1;INT;0
Node;AmplifyShaderEditor.FunctionNode;2949;-4416,-3584;Inherit;False;DESF Core Lit;1;;57784;e0cdd7758f4404849b063afff4596424;39,442,2,1557,0,1749,0,1556,0,2284,0,2283,0,2213,0,2481,0,2411,0,2399,0,2172,0,2282,0,3300,0,3301,0,3299,0,2132,0,3146,0,2311,0,3108,0,3119,0,3076,0,3408,0,3291,0,3290,0,3289,0,3287,0,96,2,2591,1,2559,1,1368,0,2125,0,2131,0,2028,0,1333,0,2126,0,1896,0,1415,0,830,0,2523,1;1;1234;FLOAT3;0,0,0;False;17;FLOAT3;38;FLOAT3;35;FLOAT;37;FLOAT3;1922;FLOAT;33;FLOAT;34;FLOAT;46;FLOAT;814;FLOAT;1660;FLOAT3;656;FLOAT3;657;FLOAT3;655;FLOAT3;1235;FLOAT3;2760;SAMPLERSTATE;1819;SAMPLERSTATE;1824;SAMPLERSTATE;1818
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;2939;-3960.297,-3584;Float;False;False;-1;2;DE_ShaderGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;ExtraPrePass;0;0;ExtraPrePass;5;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;5;True;12;all;0;False;True;1;1;False;;0;False;;0;1;False;;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;0;False;False;0;Hidden/DE/Utility/Fallback;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;2941;-3960.297,-3640.745;Float;False;False;-1;2;DE_ShaderGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;ShadowCaster;0;2;ShadowCaster;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;5;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;False;False;True;False;False;False;False;0;False;;False;False;False;False;False;False;False;False;False;True;1;False;;True;3;False;;False;True;1;LightMode=ShadowCaster;False;False;0;Hidden/DE/Utility/Fallback;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;2942;-3960.297,-3640.745;Float;False;False;-1;2;DE_ShaderGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;DepthOnly;0;3;DepthOnly;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;5;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;False;False;True;False;False;False;False;0;False;;False;False;False;False;False;False;False;False;False;True;1;False;;False;False;True;1;LightMode=DepthOnly;False;False;0;Hidden/DE/Utility/Fallback;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;2943;-3960.297,-3640.745;Float;False;False;-1;2;DE_ShaderGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;Meta;0;4;Meta;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;5;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;2;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=Meta;False;False;0;Hidden/DE/Utility/Fallback;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;2944;-3960.297,-3640.745;Float;False;False;-1;2;DE_ShaderGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;Universal2D;0;5;Universal2D;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;5;True;12;all;0;False;True;1;1;False;;0;False;;1;1;False;;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;False;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;1;LightMode=Universal2D;False;False;0;Hidden/DE/Utility/Fallback;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;2945;-3960.297,-3640.745;Float;False;False;-1;2;DE_ShaderGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;DepthNormals;0;6;DepthNormals;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;5;True;12;all;0;False;True;1;1;False;;0;False;;0;1;False;;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;False;;True;3;False;;False;True;1;LightMode=DepthNormalsOnly;False;False;0;Hidden/DE/Utility/Fallback;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;2946;-3960.297,-3640.745;Float;False;False;-1;2;DE_ShaderGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;GBuffer;0;7;GBuffer;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;5;True;12;all;0;False;True;1;1;False;;0;False;;0;1;False;;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;1;LightMode=UniversalGBuffer;False;False;0;Hidden/DE/Utility/Fallback;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;2947;-3960.297,-3640.745;Float;False;False;-1;2;DE_ShaderGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;SceneSelectionPass;0;8;SceneSelectionPass;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;5;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;2;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=SceneSelectionPass;False;False;0;Hidden/DE/Utility/Fallback;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;2948;-3960.297,-3640.745;Float;False;False;-1;2;DE_ShaderGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;ScenePickingPass;0;9;ScenePickingPass;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;5;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=Picking;False;False;0;Hidden/DE/Utility/Fallback;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;2940;-3968,-3584;Float;False;True;-1;2;DE_ShaderGUI;0;12;DE Environment/Vegetation/Cutout Translucency Voronoi;94348b07e5e8bab40bd6c8a1e3df54cd;True;Forward;0;1;Forward;21;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;True;True;0;True;_Cull;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;5;True;12;all;0;False;True;1;1;False;;0;False;;1;1;False;;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;1;LightMode=UniversalForwardOnly;False;False;0;Hidden/DE/Utility/Fallback;0;0;Standard;39;Workflow;1;0;Surface;0;0;  Refraction Model;0;0;  Blend;0;0;Two Sided;1;0;Fragment Normal Space,InvertActionOnDeselection;0;0;Forward Only;1;638177034779964215;Transmission;1;638177034792653423;  Transmission Shadow;0.5,True,_ASETransmissionShadow;638177034899989159;Translucency;1;638177034802459691;  Translucency Strength;1,True,_ASETranslucencyStrength;638177034938257901;  Normal Distortion;0.5,True,_ASETranslucencyNormalDistortion;638177034965985778;  Scattering;2,True,_ASETranslucencyScattering;638177035016096047;  Direct;0.9,True,_ASETranslucencyScattering;638177035057662061;  Ambient;0.1,True,_ASETranslucencyAmbient;638177035084225150;  Shadow;0.5,True,_ASETranslucencyShadow;638177035114095491;Cast Shadows;1;0;  Use Shadow Threshold;1;638177035141129073;GPU Instancing;1;0;LOD CrossFade;1;0;Built-in Fog;1;0;_FinalColorxAlpha;0;0;Meta Pass;1;0;Override Baked GI;0;0;Extra Pre Pass;0;0;Tessellation;0;0;  Phong;0;0;  Strength;0.5,True,_TessellationPhong;0;  Type;0;0;  Tess;16,True,_TessellationStrength;0;  Min;10,True,_TessellationDistanceMin;0;  Max;25,True,_TessellationDistanceMax;0;  Edge Length;16,False,;0;  Max Displacement;25,False,;0;Write Depth;0;0;  Early Z;0;0;Vertex Position,InvertActionOnDeselection;1;0;Debug Display;0;0;Clear Coat;0;0;0;10;False;True;True;True;True;True;True;False;True;True;False;;True;0
WireConnection;2940;0;2949;38
WireConnection;2940;1;2949;35
WireConnection;2940;3;2949;37
WireConnection;2940;4;2949;33
WireConnection;2940;5;2949;34
WireConnection;2940;6;2949;46
WireConnection;2940;7;2949;814
WireConnection;2940;16;2949;1660
WireConnection;2940;14;2949;656
WireConnection;2940;15;2949;657
ASEEND*/
//CHKSM=5BC7D19834D4A10E630FA75F80DA0B299E41F466