...
Shader "DE Environment/Bicubic/Surface Precompute"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				float2 temp_output_1955_0_g58118 = (_MainUVs).xy;
				float2 temp_output_1953_0_g58118 = (_MainUVs).zw;
				float2 Offset235_g58525 = temp_output_1953_0_g58118;
				float2 temp_output_41_0_g58525 = ( ( localfloat2switchUVMode80_g58525 * temp_output_1955_0_g58118 ) + Offset235_g58525 );
						 ...
						 ) : SV_Target
			{
				...
				float3 temp_output_1923_0_g58118 = (_BaseColor).rgb;
				float localStochasticTiling159_g58228 = ( 0.0 );
				float2 vertexToFrag70_g58525 = IN.ase_texcoord8.xy;
				float2 UV213_g58118 = vertexToFrag70_g58525;
				float2 UV159_g58228 = UV213_g58118;
				...
				float3 ALBEDO_RGBA1381_g58118 = (Output_Fetch2D44_g58234).rgb;
				float3 temp_output_3_0_g58118 = ( temp_output_1923_0_g58118 * ALBEDO_RGBA1381_g58118 * _Brightness );
				
				float localStochasticTiling159_g58240 = ( 0.0 );
				float2 UV159_g58240 = UV213_g58118;
				...
				float4 NORMAL_RGBA1382_g58118 = Output_Fetch2D44_g58238;
				float3 unpack1891_g58118 = UnpackNormalScale( NORMAL_RGBA1382_g58118, _NormalStrength );
				unpack1891_g58118.z = lerp( 1, unpack1891_g58118.z, saturate(_NormalStrength) );
				
				float localStochasticTiling159_g58231 = ( 0.0 );
				float2 UV159_g58231 = UV213_g58118;
				...
				float MASK_B1377_g58118 = break50_g58233.b;
				
				float MASK_G158_g58118 = break50_g58233.g;
				float temp_output_2651_0_g58118 = ( 1.0 - MASK_G158_g58118 );
				float lerpResult2650_g58118 = lerp( MASK_G158_g58118 , temp_output_2651_0_g58118 , _SmoothnessSource);
				float temp_output_2693_0_g58118 = ( lerpResult2650_g58118 * _SmoothnessStrength );
				float2 appendResult2645_g58118 = (float2(WorldViewDirection.xy));
				float3 appendResult2644_g58118 = (float3(appendResult2645_g58118 , ( WorldViewDirection.z / 1.06 )));
				float3 break2680_g58118 = unpack1891_g58118;
				float3 normalizeResult2641_g58118 = normalize( ( ( WorldTangent * break2680_g58118.x ) + ( WorldBiTangent * break2680_g58118.y ) + ( WorldNormal * break2680_g58118.z ) ) );
				float3 Normal_Per_Pixel2690_g58118 = normalizeResult2641_g58118;
				float fresnelNdotV2685_g58118 = dot( normalize( Normal_Per_Pixel2690_g58118 ), appendResult2644_g58118 );
				float fresnelNode2685_g58118 = ( 0.0 + ( 1.0 - _SmoothnessFresnelScale ) * pow( max( 1.0 - fresnelNdotV2685_g58118 , 0.0001 ), _SmoothnessFresnelPower ) );
				float lerpResult2636_g58118 = lerp( temp_output_2693_0_g58118 , ( temp_output_2693_0_g58118 - fresnelNode2685_g58118 ) , _SmoothnessFresnelEnable);
				
				float MASK_R1378_g58118 = break50_g58233.r;
				float lerpResult3415_g58118 = lerp( 1.0 , MASK_R1378_g58118 , _OcclusionStrengthAO);
				float lerpResult3414_g58118 = lerp( 1.0 , IN.ase_color.a , _OcclusionStrengthAO);
				float lerpResult2709_g58118 = lerp( lerpResult3415_g58118 , lerpResult3414_g58118 , _OcclusionSource);
				float temp_output_2730_0_g58118 = saturate( lerpResult2709_g58118 );
				

				float3 BaseColor = temp_output_3_0_g58118;
				float3 Normal = unpack1891_g58118;
				float3 Emission = 0;
				float3 Specular = 0.5;
				float Metallic = ( _MetallicStrength * MASK_B1377_g58118 );
				float Smoothness = saturate( lerpResult2636_g58118 );
				float Occlusion = temp_output_2730_0_g58118;
				float Alpha = 1;
...
Node;AmplifyShaderEditor.FunctionNode;442;960,-640;Inherit;False;DESF Core Lit;1;;58118;e0cdd7758f4404849b063afff4596424;39,442,2,1557,0,1749,0,1556,0,2284,2,2283,2,2213,2,2481,2,2411,2,2399,2,2172,2,2282,2,3300,2,3301,2,3299,2,2132,2,3146,2,2311,2,3108,0,3119,0,3076,0,3408,0,3291,0,3290,0,3289,0,3287,0,96,0,2591,0,2559,0,1368,0,2125,0,2131,0,2028,0,1333,0,2126,0,1896,0,1415,0,830,0,2523,1;1;1234;FLOAT3;0,0,0;False;17;FLOAT3;38;FLOAT3;35;FLOAT;37;FLOAT3;1922;FLOAT;33;FLOAT;34;FLOAT;46;FLOAT;814;FLOAT;1660;FLOAT3;656;FLOAT3;657;FLOAT3;655;FLOAT3;1235;FLOAT3;2760;SAMPLERSTATE;1819;SAMPLERSTATE;1824;SAMPLERSTATE;1818
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;432;1374.904,-640;Float;False;False;-1;2;DE_ShaderGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;ExtraPrePass;0;0;ExtraPrePass;5;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;5;True;12;all;0;False;True;1;1;False;;0;False;;0;1;False;;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;0;False;False;0;Hidden/DE/Utility/Fallback;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;434;1374.904,-680.6909;Float;False;False;-1;2;DE_ShaderGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;ShadowCaster;0;2;ShadowCaster;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;5;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;False;False;True;False;False;False;False;0;False;;False;False;False;False;False;False;False;False;False;True;1;False;;True;3;False;;False;True;1;LightMode=ShadowCaster;False;False;0;Hidden/DE/Utility/Fallback;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;435;1374.904,-680.6909;Float;False;False;-1;2;DE_ShaderGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;DepthOnly;0;3;DepthOnly;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;5;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;False;False;True;False;False;False;False;0;False;;False;False;False;False;False;False;False;False;False;True;1;False;;False;False;True;1;LightMode=DepthOnly;False;False;0;Hidden/DE/Utility/Fallback;0;0;Standard;0;False;0
