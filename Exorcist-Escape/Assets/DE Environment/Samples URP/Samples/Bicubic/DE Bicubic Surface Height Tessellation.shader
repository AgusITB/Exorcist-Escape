...
Shader "DE Environment/Bicubic/Surface Height Tessellation"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				float3 temp_output_1234_0_g58186 = _Vector8;
				float localStochasticTiling159_g58266 = ( 0.0 );
				float m_switch80_g58528 = _UVMode;
				float2 m_UV080_g58528 = v.texcoord.xy;
				float2 m_UV180_g58528 = v.texcoord1.xy;
				float2 m_UV280_g58528 = v.texcoord2.xy;
				float2 m_UV380_g58528 = v.ase_texcoord3.xy;
				...
				float2 temp_output_1955_0_g58186 = (_MainUVs).xy;
				float2 temp_output_1953_0_g58186 = (_MainUVs).zw;
				float2 Offset235_g58528 = temp_output_1953_0_g58186;
				float2 temp_output_41_0_g58528 = ( ( localfloat2switchUVMode80_g58528 * temp_output_1955_0_g58186 ) + Offset235_g58528 );
				float2 temp_output_2089_0_g58186 = temp_output_41_0_g58528;
				float2 UV213_g58186 = temp_output_2089_0_g58186;
				float2 UV159_g58266 = UV213_g58186;
				float4 TexelSize159_g58266 = _ParallaxMap_TexelSize;
				float4 Offsets159_g58266 = float4( 0,0,0,0 );
				float2 Weights159_g58266 = float2( 0,0 );
				{
				UV159_g58266 = UV159_g58266 * TexelSize159_g58266.zw - 0.5;
				float2 f = frac( UV159_g58266 );
				UV159_g58266 -= f;
				...
				float4 c = float4( UV159_g58266.x - 0.5, UV159_g58266.x + 1.5, UV159_g58266.y - 0.5, UV159_g58266.y + 1.5 );
				float4 s = float4( xc.x + xc.y, xc.z + xc.w, yc.x + yc.y, yc.z + yc.w );
				float w0 = s.x / ( s.x + s.y );
				float w1 = s.z / ( s.z + s.w );
				Offsets159_g58266 = ( c + float4( xc.y, xc.w, yc.y, yc.w ) / s ) * TexelSize159_g58266.xyxy;
				Weights159_g58266 = float2( w0, w1 );
				}
				float4 Input_FetchOffsets70_g58264 = Offsets159_g58266;
				float2 Input_FetchWeights143_g58264 = Weights159_g58266;
				float2 break46_g58264 = Input_FetchWeights143_g58264;
				float4 lerpResult20_g58264 = lerp( SAMPLE_TEXTURE2D_LOD( _ParallaxMap, sampler_ParallaxMap, (Input_FetchOffsets70_g58264).yw, 0.0 ) , SAMPLE_TEXTURE2D_LOD( _ParallaxMap, sampler_ParallaxMap, (Input_FetchOffsets70_g58264).xw, 0.0 ) , break46_g58264.x);
				float4 lerpResult40_g58264 = lerp( SAMPLE_TEXTURE2D_LOD( _ParallaxMap, sampler_ParallaxMap, (Input_FetchOffsets70_g58264).yz, 0.0 ) , SAMPLE_TEXTURE2D_LOD( _ParallaxMap, sampler_ParallaxMap, (Input_FetchOffsets70_g58264).xz, 0.0 ) , break46_g58264.x);
				float4 lerpResult22_g58264 = lerp( lerpResult20_g58264 , lerpResult40_g58264 , break46_g58264.y);
				float4 Output_Fetch2D44_g58264 = lerpResult22_g58264;
				float3 Displacment2502_g58186 = (Output_Fetch2D44_g58264).rgb;
				float3 lerpResult2554_g58186 = lerp( Displacment2502_g58186 , ( 1.0 - Displacment2502_g58186 ) , _DisplacementBlendInversion);
				float3 lerpResult2551_g58186 = lerp( _Vector8 , ( v.normalOS * ( lerpResult2554_g58186 * _DisplacementStrength ) ) , ( _DisplacementEnable + ( ( _CATEGORY_DISPLACEMENT + _SPACE_DISPLACEMENT ) * 0.0 ) ));
				...
				float3 vertexValue = ( temp_output_1234_0_g58186 + lerpResult2551_g58186 );
						 ...
						 ) : SV_Target
			{
				...
				float3 temp_output_1923_0_g58186 = (_BaseColor).rgb;
				...
				float2 temp_output_2089_0_g58186 = temp_output_41_0_g58528;
				float2 UV213_g58186 = temp_output_2089_0_g58186;
				float2 UV159_g58228 = UV213_g58186;
				...
				float3 ALBEDO_RGBA1381_g58186 = (Output_Fetch2D44_g58234).rgb;
				float3 temp_output_3_0_g58186 = ( temp_output_1923_0_g58186 * ALBEDO_RGBA1381_g58186 * _Brightness );
				
				float localStochasticTiling159_g58240 = ( 0.0 );
				float2 UV159_g58240 = UV213_g58186;
				...
				float4 NORMAL_RGBA1382_g58186 = Output_Fetch2D44_g58238;
				float3 unpack1891_g58186 = UnpackNormalScale( NORMAL_RGBA1382_g58186, _NormalStrength );
				unpack1891_g58186.z = lerp( 1, unpack1891_g58186.z, saturate(_NormalStrength) );
				...
				float2 UV119_g58318 = UV213_g58186;
				...
				float3 lerpResult2520_g58186 = lerp( unpack1891_g58186 , localCombineSamplesSmooth150_g58318 , _DisplacementNormalReconstructed);
				float DisplacementEnable2553_g58186 = _DisplacementEnable;
				float3 lerpResult2522_g58186 = lerp( unpack1891_g58186 , lerpResult2520_g58186 , DisplacementEnable2553_g58186);
				
				float localStochasticTiling159_g58231 = ( 0.0 );
				float2 UV159_g58231 = UV213_g58186;
				...
				float MASK_B1377_g58186 = break50_g58233.b;
				
				float MASK_G158_g58186 = break50_g58233.g;
				float temp_output_2651_0_g58186 = ( 1.0 - MASK_G158_g58186 );
				float lerpResult2650_g58186 = lerp( MASK_G158_g58186 , temp_output_2651_0_g58186 , _SmoothnessSource);
				float temp_output_2693_0_g58186 = ( lerpResult2650_g58186 * _SmoothnessStrength );
				float2 appendResult2645_g58186 = (float2(WorldViewDirection.xy));
				float3 appendResult2644_g58186 = (float3(appendResult2645_g58186 , ( WorldViewDirection.z / 1.06 )));
				float3 break2680_g58186 = lerpResult2522_g58186;
				float3 normalizeResult2641_g58186 = normalize( ( ( WorldTangent * break2680_g58186.x ) + ( WorldBiTangent * break2680_g58186.y ) + ( WorldNormal * break2680_g58186.z ) ) );
				float3 Normal_Per_Pixel2690_g58186 = normalizeResult2641_g58186;
				float fresnelNdotV2685_g58186 = dot( normalize( Normal_Per_Pixel2690_g58186 ), appendResult2644_g58186 );
				float fresnelNode2685_g58186 = ( 0.0 + ( 1.0 - _SmoothnessFresnelScale ) * pow( max( 1.0 - fresnelNdotV2685_g58186 , 0.0001 ), _SmoothnessFresnelPower ) );
				float lerpResult2636_g58186 = lerp( temp_output_2693_0_g58186 , ( temp_output_2693_0_g58186 - fresnelNode2685_g58186 ) , _SmoothnessFresnelEnable);
				
				float MASK_R1378_g58186 = break50_g58233.r;
				float lerpResult3415_g58186 = lerp( 1.0 , MASK_R1378_g58186 , _OcclusionStrengthAO);
				float lerpResult3414_g58186 = lerp( 1.0 , IN.ase_color.a , _OcclusionStrengthAO);
				float lerpResult2709_g58186 = lerp( lerpResult3415_g58186 , lerpResult3414_g58186 , _OcclusionSource);
				float temp_output_2730_0_g58186 = saturate( lerpResult2709_g58186 );
				

				float3 BaseColor = temp_output_3_0_g58186;
				float3 Normal = lerpResult2522_g58186;
				float3 Emission = 0;
				float3 Specular = 0.5;
				float Metallic = ( _MetallicStrength * MASK_B1377_g58186 );
				float Smoothness = saturate( lerpResult2636_g58186 );
				float Occlusion = temp_output_2730_0_g58186;
				float Alpha = 1;
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v )
			{
				...
				float localStochasticTiling159_g58266 = ( 0.0 );
				float m_switch80_g58528 = _UVMode;
				float2 m_UV080_g58528 = v.ase_texcoord.xy;
				float2 m_UV180_g58528 = v.ase_texcoord1.xy;
				float2 m_UV280_g58528 = v.ase_texcoord2.xy;
				float2 m_UV380_g58528 = v.ase_texcoord3.xy;
				float2 localfloat2switchUVMode80_g58528 = float2switchUVMode80_g58528( m_switch80_g58528 , m_UV080_g58528 , m_UV180_g58528 , m_UV280_g58528 , m_UV380_g58528 );
				float2 temp_output_1955_0_g58186 = (_MainUVs).xy;
				float2 temp_output_1953_0_g58186 = (_MainUVs).zw;
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				float localStochasticTiling159_g58266 = ( 0.0 );
				float m_switch80_g58528 = _UVMode;
				float2 m_UV080_g58528 = v.texcoord0.xy;
				float2 m_UV180_g58528 = v.texcoord1.xy;
				float2 m_UV280_g58528 = v.texcoord2.xy;
				float2 m_UV380_g58528 = v.ase_texcoord3.xy;
				float2 localfloat2switchUVMode80_g58528 = float2switchUVMode80_g58528( m_switch80_g58528 , m_UV080_g58528 , m_UV180_g58528 , m_UV280_g58528 , m_UV380_g58528 );
...
/*ASEBEGIN
Version=19303
Node;AmplifyShaderEditor.CommentaryNode;384;1055.784,-1049.107;Inherit;False;320.1923;375.7019;TESSELLATION;13;446;445;444;443;442;441;440;439;437;388;385;387;386;;0,0,0,1;0;0
Node;AmplifyShaderEditor.StickyNoteNode;432;797.3979,-1048.955;Inherit;False;248;127;;;0,0,0,1;_TessellationStrength$_TessellationPhong$_TessellationDistanceMin$_TessellationDistanceMax$;0;0
Node;AmplifyShaderEditor.RangedFloatNode;388;1088,-768;Half;False;Property;_TessellationPhong;Tessellation Phong;3;0;Create;False;1;;0;0;True;0;False;0.5;0.5;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;385;1088,-848;Half;False;Property;_TessellationDistanceMax;Tessellation Distance Max ;5;0;Create;False;1;;0;0;True;0;False;5;5;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;387;1088,-928;Half;False;Property;_TessellationDistanceMin;Tessellation Distance Min;4;0;Create;False;1;;0;0;True;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;386;1088,-1008;Half;False;Property;_TessellationStrength;Tessellation Strength;2;0;Create;False;1;;0;0;True;0;False;6;6;0.001;100;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;430;1408,-1024;Inherit;False;Property;_CATEGORY_TESSELLATION;CATEGORY_TESSELLATION;1;0;Create;True;0;0;0;True;1;DE_DrawerCategory(TESSELLATION,true,_TessellationStrength,0,0);False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;431;1408,-944;Inherit;False;Property;_SPACE_TESSELLATION;SPACE_TESSELLATION;6;0;Create;True;0;0;0;True;1;DE_DrawerSpace(10);False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;447;960,-640;Inherit;False;DESF Core Lit;7;;58186;e0cdd7758f4404849b063afff4596424;39,442,2,1557,0,1749,0,1556,0,2284,2,2283,2,2213,2,2481,2,2411,2,2399,2,2172,2,2282,2,3300,2,3301,2,3299,2,2132,2,3146,2,2311,2,3108,0,3119,0,3076,0,3408,0,3291,0,3290,0,3289,0,3287,0,96,0,2591,0,2559,0,1368,0,2125,0,2131,0,2028,0,1333,0,2126,0,1896,1,1415,1,830,1,2523,1;1;1234;FLOAT3;0,0,0;False;17;FLOAT3;38;FLOAT3;35;FLOAT;37;FLOAT3;1922;FLOAT;33;FLOAT;34;FLOAT;46;FLOAT;814;FLOAT;1660;FLOAT3;656;FLOAT3;657;FLOAT3;655;FLOAT3;1235;FLOAT3;2760;SAMPLERSTATE;1819;SAMPLERSTATE;1824;SAMPLERSTATE;1818
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;438;1408,-640;Float;False;True;-1;2;DE_ShaderGUI;0;12;DE Environment/Bicubic/Surface Height Tessellation;94348b07e5e8bab40bd6c8a1e3df54cd;True;Forward;0;1;Forward;21;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;True;True;0;True;_Cull;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;5;True;12;all;0;False;True;1;1;False;;0;False;;1;1;False;;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;1;LightMode=UniversalForward;False;False;0;Hidden/DE/Utility/Fallback;0;0;Standard;39;Workflow;1;0;Surface;0;0;  Refraction Model;0;0;  Blend;0;0;Two Sided;1;0;Fragment Normal Space,InvertActionOnDeselection;0;0;Forward Only;0;0;Transmission;0;0;  Transmission Shadow;0.5,True,_ASETransmissionShadow;0;Translucency;0;0;  Translucency Strength;1,True,_ASETranslucencyStrength;0;  Normal Distortion;0.5,True,_ASETranslucencyNormalDistortion;0;  Scattering;2,True,_ASETranslucencyScattering;0;  Direct;0.9,True,_ASETranslucencyScattering;0;  Ambient;0.1,True,_ASETranslucencyAmbient;0;  Shadow;0.5,True,_ASETranslucencyShadow;0;Cast Shadows;1;0;  Use Shadow Threshold;0;0;GPU Instancing;1;0;LOD CrossFade;1;0;Built-in Fog;1;0;_FinalColorxAlpha;0;0;Meta Pass;1;0;Override Baked GI;0;0;Extra Pre Pass;0;0;Tessellation;1;638176263246288356;  Phong;1;638176263266078107;  Strength;0.5,True,_TessellationPhong;638176263345782704;  Type;1;638176263288209337;  Tess;16,True,_TessellationStrength;638176263384890745;  Min;10,True,_TessellationDistanceMin;638176263418462964;  Max;25,True,_TessellationDistanceMax;638176263456496212;  Edge Length;16,False,;0;  Max Displacement;25,False,;0;Write Depth;0;0;  Early Z;0;0;Vertex Position,InvertActionOnDeselection;1;0;Debug Display;0;0;Clear Coat;0;0;0;10;False;True;True;True;True;True;True;True;True;True;False;;True;0
WireConnection;438;0;447;38
WireConnection;438;1;447;35
WireConnection;438;3;447;37
WireConnection;438;4;447;33
WireConnection;438;5;447;34
WireConnection;438;8;447;1235
ASEEND*/
//CHKSM=881B0274712C2987249B34C5DFABE005A2469640